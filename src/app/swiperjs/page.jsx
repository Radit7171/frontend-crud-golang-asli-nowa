        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">SWIPER JS</h1>
                    ...
                    <div className="swiper swiper-basic">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-27.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-26.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-25.jpg" alt="" />
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="swiper pagination">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-32.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-31.jpg" alt="" />
                        </div>
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-33.jpg" alt="" />
                        </div>
                      </div>
                      <div className="swiper-pagination" />
                    </div>
                  ...
                  <div className="card-body">
                    <div className="swiper pagination-progress">
                      <div className="swiper-wrapper">
                        ...
                        <div className="swiper-slide">
                          <img src="/assets/images/media/media-5.jpg" alt="" />
                        </div>
                      </div>
                      <div className="swiper-button-next" />
                      <div className="swiper-button-prev" />
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div
                      ...
                      className="swiper swiper-preview"
                    >
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img
