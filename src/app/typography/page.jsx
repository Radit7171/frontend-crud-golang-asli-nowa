        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">TYPOGRAPHY</h1>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Headings H tags</div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"    "}&lt;h2 class="mb-3"&gt;h2. Bootstrap
                        heading&lt;/h2&gt;{"\n"}
                        {"    "}&lt;h3 class="mb-3"&gt;h3. Bootstrap
                        heading&lt;/h3&gt;{"\n"}
                        {"    "}&lt;h4 class="mb-3"&gt;h4. Bootstrap
                        heading&lt;/h4&gt;{"\n"}
                        {"    "}&lt;h5 class="mb-3"&gt;h5. Bootstrap
                        heading&lt;/h5&gt;{"\n"}
                        {"    "}&lt;h6 class="mb-0"&gt;h6. Bootstrap
                        heading&lt;/h6&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                ...
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Heading Class Names</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"    "}&lt;p class="h2 mb-3"&gt;h2. Bootstrap
                        heading&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="h3 mb-3"&gt;h3. Bootstrap
                        heading&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="h4 mb-3"&gt;h4. Bootstrap
                        heading&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="h5 mb-3"&gt;h5. Bootstrap
                        heading&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="h6 mb-0"&gt;h6. Bootstrap
                        heading&lt;/p&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Inline text elements</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;p&gt;&lt;del&gt;This line of text is meant
                        to be treated as deleted text.&lt;/del&gt;{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;p&gt;&lt;s&gt;This line of text is meant to
                        be treated as no longer{"\n"}
                        {"            "}accurate.&lt;/s&gt;{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;p&gt;&lt;ins&gt;This line of text is meant
                        to be treated as an addition to the{"\n"}
                        {"            "}document.&lt;/ins&gt;&lt;/p&gt;{"\n"}
                        {"    "}&lt;p&gt;&lt;u&gt;This line of text will render
                        as underlined.&lt;/u&gt;&lt;/p&gt;{"\n"}
                        {"    "}&lt;p&gt;&lt;small&gt;This line of text is meant
                        to be treated as fine{"\n"}
                        {"            "}print.&lt;/small&gt;{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;p&gt;&lt;strong&gt;This line rendered as
                        bold text.&lt;/strong&gt;&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="mb-0"&gt;&lt;em&gt;This line
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Lead Paragraph</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="lead mb-0"&gt;{"\n"}
                        {"    "}&lt;b&gt;This is a lead paragraph. It stands out
                        from regular paragraphs&lt;/b&gt;.There are many
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Left Aligned</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"        "}&lt;h6&gt;The greatest glory in living lies
                        not in never falling, but in rising every time we
                        fall.&lt;/h6&gt;{"\n"}
                        {"    "}&lt;/blockquote&gt;{"\n"}
                        {"    "}&lt;figcaption class="blockquote-footer mt-0
                        mb-0 text-muted op-7"&gt;&lt;cite title="Source
                        Title"&gt;Nelson Mandela&lt;/cite&gt;{"\n"}
                        {"    "}&lt;/figcaption&gt;{"\n"}&lt;/figure&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Right Aligned</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
            ...
            <div className="row">
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Primary Blockquote</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        primary mb-0 text-center"&gt;{"\n"}
                        {"    "}&lt;h6&gt;The future belongs to those who
                        believe in the beauty of their dreams..&lt;/h6&gt;{"\n"}
                        {"    "}&lt;footer class="blockquote-footer mt-3 fs-14
                        text-muted op-7 mb-0"&gt;Someone famous as &lt;cite
                        title="Source Title"&gt;-Eleanor
                        Roosevelt&lt;/cite&gt;&lt;/footer&gt;{"\n"}
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Secondary Blockquote</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Warning Blockquote</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Success Blockquote</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Info Blockquote</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;blockquote class="blockquote custom-blockquote info
                        mb-0 text-center"&gt;{"\n"}
                        {"    "}&lt;h6&gt;The future belongs to those who
                        believe in the beauty of their dreams..&lt;/h6&gt;{"\n"}
                        {"    "}&lt;footer class="blockquote-footer mt-3 fs-14
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Danger Blockquote</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        lists&lt;/dt&gt;{"\n"}
                        {"    "}&lt;dd class="col-sm-9"&gt;A description list is
                        perfect for defining terms.&lt;/dd&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;dt class="col-sm-3"&gt;Term&lt;/dt&gt;{"\n"}
                        {"    "}&lt;dd class="col-sm-9"&gt;{"\n"}
                        {"        "}&lt;p&gt;Definition for the term.&lt;/p&gt;
                        {"\n"}
                        {"        "}&lt;p&gt;And some more placeholder
                        definition text.&lt;/p&gt;{"\n"}
                        {"    "}&lt;/dd&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;dt class="col-sm-3"&gt;Another
                        term&lt;/dt&gt;
                        {"\n"}
                        {"    "}&lt;dd class="col-sm-9"&gt;This definition is
                        short, so no extra paragraphs or{"\n"}
                        {"        "}anything.&lt;/dd&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;dt class="col-sm-3
                        text-truncate"&gt;Truncated term is truncated&lt;/dt&gt;
                        {"\n"}
                        {"    "}&lt;dd class="col-sm-9"&gt;This can be useful
                        when space is tight. Adds an{"\n"}
                        {"        "}ellipsis at{"\n"}
                        {"        "}the end.&lt;/dd&gt;{"\n"}
                        {"\n"}
                        ...
                        definition list&lt;/dt&gt;{"\n"}
                        {"            "}&lt;dd class="col-sm-8 mb-0"&gt;I heard
                        you like definition lists. Let me put a{"\n"}
                        {"                "}definition list inside your
                        definition list.&lt;/dd&gt;{"\n"}
                        {"        "}&lt;/dl&gt;{"\n"}
                        {"    "}&lt;/dd&gt;{"\n"}&lt;/dl&gt;
                      </code>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;li&gt;This is a list.&lt;/li&gt;{"\n"}
                        {"    "}&lt;li&gt;It appears completely
                        unstyled.&lt;/li&gt;
                        {"\n"}
                        {"    "}&lt;li&gt;Structurally, it's still a
                        list.&lt;/li&gt;{"\n"}
                        {"    "}&lt;li&gt;However, this style only applies to
                        immediate child elements.&lt;/li&gt;{"\n"}
                        {"    "}&lt;li class="mb-2"&gt;Nested lists:{"\n"}
                        {"        "}&lt;ul&gt;{"\n"}
                        {"            "}&lt;li&gt;are unaffected by this
                        style&lt;/li&gt;{"\n"}
                        {"            "}&lt;li&gt;will still show a
                        bullet&lt;/li&gt;{"\n"}
                        {"            "}&lt;li&gt;and have appropriate left
                        margin&lt;/li&gt;{"\n"}
                        {"        "}&lt;/ul&gt;{"\n"}
                        {"    "}&lt;/li&gt;{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;p class="mb-0"&gt;&lt;abbr title="HyperText
                        Markup Language"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;li class="list-inline-item"&gt;This is a
                        list item.&lt;/li&gt;{"\n"}
                        {"    "}&lt;li class="list-inline-item"&gt;And another
                        one.&lt;/li&gt;{"\n"}
                        {"    "}&lt;li class="list-inline-item"&gt;But they're
                        displayed inline.&lt;/li&gt;{"\n"}&lt;/ul&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="example">
                      <p className="mb-1">
                        ...
                        adipisci voluptatibus ipsum, architecto veniam delectus
                        vel dolor magni a vero sunt ut harum.
                      </p>
                      ...
                      <p className=" mb-1">
                        ...
                        elit. Iusto perspiciatis, magni numquam quos perferendis
                        nulla magnam odit amet excepturi quisquam provident.
                      </p>
                      <hr className="text-danger border-2 opacity-50" />
                      <p className="mb-0">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Repellendus aliquid consequatur aut doloremque assumenda
                        voluptatem, id qui vero adipisci! Nostrum ipsam
                        praesentium!
                      </p>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="mb-1"&gt;Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Rerum dolorem fuga iste
                        obcaecati natus eos officiis adipisci voluptatibus
                        ipsum, architecto veniam delectus vel dolor magni a vero
                        sunt ut harum.&lt;/p&gt;
                        {"\n"}
                        {"    "}&lt;div class="text-success"&gt;{"\n"}
                        {"        "}&lt;hr&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;p class=" mb-1"&gt;Lorem, ipsum dolor sit
                        amet consectetur adipisicing elit. Iusto perspiciatis,
                        magni numquam quos perferendis nulla magnam odit amet
                        excepturi quisquam provident.&lt;/p&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;hr class="text-danger border-2
                        opacity-50"&gt;
                        {"\n"}
                        {"    "}&lt;p class="mb-0"&gt;Lorem ipsum dolor sit amet
                        consectetur adipisicing elit. Repellendus aliquid
                        consequatur aut doloremque assumenda voluptatem, id qui
                        vero adipisci! Nostrum ipsam praesentium!&lt;/p&gt;
                        {"\n"}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="text-lowercase"&gt;Lowercased
                        text.&lt;/p&gt;
                        {"\n"}
                        {"    "}&lt;p class="text-uppercase"&gt;Uppercased
                        text.&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="text-capitalize
                        mb-0"&gt;CapiTaliZed text.&lt;/p&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="text-decoration-underline"&gt;This text has
                        a line underneath it.{"\n"}&lt;/p&gt;{"\n"}&lt;p
                        class="text-decoration-line-through"&gt;This text has a
                        line going{"\n"}
                        {"    "}through{"\n"}
                        {"    "}it.{"\n"}&lt;/p&gt;{"\n"}&lt;a href="#"
                        class="text-decoration-none"&gt;This link has its text
                        {"\n"}
                        {"    "}decoration{"\n"}
                        {"    "}removed{"\n"}&lt;/a&gt;
                      </code>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;p class="fw-bolder"&gt;Bolder weight text
                        (relative to the parent element).&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="fw-semibold"&gt;Semibold weight
                        text.&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="fw-normal"&gt;Normal weight
                        text.&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="fw-light"&gt;Light weight
                        text.&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="fw-lighter"&gt;Lighter weight text
                        (relative to the parent element).&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="fst-italic"&gt;Italic
                        text.&lt;/p&gt;
                        {"\n"}
                        {"    "}&lt;p class="fst-normal mb-0"&gt;Text with
                        normal font style&lt;/p&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="lh-1"&gt;This is a long paragraph written
                        to show how the line-height of{"\n"}
                        {"    "}an{"\n"}
                        {"    "}element is affected by our utilities. Classes
                        are applied to the element{"\n"}
                        {"    "}itself{"\n"}
                        {"    "}or sometimes the parent element. These classes
                        can be customized as needed{"\n"}
                        {"    "}with{"\n"}
                        {"    "}our utility API.{"\n"}&lt;/p&gt;{"\n"}&lt;p
                        class="lh-sm"&gt;This is a long paragraph written to
                        show how the line-height of{"\n"}
                        {"    "}an{"\n"}
                        {"    "}element is affected by our utilities. Classes
                        are applied to the element{"\n"}
                        {"    "}itself{"\n"}
                        ...
                        {"    "}with{"\n"}
                        {"    "}our utility API.{"\n"}&lt;/p&gt;{"\n"}&lt;p
                        class="lh-base"&gt;This is a long paragraph written to
                        show how the line-height{"\n"}
                        {"    "}of{"\n"}
                        {"    "}an element is affected by our utilities. Classes
                        are applied to the element{"\n"}
                        {"    "}itself or sometimes the parent element. These
                        classes can be customized as{"\n"}
                        {"    "}needed with our utility API.{"\n"}&lt;/p&gt;
                        {"\n"}
                        &lt;p class="lh-lg mb-0"&gt;This is a long paragraph
              ...
              <div className="col-xl-3">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="font-monospace mb-0"&gt;This is in
                        monospace&lt;/p&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-3">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="visible mb-0"&gt;This is visible
                        text&lt;/p&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-3">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;p class="invisible mb-0"&gt;This is invisible
                        text&lt;/p&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;p class="text-end"&gt;End aligned text on
                        all viewport sizes.&lt;/p&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;p class="text-sm-start"&gt;Start aligned
                        text on viewports sized SM (small) or{"\n"}
                        {"        "}wider.{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="text-md-start"&gt;Start aligned
                        text on viewports sized MD (medium) or{"\n"}
                        {"        "}wider.{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="text-lg-start"&gt;Start aligned
                        text on viewports sized LG (large) or{"\n"}
                        {"        "}wider.{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;p class="text-xl-start"&gt;Start aligned
                        text on viewports sized XL (extra-large){"\n"}
                        {"        "}or{"\n"}
                        {"        "}wider.&lt;/p&gt;
                      </code>
                    </pre>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        style="width: 6rem;"&gt;{"\n"}
                        {"    "}This text should wrap.{"\n"}&lt;/div&gt;{"\n"}
                        &lt;p class="text-muted mb-2"&gt; use class
                        &lt;code&gt;.text-nowrap&lt;/code&gt; to prevent text
                        from wrapping&lt;/p&gt;{"\n"}&lt;div class="text-nowrap
                        bg-light border" style="width: 8rem;"&gt;{"\n"}
                        {"    "}This text should overflow the parent.{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
