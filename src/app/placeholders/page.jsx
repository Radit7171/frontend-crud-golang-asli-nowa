          ...
          <div className="container-fluid">
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div className="card" aria-hidden="true">
                      ...
                      />
                      <div className="card-body">
                        <div className="h5 placeholder-glow">
                  ...
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      <div className="card-header justify-content-between">
                        <div className="card-title">Animation</div>
                    ...
                    <div className="row">
                      <div className="col-xl-12">
                        <div className="card custom-card">
                          ...
                          <div className="card-body">
                            <span className="placeholder col-12 placeholder-xl mb-1" />
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            ...
                            {"\n"}&lt;span class="placeholder col-12
                            bg-warning"&gt;&lt;/span&gt;{"\n"}&lt;span
                            class="placeholder col-12 bg-info"&gt;&lt;/span&gt;
                            {"\n"}&lt;span class="placeholder col-12
                            bg-light"&gt;&lt;/span&gt;{"\n"}&lt;span
                            class="placeholder col-12 bg-dark"&gt;&lt;/span&gt;
                          </code>
                        </pre>
                        {/* Prism Code */}
                      </div>
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Width</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <span className="placeholder bg-primary col-6" />
                    <span className="placeholder bg-primary w-75" />
                    <span
                      className="placeholder bg-primary"
                      style={{ width: "25%" }}
                    />
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        col-6"&gt;&lt;/span&gt;{"\n"}&lt;span class="placeholder
                        bg-primary w-75"&gt;&lt;/span&gt;{"\n"}&lt;span
                        class="placeholder bg-primary" style="width:
                        25%;"&gt;&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
