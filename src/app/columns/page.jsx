        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">COLUMNS</h1>
                ...
                <div className="row">
                        ...
                        <div className="container">
                          <div className="row">
                            ...
                            <div className="col-4">
                              ...
                              gets wrapped onto a new line as one contiguous
                              unit.
                            </div>
                            <div className="col-6">
                              .col-6
                  ...
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      ...
                      <div className="card-body bd-example-row">
                        <p className="mb-4">
                          With the move to flexbox in v4, you can use margin
                          utilities like
                          <span className="text-danger">.me-auto</span>to force
                    ...
                    <div className="card custom-card">
                      ...
                      <div className="card-body bd-example-row">
                        ...
                        <p>
                          ...
                          <span className="text-danger">.order-first</span> and
                          <span className="text-danger">.order-last</span>{" "}
                          classes that change the order of an element by
                          applying{" "}
                          <span className="text-danger">order: -1</span>
                          and
                          <span className="text-danger">order: 6</span>,
                  ...
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      ...
                      <div className="card-body">
                        <p>
                          The <span className="text-danger">.col-*</span>{" "}
                          classes can also be used outside a
                          <span className="text-danger">.row</span> to give an
                          element a specific width. Whenever column classes are
                ...
                <div className="card custom-card">
                  <div className="card-body">
                    <p>
                      ...
                      responsive floated images. Make sure to wrap the content
                      in a <span className="text-danger">.clearfix</span>
