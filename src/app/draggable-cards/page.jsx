...
export default function Draggable_cards() {
      ...
      <div className="page">
        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            {/* Start::row-1 */}
            <div className="row">
              <div className="col-xl-6" id="draggable-left">
                ...
                <div className="card custom-card">
                  <div className="card-header justify-content-between border-bottom">
              ...
              <div className="col-xl-6" id="draggable-right">
