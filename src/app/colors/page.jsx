        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">COLORS</h1>
                  ...
                  <div className="card-body">
                    <div className="row row-cols-12 d-flex align-items-center">
                      <div className="p-3 col">
                        <div className="my-2 bg-primary mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-primary</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-secondary mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-secondary</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-warning mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-warning</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-info mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-info</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-success mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-success</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-danger mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-danger</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-light mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-light</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-dark mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-dark</code>
                        </p>
                      </div>
              ...
              <div className="col-lg-12 col-sm-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="row row-cols-12 d-flex align-items-center">
                      <div className="p-3 col">
                        <div className="my-2 bg-primary-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-primary-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-secondary-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-secondary-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-warning-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-warning-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-info-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-info-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-success-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-success-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-danger-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-danger-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-light-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-light-gradient</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-dark-gradient mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
              ...
              <div className="col-lg-12 col-sm-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="row row-cols-12 d-flex align-items-center">
                      <div className="p-3 col">
                        <div className="my-2 bg-primary-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-primary-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-secondary-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-secondary-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-warning-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-warning-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-info-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-info-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-success-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-success-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-danger-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-danger-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-light-transparent mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-light-transparent</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 bg-dark-transparent mx-auto color-container shadow-none" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
              ...
              <div className="col-lg-12 col-sm-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="row row-cols-12 d-flex align-items-center">
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-primary mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-secondary mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-warning mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-info mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-success mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-danger mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-light mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-outline-dark mx-auto color-container">
                          <i className="bi bi-emoji-smile fs-18" />
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
              ...
              <div className="col-lg-12 col-sm-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="row row-cols-12 d-flex align-items-center">
                      <div className="p-3 col">
                        <div className="my-2 border border-primary mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-primary</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-secondary mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-secondary</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-warning mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-warning</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-info mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-info</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-success mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-success</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-danger mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-danger</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-light mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.border-light</code>
                        </p>
                      </div>
                      <div className="p-3 col">
                        <div className="my-2 border border-dark mx-auto color-container" />
                        <p className="pb-0 mb-0 fw-semibold text-center">
              ...
              <div className="col-lg-12 col-sm-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="row row-cols-12 d-flex align-items-center">
                      <div className="p-3 col">
                        <div className="my-2 bg-success bg-opacity-100 text-fixed-white mx-auto color-container">
                          100%
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-success text-fixed-white bg-opacity-75 mx-auto color-container">
                          75%
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                          <code>.bg-opacity-75</code>
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-success text-fixed-dark bg-opacity-50 mx-auto color-container">
                          50%
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-success text-fixed-dark bg-opacity-25 mx-auto color-container">
                          25%
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
                      ...
                      <div className="p-3 col">
                        <div className="my-2 bg-success text-fixed-dark bg-opacity-10 mx-auto color-container">
                          10%
                        </div>
                        <p className="pb-0 mb-0 fw-semibold text-center">
            ...
            <div className="row">
              ...
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-body d-xl-flex">
                    <div className="flex-fill p-3 bd-indigo-100">
                      $indigo-100
                    </div>
                    <div className="flex-fill p-3 bd-indigo-200">
                      $indigo-200
                    </div>
                    <div className="flex-fill p-3 bd-indigo-300">
                      $indigo-300
                    </div>
                    <div className="flex-fill p-3 bd-indigo-400">
                      $indigo-400
                    </div>
                    <div className="flex-fill p-3 bd-indigo-500">
                      $indigo-500
                    </div>
                    <div className="flex-fill p-3 bd-indigo-600">
                      $indigo-600
                    </div>
                    <div className="flex-fill p-3 bd-indigo-700">
                      $indigo-700
                    </div>
                    <div className="flex-fill p-3 bd-indigo-800">
                      $indigo-800
                    </div>
                    <div className="flex-fill p-3 bd-indigo-900">
                      $indigo-900
                    </div>
              ...
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-body d-xl-flex">
                    <div className="flex-fill p-3 bd-purple-100">
                      $purple-100
                    </div>
                    <div className="flex-fill p-3 bd-purple-200">
                      $purple-200
                    </div>
                    <div className="flex-fill p-3 bd-purple-300">
                      $purple-300
                    </div>
                    <div className="flex-fill p-3 bd-purple-400">
                      $purple-400
                    </div>
                    <div className="flex-fill p-3 bd-purple-500">
                      $purple-500
                    </div>
                    <div className="flex-fill p-3 bd-purple-600">
                      $purple-600
                    </div>
                    <div className="flex-fill p-3 bd-purple-700">
                      $purple-700
                    </div>
                    <div className="flex-fill p-3 bd-purple-800">
                      $purple-800
                    </div>
                    <div className="flex-fill p-3 bd-purple-900">
                      $purple-900
                    </div>
              ...
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-body d-xl-flex">
                    <div className="flex-fill p-3 fs-12 bd-orange-100">
                      $orange-100
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-200">
                      $orange-200
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-300">
                      $orange-300
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-400">
                      $orange-400
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-500">
                      $orange-500
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-600">
                      $orange-600
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-700">
                      $orange-700
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-800">
                      $orange-800
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange-900">
                      $orange-900
                    </div>
                    <div className="flex-fill p-3 fs-12 bd-orange">$orange</div>
                  </div>
                </div>
              </div>
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-body d-xl-flex">
                    <div className="flex-fill p-3 bd-yellow-100">
                      $yellow-100
                    </div>
                    <div className="flex-fill p-3 bd-yellow-200">
                      $yellow-200
                    </div>
                    <div className="flex-fill p-3 bd-yellow-300">
                      $yellow-300
                    </div>
                    <div className="flex-fill p-3 bd-yellow-400">
                      $yellow-400
                    </div>
                    <div className="flex-fill p-3 bd-yellow-500">
                      $yellow-500
                    </div>
                    <div className="flex-fill p-3 bd-yellow-600">
                      $yellow-600
                    </div>
                    <div className="flex-fill p-3 bd-yellow-700">
                      $yellow-700
                    </div>
                    <div className="flex-fill p-3 bd-yellow-800">
                      $yellow-800
                    </div>
                    <div className="flex-fill p-3 bd-yellow-900">
                      $yellow-900
                    </div>
