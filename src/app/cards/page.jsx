        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">CARDS</h1>
                ...
                <div className="card custom-card">
                  <div className="card-body">
                    ...
                    <p className="card-text">
                      ...
                      variations of passages of Lorem Ipsum available there are
                      so many ways to solve but the majority have suffered.
                    </p>
                  </div>
                  <div className="card-footer">
                    <a
            ...
            <div className="row">
              ...
              <div className="col-xl-3">
                <div className="card custom-card text-center">
                  <div className="card-header border-bottom-0 pb-0">
                    <span className="float-end shadow-lg fs-17">
              ...
              <div className="col-xl-3">
                <div className="card custom-card border border-primary">
                  <div className="card-body">
                    <svg
                      className="footer-card-icon my-3"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                    >
                      <path
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    ...
                    >
                      <i className="ri-arrow-down-s-line fs-18 collapse-open" />
                      <i className="ri-arrow-up-s-line collapse-close fs-18" />
                    </a>
                  </div>
                    ...
                    <div className="card custom-card w-75">
                      ...
                      <div className="card-body">
                        <div className="card-text">
                          ...
                          elit. Id nostrum omnis excepturi consequatur molestiae
                        </div>
                      </div>
                      <div className="card-footer">
                        <a
              ...
              <div className="col-xl-4">
                <div className="card custom-card overlay-card">
                  ...
                  <div className="card-img-overlay d-flex flex-column p-0">
                    ...
                    <div className="card-body text-fixed-white overflow-scroll">
                ...
                <div className="card custom-card overlay-card">
                  ...
                  <div className="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                    <div className="card-body text-fixed-white">
                      ...
                      <div className="card-text mb-2 text-truncate">
                        There are many variations of passages of Lorem Ipsum
                        available, but the majority have suffered alteration in
                        some form, by injected humour, or randomised words which
                        don't look even.
            ...
            <div className="row">
              ...
              <div className="col-xl-3">
                <div className="card custom-card card-bg-info">
                  <div className="card-body">
                    <div className="d-flex align-items-center w-100">
                      <div className="me-2">
                        <span className="avatar avatar-rounded">
              ...
              <div className="col-xl-3">
                <div className="card custom-card card-bg-danger">
                  <div className="card-body">
                    <div className="d-flex align-items-center w-100">
                      <div className="me-2">
                        <span className="avatar avatar-rounded">
              ...
              <div className="col-xl-3">
                <div className="card custom-card card-bg-dark">
                  <div className="card-body">
                    <div className="d-flex align-items-center w-100">
                      <div className="me-2">
                        <span className="avatar avatar-rounded">
                ...
                <div className="card border border-secondary custom-card">
                  <div className="card-body">
                    ...
                    <div className="d-flex flex-wrap gap-2 mb-4">
                      ...
                      <span className="badge bg-teal-transparent">
                        Codeignitor
                      </span>
                ...
                <div className="card border border-info custom-card">
                  <div className="card-body">
                    <p className="fs-14 fw-semibold mb-2 lh-1">
                      ...
                      <a href="javascript:void(0);">
                        <i className="bi bi-plus-square float-end text-info fs-18" />
                      </a>
                    </p>
                    <div className="d-flex flex-wrap gap-2 mb-4">
                      <span className="badge bg-info-transparent">React</span>
                ...
                <div className="card border border-danger custom-card">
                  <div className="card-body">
                    <p className="fs-14 fw-semibold mb-2 lh-1">
                      ...
                      <a href="javascript:void(0);">
                        <i className="bi bi-plus-square float-end text-danger fs-18" />
                      </a>
                    </p>
                    <div className="d-flex flex-wrap gap-2 mb-4">
                ...
                <div className="card border border-light custom-card">
                  <div className="card-body">
                    <p className="fs-14 fw-semibold mb-2 lh-1">
                      New Employees
                      <a href="javascript:void(0);">
                        <i className="bi bi-plus-square float-end text-default fs-18" />
                      </a>
                    </p>
                    <div className="d-flex flex-wrap gap-2 mb-4">
                      <span className="badge bg-warning-transparent">Html</span>
                ...
                <div className="card border border-dark custom-card">
                  <div className="card-body">
                    <p className="fs-14 fw-semibold mb-2 lh-1">
                      ...
                      <a href="javascript:void(0);">
                        <i className="bi bi-plus-square float-end text-dark fs-18" />
                      </a>
                    </p>
                    <div className="d-flex flex-wrap gap-2 mb-4">
                      <span className="badge bg-primary-transparent">
                        ...
                        <div className="col-md-8">
                          <div className="card-body">
                            ...
                            <p className="card-text mb-0">
                              ...
                              are very efficient at kill,they are very
                              Dangerous.
                            </p>
                            <p className="mb-0 card-text">
