                  ...
                  <div className="card-sigin">
                    <div className="">
                      <div>
                        ...
                        <div className="row row-sm mx-auto" id="timer"></div>
                        ...
                        <div className="mt-4 d-flex text-center justify-content-center">
                          ...
                          >
                            <span className="btn-inner--icon">
                              {" "}
                              <i className="bx bxl-facebook tx-18 tx-prime" />{" "}
                            </span>
                          </a>
                          <a
                            href="javascript:void(0);"
                          ...
                          >
                            <span className="btn-inner--icon">
                              {" "}
                              <i className="bx bxl-twitter tx-18 tx-prime" />{" "}
                            </span>
                          </a>
                          <a
                            href="javascript:void(0);"
                          ...
                          >
                            <span className="btn-inner--icon">
                              {" "}
                              <i className="bx bxl-linkedin tx-18 tx-prime" />{" "}
                            </span>
                          </a>
                          <a
                            href="javascript:void(0);"
                          ...
                          >
                            <span className="btn-inner--icon">
                              {" "}
                              <i className="bx bxl-instagram tx-18 tx-prime" />{" "}
                            </span>
                          </a>
                        </div>
                      </div>
