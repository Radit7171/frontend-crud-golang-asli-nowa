                  ...
                  <div className="card-body">
                    ...
                    <div className="form-group">
                      ...
                      >
                        ...
                        <option value="Choice 1">Language</option>
                        <option value="Choice 2">Science</option>
                        <option value="Choice 3">Health</option>
                        <option value="Choice 4">Humanities</option>
                        <option value="Choice 5">Business</option>
                        <option value="Choice 6">Maths</option>
                        <option value="Choice 7">Marketing</option>
                      </select>
                    </div>
                    <div className="form-group">
                      ...
                      >
                        <option value="">--Select--</option>
                        <option value="Choice 1">Blanche</option>
                        <option value="Choice 2">Pedro Cox</option>
                        <option value="Choice 3">Vera Guzman</option>
                        <option value="Choice 4">Glenda Long</option>
                        <option value="Choice 5">Joel Anderson</option>
                      </select>
                    </div>
                    <div className="form-group">
                      <label className="form-label text-dark">
                    ...
                    <div id="editor" className="mb-3">
                      <h4>
                        <b className="ql-size-large">Quill Snow</b> is a free,
                        open source{" "}
                        <a
                        ...
                        and expressive API, it is completely customizable to fit
                        any need.
                      </h4>
                      <p>
                        <br />
                    ...
                    <div className="p-4 border mb-4 form-group">
                      <div>
                        <form
                          data-single="true"
                          method="post"
                    ...
                    <div className="control-group form-group  mb-0">
                      ...
                      <div className=" border p-3 br-7">
                        <div className="d-md-flex ad-post-details">
                          <div className="form-check mb-0 me-5">
                            <input
                              className="form-check-input"
                              type="radio"
                          ...
                          <div className="form-check mb-0 me-4">
                            <input
                              className="form-check-input"
                              type="radio"
                              name="flexRadioDefault"
                          ...
                          <div className="form-check mb-0 me-4">
                            ...
                            >
                              {" "}
                              6months /<span className="fw-bold">$50</span>
                            </label>
                          </div>
