          ...
          <div className="main-container container-fluid">
            ...
            <div className="row">
              <div className="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                <div className="card primary-custom-card1">
                    ...
                    <div className="row">
                      <div className="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                        <div className="prime-card">
                          <img
                            className="img-fluid"
                            src="/assets/images/png/dashboard8.png"
                            alt=""
                          />
                        </div>
                      </div>
                      <div className="col-xl-7 col-lg-6 col-md-12 col-sm-12">
                        <div className="text-justified align-items-center">
                          ...
                          <p className="fw-semibold fs-12 mb-4">
                            For billing related queries, contact us through
                            support chat or mail us at team@spruko.com{" "}
                          </p>
                ...
                <div className="card overflow-hidden">
                  ...
                  <div className="card-body p-0">
                    <div className="list-group projects-list border-0">
                      <a
                        href="#"
                        className="list-group-item list-group-item-action flex-column align-items-start border-0 rounded-0"
                      >
                      ...
                      >
                        ...
                        <div className="d-flex w-100 justify-content-between">
                          <span className="text-muted  fs-12">
                            <i className="bx bx-caret-up text-success me-1" />
                            <span className="text-success"> 06%</span> last
                            month
                          </span>
                      ...
                      >
                        ...
                        <div className="d-flex w-100 justify-content-between">
                          <span className="text-muted  fs-12">
                            <i className="bx bx-caret-up text-success me-1" />
                            <span className="text-success"> 55%</span> last
                            month
                          </span>
                      ...
                      >
                        ...
                        <div className="d-flex w-100 justify-content-between">
                          <span className="text-muted  fs-12">
                            <i className="bx bx-caret-up text-success me-1" />
                            <span className="text-success"> 32%</span> last
                            month
                          </span>
                          <span className="text-muted  fs-11">11 days ago</span>
                        </div>
            ...
            <div className="row row-sm">
              ...
              <div className="col-sm-12 col-xl-6 col-lg-12 col-xxl-3">
                <div className="card">
