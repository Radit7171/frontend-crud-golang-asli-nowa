...
export default function Mail_compose() {
                ...
                <div className="card">
                  ...
                  <div className="main-chat-footer d-sm-flex">
                    <nav className="nav gap-2">
                      ...
                      >
                        <i className="bx bx-paperclip text-muted fs-18" />
                      </a>
                      <a
                        className="nav-link"
                        data-bs-toggle="tooltip"
                      ...
                      >
                        <i className="bx bx-link text-muted fs-18" />
                      </a>
                      <a
                        className="nav-link"
                        data-bs-toggle="tooltip"
                      ...
                      >
                        <i className="bx bx-image text-muted fs-18" />
                      </a>
                      <a
                        className="nav-link"
                        data-bs-toggle="tooltip"
                      ...
                      >
                        <i className="bx bx-trash text-muted fs-18" />
                      </a>
                    </nav>
                    <div className="btn-list ms-auto">
                      <a
                        className="main-msg-send bg-primary text-fixed-white"
                        href=""
                      >
