...
export default function Mail_read() {
        ...
        <div className="main-content app-content">
          ...
          <div className="main-container container-fluid">
            ...
            <div className="row row-sm">
              {/* Col */}
              <div className="col-lg-4 col-xl-3 col-md-4 col-sm-12">
                    ...
                    <div className="main-mail-menu">
                      <nav className="nav main-nav-column mg-b-20">
                        ...
                        <a
                          ...
                          href="javascript:void(0);"
                        >
                          <i className="far fa-star" /> Starred <span>8</span>
                        </a>
                        <a
                          className="nav-link thumb"
                          href="javascript:void(0);"
                        >
                          <i className="far fa-clock" /> Snoozed <span>6</span>
                        </a>
                        <a
                          className="nav-link thumb"
                          href="javascript:void(0);"
                        ...
                        <a
                          ...
                          href="javascript:void(0);"
                        >
                          <i className="far fa-dot-circle" /> Spam{" "}
                          <span>32</span>
                        </a>
                        <a
                          className="nav-link thumb"
                          href="javascript:void(0);"
                        >
                          <i className="far fa-comments" /> Chats{" "}
                          <span>14</span>
                        </a>
                        <a
                          className="nav-link thumb"
                          href="javascript:void(0);"
                        >
                          <i className="far fa-user-circle" /> Contacts{" "}
                          <span>547</span>
                        </a>
                        <a
                          className="nav-link thumb"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-trash" /> Trash <span>365</span>
                        </a>
                      </nav>
                ...
                <div className="card">
                  ...
                  <div className="card-body p-0">
                    <div className="email-media m-4">
                      <div className="mt-0 d-sm-flex">
                        ...
                        <div className="media-body">
                          <div className="float-end d-none d-md-flex fs-8">
                            <small className="me-2  border br-5 p-2">
                              <i
                                className="bx bx-star fs-18 text-muted"
                                data-bs-toggle="tooltip"
                                title=""
                            ...
                            <small className="me-2  border br-5 p-2">
                              <i
                                className="bx bx-paperclip fs-18 text-muted"
                                data-bs-toggle="tooltip"
                                title=""
                            ...
                            <small className="me-2  border br-5 p-2">
                              <i
                                className="bx bx-reply fs-18 text-muted"
                                data-bs-toggle="tooltip"
                                title=""
                                data-bs-original-title="Reply"
                              />
                            </small>
                            <div className="me-2  border br-5 p-2">
                              <a
                                href="javascript:void(0);"
                                data-bs-toggle="dropdown"
                                role="button"
                              ...
                              >
                                <i
                                  className="fe fe-more-vertical text-muted  fs-18"
                                  data-bs-toggle="tooltip"
                                  title=""
                          ...
                          <small className="me-2 d-md-none">
                            <i
                              className="fe fe-star text-muted"
                              data-bs-toggle="tooltip"
                              title=""
                              data-bs-original-title="Rated"
                            />
                    ...
                    <div className="eamil-body mt-5">
                      ...
                      <hr />
                      <div className="email-attch mx-4">
