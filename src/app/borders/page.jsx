        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">BORDERS</h1>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="p-3 bg-info bg-opacity-10 border border-info border-start-0 rounded-end mb-1">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        placeholder="name@example.com"&gt;{"\n"}&lt;/div&gt;
                        {"\n"}
                        &lt;div class="h4 pb-3 mb-4 text-danger border-bottom
                        border-danger"&gt;{"\n"}
                        {"    "}Below Shows Danger Border{"\n"}&lt;/div&gt;
                        {"\n"}
                        &lt;div{"\n"}
                        {"    "}class="p-3 bg-info bg-opacity-10 border
                        border-info border-start-0 rounded-end mb-1"&gt;{"\n"}
                        {"    "}Customizing borders with backgrounud colors
                        {"\n"}
                        &lt;/div&gt;
                      </code>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="border border-success p-2 mb-2"&gt;This
                        is default success border&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="border border-success p-2 mb-2
                        border-opacity-75"&gt;This is 75%{"\n"}
                        {"        "}opacity{"\n"}
                        {"        "}success border{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="border border-success p-2 mb-2
                        border-opacity-50"&gt;This is 50%{"\n"}
                        {"        "}opacity{"\n"}
                        {"        "}success border{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="border border-success p-2 mb-2
                        border-opacity-25"&gt;This is 25%{"\n"}
                        {"        "}opacity{"\n"}
                        {"        "}success border{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Border Radius Placements</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    ...
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img rounded-top"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img rounded-end"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img rounded-bottom"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img rounded-start"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                    ...
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img  rounded-pill"
                      alt="..."
                    />
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        class="bd-placeholder-img rounded" alt="..."&gt;{"\n"}
                        {"    "}&lt;img src="/assets/images/media/media-58.jpg"
                        class="bd-placeholder-img rounded-top" alt="..."&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/media/media-58.jpg"
                        class="bd-placeholder-img rounded-end" alt="..."&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/media/media-58.jpg"
                        class="bd-placeholder-img rounded-bottom" alt="..."&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/media/media-58.jpg"
                        class="bd-placeholder-img rounded-start" alt="..."&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/media/media-58.jpg"
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Border Radius Sizes</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    ...
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img bd-placeholder-img rounded-1"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img bd-placeholder-img rounded-2"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img bd-placeholder-img rounded-3"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img bd-placeholder-img rounded-4"
                      alt="..."
                    />
                    <img
                      src="/assets/images/media/media-58.jpg"
                      className="bd-placeholder-img bd-placeholder-img rounded-5"
                      alt="..."
                    />
                  </div>
                  <div className="card-footer d-none border-top-0">
