...
export default function File_manager1() {
                  ...
                  <div className="col-xl-2 col-md-4 col-sm-6">
                    <div className="card p-0 ">
                      ...
                      <div className="card-body pt-0 text-center">
                        ...
                        <h6 className="mb-1 fw-semibold mt-1">Document</h6>
                        <span className="text-muted">23kb</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-2 col-md-4 col-sm-6">
                    <div className="card p-0 ">
                      ...
                      <div className="card-body pt-0 text-center">
                        ...
                        <h6 className="mb-1 fw-semibold mt-2">login image</h6>
                        <span className="text-muted">23kb</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-2 col-md-4 col-sm-6">
                    <div className="card p-0 ">
                      ...
                      <div className="card-body pt-0 text-center">
                        ...
                        <h6 className="mb-1 fw-semibold mt-2">beach image</h6>
                        <span className="text-muted">4.23gb</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-2 col-md-4 col-sm-6">
                    <div className="card p-0 ">
                      ...
                      <div className="card-body pt-0 text-center">
                        ...
                        <h6 className="mb-1 fw-semibold mt-2">sky image</h6>
                        <span className="text-muted">1.23gb</span>
                      </div>
                    </div>
                  </div>
                  <div className="col-xl-2 col-md-4 col-sm-6">
                    <div className="card p-0 ">
                      ...
                      <div className="card-body pt-0 text-center">
                        ...
                        <h6 className="mb-1 fw-semibold mt-2">Sea</h6>
                  ...
                  <div className="col-xl-2 col-md-4 col-sm-6">
                    <div className="card p-0 ">
                      ...
                      <div className="card-body pt-0 text-center">
                        ...
                        <h6 className="mb-1 fw-semibold mt-2">Outdoor Image</h6>
                        <span className="text-muted">23kb</span>
                      </div>
                    </div>
                  </div>
