            ...
            <div className="container-fluid">
              ...
              <div className="row">
                    ...
                    <div className="card-footer d-none border-top-0">
                      ...
                      <pre className="language-html">
                        <code className="language-html">
                          ...
                          {"\n"}
                          {"        "}&lt;li class="breadcrumb-item"&gt;&lt;a
                          href="javascript:void(0);"&gt;Library&lt;/a&gt;&lt;/li&gt;
                          {"\n"}
                          {"        "}&lt;li class="breadcrumb-item active"
                ...
                <div className="col-xl-6">
                  <div className="card custom-card">
                    <div className="card-header justify-content-between">
                      <div className="card-title">Example-1</div>
                      <div className="prism-toggle">
                        <button className="btn btn-sm btn-primary-light">
                          Show Code
                          <i className="ri-code-line ms-2 d-inline-block align-middle" />
                ...
                <div className="col-xl-6">
                  <div className="card custom-card">
                    <div className="card-header justify-content-between">
                      <div className="card-title">Dividers</div>
                      <div className="prism-toggle">
                        <button className="btn btn-sm btn-primary-light">
                          Show Code
                          <i className="ri-code-line ms-2 d-inline-block align-middle" />
                ...
                <div className="col-xl-6">
                  <div className="card custom-card embedded-breadcrumb">
                    <div className="card-header justify-content-between">
                      <div className="card-title">Embedded SVG icon</div>
                      <div className="prism-toggle">
                        <button className="btn btn-sm btn-primary-light">
                          Show Code
                          <i className="ri-code-line ms-2 d-inline-block align-middle" />
                      ...
                      <div className="example">
                        ...
                        >
                          <ol className="breadcrumb mb-0">
                            ...
                            <li
                              className="breadcrumb-item active embedded-breadcrumb"
                              aria-current="page"
                            >
                              Library
                            </li>
                    ...
                    <div className="card-footer d-none border-top-0">
                      ...
                      <pre className="language-html">
                        <code className="language-html">
                          ...
                          height='8'%3E%3Cpath d='M2.5 0L1 1.5 3.5 4 1 6.5 2.5
                          8l4-4-4-4z' fill='currentColor'/%3E%3C/svg%3E");"
                          {"\n"}
                          {"    "}aria-label="breadcrumb"&gt;{"\n"}
                          {"    "}&lt;ol class="breadcrumb mb-0"&gt;{"\n"}
                          {"        "}&lt;li class="breadcrumb-item"&gt;&lt;a
                ...
                <div className="col-xl-6">
                  <div className="card custom-card">
                    <div className="card-header justify-content-between">
                      <div className="card-title">Breadcrumb Style-1</div>
                      <div className="prism-toggle">
                        <button className="btn btn-sm btn-primary-light">
                          Show Code
                          <i className="ri-code-line ms-2 d-inline-block align-middle" />
                    ...
                    <div className="card-footer d-none border-top-0">
                      ...
                      <pre className="language-html">
                        <code className="language-html">
                          &lt;nav aria-label="breadcrumb"&gt;{"\n"}&lt;ol
                          class="breadcrumb breadcrumb-style1 mb-0"&gt;{"\n"}
                          {"    "}&lt;li class="breadcrumb-item"&gt;&lt;a
                          href="javascript:void(0);"&gt;Home&lt;/a&gt;&lt;/li&gt;
                          {"\n"}
                          {"    "}&lt;li class="breadcrumb-item"&gt;&lt;a
                ...
                <div className="col-xl-6">
                  <div className="card custom-card">
                    <div className="card-header justify-content-between">
                      <div className="card-title">Breadcrumb Style-2</div>
                      <div className="prism-toggle">
                        <button className="btn btn-sm btn-primary-light">
                          Show Code
                          <i className="ri-code-line ms-2 d-inline-block align-middle" />
                      ...
                      <div className="example">
                        <nav aria-label="breadcrumb">
                          <ol className="breadcrumb breadcrumb-style2 mb-0">
                            <li className="breadcrumb-item">
                              <a href="javascript:void(0);">
                                <i className="ti ti-home-2 me-1 fs-15 d-inline-block" />
                                Home
                              </a>
                            </li>
                            <li className="breadcrumb-item">
                              <a href="javascript:void(0);">
                                <i className="ti ti-apps me-1 fs-15 d-inline-block" />
                                About
                              </a>
                            </li>
                            <li
                    ...
                    <div className="card-footer d-none border-top-0">
                      ...
                      <pre className="language-html">
                        <code className="language-html">
                          &lt;nav aria-label="breadcrumb"&gt;{"\n"}&lt;ol
                          class="breadcrumb breadcrumb-style2 mb-0"&gt;{"\n"}
                          {"    "}&lt;li class="breadcrumb-item"&gt;&lt;a
                          href="javascript:void(0);"&gt;&lt;i class="ti
                          ti-home-2 me-1
                          fs-15"&gt;&lt;/i&gt;Home&lt;/a&gt;&lt;/li&gt;{"\n"}
                          {"    "}&lt;li class="breadcrumb-item"&gt;&lt;a
                          href="javascript:void(0);"&gt;&lt;i class="ti ti-apps
                          me-1 fs-15"&gt;&lt;/i&gt;About&lt;/a&gt;&lt;/li&gt;
                          {"\n"}
                          {"    "}&lt;li class="breadcrumb-item active"
