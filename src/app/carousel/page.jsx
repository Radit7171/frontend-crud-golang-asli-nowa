        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">CAROUSEL</h1>
              ...
              <div className="col-xl-4 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Slides Only</div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div id="carouselExampleSlidesOnly" class="carousel
                        slide" data-bs-ride="carousel"&gt;{"\n"}
                        {"    "}&lt;div class="carousel-inner"&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item active"&gt;
                        {"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-26.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-27.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-33.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;
                      </code>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-28.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-31.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-32.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-25.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-29.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-30.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;button class="carousel-control-prev"
            ...
            <div className="row">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-59.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        ...
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-60.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"            "}&lt;div class="carousel-caption d-none
                        d-md-block"&gt;{"\n"}
                        {"                "}&lt;h5&gt;Second slide
                        ...
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-61.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"            "}&lt;div class="carousel-caption d-none
                        d-md-block"&gt;{"\n"}
                        {"                "}&lt;h5&gt;Third slide
              ...
              <div className="col-xl-4 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Cross fade</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-43.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-44.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-45.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;button class="carousel-control-prev"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        data-bs-interval="10000"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-40.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"
                        data-bs-interval="2000"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-41.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-42.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;button class="carousel-control-prev"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-13.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-14.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-18.jpg" class="d-block
                        w-100" alt="..."&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;button class="carousel-control-prev"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        carousel-dark slide" data-bs-ride="carousel"&gt;{"\n"}
                        {"    "}&lt;div class="carousel-indicators"&gt;{"\n"}
                        {"        "}&lt;button type="button"
                        data-bs-target="#carouselExampleDark"
                        data-bs-slide-to="0"
                        ...
                        data-bs-interval="10000"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-63.jpg" class="d-block
                        w-100"{"\n"}
                        {"                "}alt="..."&gt;{"\n"}
                        {"            "}&lt;div class="carousel-caption d-none
                        d-md-block"&gt;{"\n"}
                        ...
                        data-bs-interval="2000"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-64.jpg" class="d-block
                        w-100"{"\n"}
                        {"                "}alt="..."&gt;{"\n"}
                        {"            "}&lt;div class="carousel-caption d-none
                        d-md-block"&gt;{"\n"}
                        ...
                        {"\n"}
                        {"                "}&lt;p class="op-7"&gt;Some
                        representative placeholder content for the second
                        slide.&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="carousel-item"&gt;{"\n"}
                        {"            "}&lt;img
                        src="/assets/images/media/media-62.jpg" class="d-block
                        w-100"{"\n"}
                        {"                "}alt="..."&gt;{"\n"}
                        {"            "}&lt;div class="carousel-caption d-none
                        d-md-block"&gt;{"\n"}
