...
export default function Apex_rangearea_charts() {
          ...
          <div className="container-fluid">
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header">
                    <div className="card-title">Basic Range Area Chart</div>
                  </div>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header">
                    <div className="card-title">Combo Range Area Chart</div>
                  </div>
                  <div className="card-body">
