...
export default function Apex_area_charts() {
                ...
                <div className="card custom-card">
                  <div className="card-header d-flex">
                    ...
                    <div className="btn-group ms-auto">
                      <button className="btn btn-primary btn-sm" id="one_month">
                        1M
                      </button>
                      <button
                        className="btn btn-primary btn-sm"
                      ...
                      <button className="btn btn-primary btn-sm" id="one_year">
                        1Y
                      </button>
                      <button className="btn btn-primary btn-sm" id="all">
                        ALL
                      </button>
