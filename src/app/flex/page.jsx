        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">FLEX</h1>
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="bd-example flex-container mb-3">
                      ...
                      <div className="d-flex mb-3" style={{ height: 100 }}>
                        <div className="p-2">Flex item</div>
                        <div className="align-self-baseline p-2">
                          Aligned flex item
                        </div>
                        <div className="p-2">Flex item</div>
                      </div>
                      <div className="d-flex" style={{ height: 100 }}>
                        <div className="p-2">Flex item</div>
                        <div className="align-self-stretch p-2">
                          Aligned flex item
                        </div>
                        <div className="p-2">Flex item</div>
                      </div>
                ...
                <div className="row">
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      <div className="card-header">
                        <div className="card-title">
                          Align content ( Heads up! This property has no effect
                          on single rows of flex items.)
                        </div>
                      </div>
                      <div className="card-body">
                        <div className="bd-example flex-container mb-3">
                          <div
                            className="d-flex align-content-start flex-wrap mb-3"
                            style={{ height: 200 }}
                          >
                            <div className="p-2">Flex item</div>
                            <div className="p-2">Flex item</div>
                          ...
                          <div
                            className="d-flex align-content-end flex-wrap mb-3"
                            style={{ height: 200 }}
                          >
                            <div className="p-2">Flex item</div>
                            <div className="p-2">Flex item</div>
                          ...
                          <div
                            className="d-flex align-content-center flex-wrap mb-3"
                            style={{ height: 200 }}
                          >
                            <div className="p-2">Flex item</div>
                            <div className="p-2">Flex item</div>
                          ...
                          <div
                            className="d-flex align-content-between flex-wrap mb-3"
                            style={{ height: 200 }}
                          >
                            <div className="p-2">Flex item</div>
                            <div className="p-2">Flex item</div>
                          ...
                          <div
                            className="d-flex align-content-around flex-wrap mb-3"
                            style={{ height: 200 }}
                          >
                            <div className="p-2">Flex item</div>
                            <div className="p-2">Flex item</div>
                          ...
                          <div
                            className="d-flex align-content-stretch flex-wrap mb-3"
                            style={{ height: 200 }}
                          >
                            <div className="p-2">Flex item</div>
                            <div className="p-2">Flex item</div>
                  ...
                  <div className="card-body">
                    <div className="d-flex mb-3">
                      <div className="flex-shrink-0">
                        <img
                          className="bd-placeholder-img card-img w-10 h-10"
                    ...
                    <div className="d-flex align-items-center">
                      <div className="flex-shrink-0">
                        <img
                          className="bd-placeholder-img card-img avatar-xl"
