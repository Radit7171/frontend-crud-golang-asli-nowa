                ...
                <div className="card custom-card">
                  <div className="card-body">
                    <div className="d-lg-flex">
                      ...
                      <div className="ms-auto">
                        <p className="mb-1">
                          <span className="fw-bold">Invoice No : #000321</span>
                        </p>
                      </div>
                    </div>
                    <div className="row row-sm">
                    ...
                    <div className="table-responsive mg-t-40">
                      <table className="table table-invoice table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td className="text-end tx-uppercase tx-bold tx-inverse">
                              TOTAL DUE
                            </td>
                            <td className="text-end" colSpan={2}>
                  ...
                  <div className="card-footer d-flex justify-content-end">
                    <div className="btn-list">
                      ...
                      >
                        <i className="fe fe-credit-card me-1" /> Pay Invoice
                      </button>
                      <button
                        type="button"
                        className="btn ripple btn-secondary mb-1"
                      >
                        <i className="fe fe-send me-1" /> Send Invoice
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        <i className="fe fe-printer me-1" /> Print Invoice
                      </button>
                    </div>
                  </div>
                </div>
