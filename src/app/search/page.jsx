            ...
            <div className="row">
              <div className="col-sm-12 col-md-12">
                <div className="card custom-card">
                  ...
                  <div className="card-body ps-0 pe-0 bd-t-0 pt-0">
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body pt-0">
                    <h6 className="fs-13">
                      In a bustling city, there lived a lonely girl named Lily.
                      One day, while exploring an overgrown, abandoned lot in
                      neighborhood
                    </h6>
                    <p className="mb-0 text-muted">
                      In a bustling city, there lived a lonely girl named Lily.
                      One day, while exploring an overgrown, abandoned lot in
                      her neighborhood, she stumbled upon a magical garden
                      filled with talking animals and enchanted plants. Each
                      creature had a unique story to tell, and the garden itself
                      held secrets from a time long forgotten. Lily's discovery
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body pt-0">
                    <div className="mb-2">
                      <a href="javascript:void(0);" className="h5 text-dark">
                        Templist – HTML5 Digital Marketplace Template by ...
                      </a>
                    </div>
                    <a
                      href="https://spruko.com/demo/templist/"
                      target="_blank"
                    ...
                    <div>
                      <a href="javascript:void(0);">
                        <i className="fa fa-star text-warning fs-16" />
                      </a>
                      <a href="javascript:void(0);">
                        <i className="fa fa-star text-warning fs-16" />
                      </a>
                      ...
                      <a href="javascript:void(0);">
                        <i className="fa fa-star-o text-warning fs-16" />
                      </a>
                      <a
                        href="javascript:void(0);"
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body pt-0">
                    <h6 className="fs-13">
                      ...
                      esse cillum dolore eu fugiat nulla pariatur eu fugiat
                      nulla pariatur
                    </h6>
                    <p className="mb-0 text-muted">
                      In a bustling city, there lived a lonely girl named Lily.
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body pt-0">
                    <div className="mb-2">
                      <a href="javascript:void(0);" className="h4 text-dark">
                        User related Images
                      </a>
                    </div>
