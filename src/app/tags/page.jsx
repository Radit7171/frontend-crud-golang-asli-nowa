          ...
          <div className="main-container container-fluid">
            ...
            <div className="row">
              <div className="col-xl-6 col-lg-12">
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="main-content-label mg-b-5">DEFAULT TAG</div>
                    <p className="mg-b-20">
                    ...
                    <div className="text-wrap">
                      <div className="example">
                        <div className="tags">
                          <span className="tag">
                            First tag
                            <a href="javascript:void(0)" className="tag-addon">
                              <i className="fe fe-x" />
                            </a>
                          </span>
                          <span className="tag">
              ...
              <div className="col-xl-6 col-lg-12">
                <div className="card">
                  <div className="card-body">
                    <div className="main-content-label mg-b-5">Link Tag</div>
                    <p className="mg-b-20">
                      It is Very Easy to Customize and it uses in your website
                      aplication.
                    </p>
                      ...
                      <div className="example">
                        <div className="tags">
                          <span className="tag tag-rounded">
                            ...
                            <a
                              href="javascript:void(0)"
                              className="tag-addon rounded-pill"
                            >
                              <i className="fe fe-x" />
                            </a>
                          </span>
                      ...
                      <div className="example">
                        <div className="tags">
                          <span className="tag tag-primary br-5">
                            ...
                            <a
                              href="javascript:void(0)"
                              className="tag-addon bg-primary"
                            >
                              <i className="fe fe-x" />
                            </a>{" "}
                          </span>
                          <span className="tag tag-secondary br-5">
                            ...
                            <a
                              href="javascript:void(0)"
                              className="tag-addon bg-secondary"
                            >
                              <i className="fe fe-x" />
                            </a>{" "}
                          </span>
                          <span className="tag tag-success br-5">
                            success tag
                            <a
                              href="javascript:void(0)"
                          ...
                          <span className="tag tag-warning br-5">
                            warning tag
                            <a
                              href="javascript:void(0)"
                              className="tag-addon bg-warning"
                            >
                              <i className="fe fe-x" />
                            </a>{" "}
                          </span>
                          <span className="tag tag-teal br-5">
                            teal tag
                            <a
                              href="javascript:void(0)"
                              className="tag-addon bg-teal"
                            >
                              <i className="fe fe-x" />
                            </a>{" "}
                          </span>
                          <span className="tag tag-danger br-5">
                            danger tag
                            <a
                              href="javascript:void(0)"
                              className="tag-addon bg-danger"
                            >
                              <i className="fe fe-x" />
                            </a>{" "}
                          </span>
