                    ...
                    <div className="">
                      <span className="profile-image position-relative">
                        <img
                          className="br-5"
                          alt=""
                          src="/assets/images/faces/profile.jpg"
                        />
              ...
              <div className="col-lg-12 col-md-12">
                <div className="custom-card main-content-body-profile">
                  <div className="tab-content">
                    <div
                      className="main-content-body tab-pane p-0 border-0 active"
                      id="about"
                    >
                      <div className="card">
                        <div className="card-body p-0 border-0 p-0 rounded-10">
                          <div className="p-4">
                            ...
                            <p className="m-b-5">
                              ...
                              unknown printer took a galley of type. Donec pede
                              ...
                              pede mollis pretium. Integer tincidunt.Cras
                            ...
                            <div className="m-t-30">
                              <div className=" p-t-10">
                                <p className="text-primary mb-2 fs-14 fw-semibold">
                              ...
                              <div className="">
                                <p className="text-primary fw-semibold mb-2 fs-14">
                            ...
                            <div className="profile-cover__info ms-4 ms-auto p-0">
                              <ul className="nav p-0 border-bottom-0 mb-0 gap-4">
                                <li className="border p-2 br-5 bg-light wd-100 ht-70">
                                  <span className="border-0 mb-1 pb-0 lh-1">
                                    113
                                  </span>
                                  Projects
                                </li>
                                ...
                                <div className="main-profile-social-list">
                                  <div className="media">
                                    ...
                                    <div className="media-body">
                                      {" "}
                                      <span>Twitter</span>{" "}
                                      <a href="">twitter.com/spruko.me</a>{" "}
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div className="main-profile-social-list">
                                  <div className="media">
                                    ...
                                    <div className="media-body">
                                      {" "}
                                      <span>Linkedin</span>{" "}
                                      <a href="">linkedin.com/in/spruko</a>{" "}
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="row row-sm">
                                ...
                                <div className="col-md-9">
                                  <input
                                    ...
                                    defaultValue="javascript:void(0);Nowa"
                                  />
                                </div>
                              </div>
                            </div>
                                  ...
                                  <div className="p-4">
                                    <div className="media">
                                      ...
                                      <div className="ms-auto">
                                        <div className="dropdown show main-contact-star">
                                          {" "}
                                          <a
                                            ...
                                            href="JavaScript:void(0);"
                                          >
                                            <i className="fe fe-more-vertical  fs-18" />
                                          </a>
                                      ...
                                      <div className="col">
                                        <a href="gallery.html">
                                          <img
                                            ...
                                            src="/assets/images/media/media-91.jpg"
                                          />
                                        </a>
                                        <a href="gallery.html">
                                          <img
                                            ...
                                            src="/assets/images/media/media-92.jpg"
                                          />
                                        </a>
                                      </div>
                                    </div>
                                      ...
                                      <div className="col">
                                        <a href="gallery.html">
                                          <img
                                            alt="img"
                                            className="wd-200 br-5 mb-2 mt-2 me-4"
                                            src="/assets/images/media/media-94.jpg"
                                          />
                                        </a>
                                        <a href="gallery.html">
                                          <img
                                      ...
                                      <div className="col">
                                        ...
                                        <a href="gallery.html">
                                          <img
                                            alt="img"
                                            className="wd-200 br-5 mb-2 mt-2"
                                            src="/assets/images/media/media-93.jpg"
                                          />
                                        </a>
                                      </div>
                                    </div>
                    ...
                    <div
                      className="main-content-body border-0 tab-pane p-0"
                      id="gallery"
                    >
                      <div className="card">
                        <div className="card-body">
                          <div className="row">
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-6">
                              <a
                                href="/assets/images/photos/9.jpg"
                                className="glightbox card"
                                data-gallery="gallery1"
                              >
                                <img
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-6">
                              <a
                                href="/assets/images/photos/10.jpg"
                                className="glightbox card"
                                data-gallery="gallery1"
                              >
                                <img
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-6">
                              <a
                                href="/assets/images/photos/11.jpg"
                                className="glightbox card"
                                data-gallery="gallery1"
                              >
                                <img
                            ...
                            <div className="col-xl-3 col-lg-4 col-sm-6">
                              <a
                                href="/assets/images/photos/12.jpg"
                                className="glightbox card"
                                data-gallery="gallery1"
                              >
                                <img
                    ...
                    <div
                      className="main-content-body tab-pane border-0 p-0"
                      id="friends"
                    >
                      <div className="card">
                          ...
                          <div className="row row-sm">
                            <div className="col-sm-12 col-md-6 col-lg-6 col-xl-3">
                              <div className="card custom-card border">
                                <div className="card-body  user-lock text-center">
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="form-group float-end">
                              <div className="row row-sm">
                                <div className="col-md-12 btn-list">
                                  <a
                                    className="mg-r-20 btn btn-primary"
                                    href="javascript:void(0);"
                                  >
                                    Deactivate Account
                                  </a>
