          ...
          <div className="main-container container-fluid">
            ...
            <div className="row">
              <div className="col-xxl-6 col-xl-12 col-lg-12 col-md-12">
                <div className="card overflow-hidden">
                  <a
                    ...
                    className="custom-card card-img-top-1 background-image-blog mb-0"
                  ></a>
                  <div className="card-body">
                    <a href="javascript:void(0);" className="mt-4">
                      <h5 className="fw-semibold">
                        Best Place To visit For a Holiday idea of denouncing
                        pleasure?
                      </h5>
                    </a>
                  ...
                  <div className="card-footer">
                    <div className="item7-card-desc d-sm-flex mt-0">
                      <a href="profile.html" className="d-flex">
                        <span className="fe fe-user text-muted me-2 fs-17" />
                        <div className="mt-0 mt-0  fw-semibold text-muted">
                          Anna Ogden
                        </div>
                      </a>
                      <div className="d-sm-flex ms-sm-auto">
                        <a href="javascript:void(0);" className="d-flex me-3">
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6  col-sm-6">
                <div className="card custom-card card-img-top-1">
                  ...
                  <div className="card-body pb-0">
                    ...
                    <p className="mb-2">
                      Those who do not know how pursues or desires to occur in
                      which toil and pain can procure him some great pleasure.
                      To take a trivial example pain was born and I will give
                    ...
                    <div className="ms-auto">
                      <a className="me-0 d-flex" href="javascript:void(0);">
                        <span className="phone me-3 fw-semibold text-muted">
                          <span className="fe fe-calendar text-muted me-2 fs-16 d-inline-block" />
                          Aug 01,2021
                        </span>
                      </a>
                    </div>
                  ...
                  <div className="card-body">
                    ...
                    <div className="media d-flex mb-4">
                      <img
                        alt=""
                        className="main-img-user avatar avatar-lg me-4 br-5"
                        src="/assets/images/photos/blog4.jpg"
                      />
                      <div className="media-body">
                        <span className="d-block">Literature</span>
                        <p className="mb-0 fw-semibold">
                          English and spanish classes in Your way
                        </p>
                    ...
                    <div className="media d-flex mb-3">
                      <img
                        alt=""
                        className="main-img-user avatar avatar-lg me-4 br-5"
                        src="/assets/images/photos/blog6.jpg"
                      />
                      <div className="media-body">
                    ...
                    <div className="list-group list-lg-group list-group-flush">
                      <div className="list-group-item list-group-item-action">
                        <div className="media mt-0">
                          <a href="profile.html">
                            <img
                              className="avatar avatar-lg rounded-circle me-3 my-auto"
                          ...
                          <div className="media-body">
                            <div className="d-flex align-items-center">
                              ...
                              <span className="ms-auto wd-45p fs-12">
                                <span id="spark1" className="wd-100p" />
                        ...
                        <div className="media mt-0">
                          ...
                          <div className="media-body">
                            <div className="d-flex align-items-center">
                              ...
                              <span className="ms-auto wd-45p fs-12">
                                <span id="spark2" className="wd-100p" />
                        ...
                        <div className="media mt-0">
                          ...
                          <div className="media-body">
                            <div className="d-flex align-items-center">
                              ...
                              <span className="ms-auto wd-45p fs-12">
                                <span id="spark3" className="wd-100p" />
                                <span className="float-end badge bg-danger-transparent ">
                                  <span className="op-7 text-danger fw-semibold">
                                    1 hr ago
                                  </span>
                        ...
                        <div className="media mt-0">
                          ...
                          <div className="media-body">
                            <div className="d-flex align-items-center">
                              ...
                              <span className="ms-auto wd-45p fs-12">
                                <span id="spark6" className="wd-100p" />
                                <span className="float-end badge bg-success-transparent ">
                                  <span className="op-7 text-success fw-semibold">
                                    3 days ago
                                  </span>
                        ...
                        <div className="media mt-0">
                          ...
                          <div className="media-body">
                            <div className="d-flex align-items-center">
                              ...
                              <span className="ms-auto wd-45p fs-12">
                                <span id="spark4" className="wd-100p" />
                                <span className="float-end badge bg-danger-transparent ">
                                  <span className="op-7 text-danger fw-semibold">
                                    22 hrs ago
                                  </span>
                        ...
                        <div className="media mt-0">
                          ...
                          <div className="media-body">
                            <div className="d-flex align-items-center">
                              ...
                              <span className="ms-auto wd-45p fs-12">
                                <span id="spark5" className="wd-100p" />
                                <span className="float-end badge bg-danger-transparent ">
                                  <span className="op-7 text-danger fw-semibold">
                                    1 day ago
                                  </span>
            ...
            {/* /row */}
            <ul className="pagination product-pagination ms-auto float-sm-end">
