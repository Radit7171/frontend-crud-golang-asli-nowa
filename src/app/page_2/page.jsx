          ...
          <div className="main-container container-fluid">
            ...
            <div className="row">
              <div className="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 px-0">
                  <div className="card px-3 ps-4">
                    <div className="row index1">
                      <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xxl-3">
                        <div className="row border-end bd-sm-e-0 p-3">
                          <div className="col-2 d-flex align-items-center justify-content-center">
                            <div className="circle-icon bg-primary text-center align-self-center overflow-hidden shadow">
                              <i className="fe fe-shopping-bag fs-15 text-fixed-white" />
                            </div>
                          </div>
                          <div className="col-10 py-0">
                            <div className="pt-4 pb-3">
                              <div className="d-flex">
                                <span className="mb-2 fs-12 d-block">
                                  Today Orders
                                </span>
                                <span className="badge bg-success-transparent text-success fw-semibold ms-auto rounded-pill lh-maincard px-2 my-auto">
                                  <i className="bx bx-caret-up me-1" />
                                  0.11%
                                </span>
                              </div>
                      ...
                      <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xxl-3">
                        <div className="row border-end bd-md-e-0 bd-xs-e-0 bd-lg-e-0 bd-xl-e-0 bd-xxl-e-0  p-3">
                          <div className="col-2 d-flex align-items-center justify-content-center">
                            <div className="circle-icon bg-warning text-center align-self-center overflow-hidden shadow">
                              <i className="fe fe-dollar-sign fs-15 text-fixed-white" />
                            </div>
                          </div>
                        ...
                        <div className="row border-end bd-sm-e-0  p-3">
                          <div className="col-2 d-flex align-items-center justify-content-center">
                            <div className="circle-icon bg-secondary text-center align-self-center overflow-hidden shadow">
                              <i className="fe fe-external-link fs-15 text-fixed-white" />
                            </div>
                          </div>
                          <div className="col-10">
                            <div className="pt-4 pb-3">
                        ...
                        <div className="row  p-3">
                          <div className="col-2 d-flex align-items-center justify-content-center">
                            <div className="circle-icon bg-info text-center align-self-center overflow-hidden shadow">
                              <i className="fe fe-credit-card fs-15 text-fixed-white" />
                            </div>
                          </div>
                          <div className="col-10">
                            <div className="pt-4 pb-3">
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                              ...
                              <p className="fs-11 text-muted">
                                ...
                                <span className="text-success ms-2">
                                  <i className="bx bx-caret-up me-2" />
                            ...
                            <div className="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                              ...
                              <p className="fs-11 text-muted">
                                ...
                                <span className="text-danger ms-2">
                                  <i className="bx bx-caret-down me-2" />
                                  <span className="badge bg-danger text-white fs-11">
                                    0.15%
                                  </span>
                                </span>
                              </p>
                            ...
                            <div className="mb-4">
                              <div className="d-flex">
                                ...
                                <div className="ms-auto">
                                  ...
                                  <span className="number-font">$32,879</span>{" "}
                                  (65%)
                                </div>
                              </div>
                            ...
                            <div className="mb-4">
                              <div className="d-flex mb-1">
                                ...
                                <div className="ms-auto">
                                  ...
                                  <span className="number-font">$22,710</span>{" "}
                                  (55%)
                                </div>
                              </div>
                              <div className="progress progress-style ht-5 mt-2 mb-4">
                            ...
                            <div className="mb-4">
                              <div className="d-flex">
                                ...
                                <div className="ms-auto">
                                  ...
                                  <span className="number-font">$56,291</span>{" "}
                                  (69%)
                                </div>
                              </div>
                              <div className="progress progress-style ht-5 mt-2 mb-4">
                            ...
                            <div className="mb-4">
                              <div className="d-flex">
                                ...
                                <div className="ms-auto">
                                  ...
                                  <span className="number-font">$34,209</span>{" "}
                                  (60%)
                                </div>
                              </div>
                              <div className="progress progress-style ht-5 mt-2 mb-4">
                            ...
                            <div className="mb-4">
                              <div className="d-flex">
                                ...
                                <div className="ms-auto">
                                  ...
                                  <span className="number-font">$45,870</span>{" "}
                                  (86%)
                                </div>
                              </div>
                              <div className="progress progress-style ht-5 mt-2 mb-4">
                            ...
                            <div className="mb-3 pb-1">
                              <div className="d-flex">
                                ...
                                <div className="ms-auto">
                                  ...
                                  <span className="number-font">$67,357</span>{" "}
                                  (73%)
                                </div>
                              </div>
                              <div className="progress progress-style ht-5 mt-2 mb-4">
                          ...
                          <div className="">
                            <label className="p-2 d-flex">
                              ...
                              <span className="ms-auto flex-shrink-0">
                                <span className="badge bg-primary fw-semibold px-2 py-1 fs-11 me-2">
                                  Today
                                </span>
                              </span>
                            </label>
                            ...
                            <label className="p-2 mt-2 d-flex">
                              ...
                              <span className="ms-auto flex-shrink-0">
                                <span className="badge bg-primary fw-semibold px-2 py-1 fs-11 me-2 float-end">
                                  22 hrs
                                </span>
                              </span>
                            </label>
              ...
              <div className="col-xxl-3 col-xl-12 col-lg-12 col-md-12 col-xs-12">
                            ...
                            <div className="media-body flex-fill">
                              <div className="d-flex align-items-center">
                                ...
                                <span className="ms-auto wd-25p fs-12">
                                  <span className="text-primary fs-11 text-end d-block">
                                    Processing
                                  </span>
                ...
                <div className="card overflow-hidden">
                  ...
                  <div className="card-body p-0 customers mt-1">
                    <div className="list-group list-lg-group list-group-flush">
                          ...
                          <div className="media mt-0">
                            ...
                            <div className="media-body flex-fill">
                              <div className="d-flex align-items-center flex-wrap">
                                ...
                                <span className="ms-auto fs-14 flex-shrink-0">
                      ...
                      <a href="#" className="border-0 mb-3">
                        <div className="list-group-item list-group-item-action border-0">
                          <div className="media mt-0">
                            <img
                              className="avatar-lg rounded-circle me-3 my-auto shadow"
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="">
                              <a
                                className="btn btn-success btn-sm br-5 me-2"
                              ...
                              <a
                                className="btn btn-danger btn-sm br-5"
                                href="javascript:void(0)"
                              >
                                <i>
                                  <svg
