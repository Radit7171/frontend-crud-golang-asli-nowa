        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">TOASTS</h1>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-wave" id="liveToastBtn"&gt;Show live{"\n"}
                        {"    "}toast&lt;/button&gt;{"\n"}&lt;div
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;div class="d-flex"&gt;{"\n"}
                        {"        "}&lt;div class="toast-body"&gt;{"\n"}
                        {"            "}Hello, world! This is the Primary toast
                        message.{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        ...
                        aria-label="Close"&gt;&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast align-items-center text-bg-secondary
                        border-0 fade show mb-4"{"\n"}
                        {"    "}role="alert" aria-live="assertive"
                        aria-atomic="true"&gt;{"\n"}
                        {"    "}&lt;div class="d-flex"&gt;{"\n"}
                        {"        "}&lt;div class="toast-body"&gt;{"\n"}
                        {"            "}Hello, world! This is the Secondary
                        toast.
                        {"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close
                        ...
                        {"    "}&lt;div class="d-flex"&gt;{"\n"}
                        {"        "}&lt;div class="toast-body"&gt;{"\n"}
                        {"            "}Hello, world! This is the Success toast
                        message.{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close
                        btn-close-white me-2 m-auto"{"\n"}
                        ...
                        {"    "}&lt;div class="d-flex"&gt;{"\n"}
                        {"        "}&lt;div class="toast-body"&gt;{"\n"}
                        {"            "}Hello, world! This is the info toast
                        message.{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close
                        btn-close-white me-2 m-auto"{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"        "}&lt;img class="bd-placeholder-img rounded
                        me-2" src="/assets/images/brand-logos/favicon.ico"
                        alt="..."&gt;
                        {"\n"}
                        {"\n"}
                        {"        "}&lt;strong
              ...
              <div className="col-xl-4">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"        "}&lt;strong
                        class="me-auto"&gt;Nowa&lt;/strong&gt;{"\n"}
                        {"        "}&lt;small class="text-muted"&gt;11 mins
                        ago&lt;/small&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="toast"{"\n"}
                        {"            "}aria-label="Close"&gt;&lt;/button&gt;
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="toast align-items-center fade show mb-3"
                        role="alert"{"\n"}
                        {"    "}aria-live="assertive" aria-atomic="true"&gt;
                        {"\n"}
                        {"    "}&lt;div class="d-flex"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close
                        me-2 m-auto" data-bs-dismiss="toast"{"\n"}
                        {"            "}aria-label="Close"&gt;{"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div&gt;
                        {"\n"}
                        {"    "}&lt;span class="my-4 text-muted"&gt;{"\n"}
                        {"        "}Alternatively, you can also add additional
                        controls and components to{"\n"}
                        {"        "}toasts.{"\n"}
                        {"    "}&lt;/span&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast fade show mt-2" role="alert"
                        aria-live="assertive"{"\n"}
                        {"    "}aria-atomic="true"&gt;{"\n"}
                        {"    "}&lt;div class="toast-body"&gt;{"\n"}
                        {"        "}Hello, world! This is a toast message.{"\n"}
                        ...
                        btn-primary btn-sm btn-wave"&gt;Take{"\n"}
                        {"                "}action&lt;/button&gt;{"\n"}
                        {"            "}&lt;button type="button" class="btn
                        btn-secondary btn-sm btn-wave"{"\n"}
                        {"                "}
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        ...
                        <button
                          type="button"
                          className="btn btn-secondary-light me-2 btn-wave"
                        ...
                        <button
                          type="button"
                          className="btn btn-warning-light me-2 btn-wave"
                          id="warningToastBtn"
                        >
                          warning
                        </button>
                        <button
                          type="button"
                          className="btn btn-info-light me-2 btn-wave"
                          id="infoToastBtn"
                        >
                          info
                        </button>
                        <button
                          type="button"
                          className="btn btn-success-light me-2 btn-wave"
                          id="successToastBtn"
                        >
                          success
                        </button>
                        <button
                          type="button"
                          className="btn btn-danger-light me-2 btn-wave"
                          id="dangerToastBtn"
                        >
                          danger
                        </button>
                      ...
                      <div className="toast-container position-fixed top-0 end-0 p-3">
                        <div
                          id="primaryToast"
                          className="toast colored-toast bg-primary-transparent"
                          role="alert"
                          aria-live="assertive"
                          aria-atomic="true"
                        >
                          <div className="toast-header bg-primary text-fixed-white">
                            <img
                              className="bd-placeholder-img rounded me-2"
                              src="/assets/images/brand-logos/toggle-dark.png"
                              alt="..."
                        ...
                        <div
                          ...
                          aria-atomic="true"
                        >
                          <div className="toast-header bg-secondary text-fixed-white">
                            <img
                              className="bd-placeholder-img rounded me-2"
                              src="/assets/images/brand-logos/toggle-dark.png"
                              alt="..."
                        ...
                        <div
                          ...
                          aria-atomic="true"
                        >
                          <div className="toast-header bg-warning text-fixed-white">
                            <img
                              className="bd-placeholder-img rounded me-2"
                              src="/assets/images/brand-logos/toggle-dark.png"
                              alt="..."
                        ...
                        <div
                          ...
                          aria-atomic="true"
                        >
                          <div className="toast-header bg-info text-fixed-white">
                            <img
                              className="bd-placeholder-img rounded me-2"
                              src="/assets/images/brand-logos/toggle-dark.png"
                              alt="..."
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-primary-light me-2 btn-wave"
                        id="primaryToastBtn"&gt;Primary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary-light me-2 btn-wave"
                        id="secondaryToastBtn"&gt;secondary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-warning-light me-2 btn-wave"
                        id="warningToastBtn"&gt;warning&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-info-light me-2 btn-wave"
                        id="infoToastBtn"&gt;info&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-success-light me-2 btn-wave"
                        id="successToastBtn"&gt;success&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-danger-light me-2 btn-wave"
                        id="dangerToastBtn"&gt;danger&lt;/button&gt;
                        {"\n"}&lt;/div&gt;{"\n"}&lt;div class="toast-container
                        position-fixed top-0 end-0 p-3"&gt;{"\n"}
                        {"    "}&lt;div id="primaryToast" class="toast
                        colored-toast bg-primary-transparent" role="alert"
                        aria-live="assertive"
                        {"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="secondaryToast" class="toast
                        colored-toast bg-secondary-transparent" role="alert"
                        aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="warningToast" class="toast
                        colored-toast bg-warning-transparent" role="alert"
                        aria-live="assertive"
                        {"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        ...
                        colored-toast bg-info-transparent" role="alert"
                        aria-live="assertive"
                        {"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        ...
                        colored-toast bg-success-transparent" role="alert"
                        aria-live="assertive"
                        {"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        ...
                        colored-toast bg-danger-transparent" role="alert"
                        aria-live="assertive"
                        {"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}&lt;/div&gt;{"\n"}&lt;div class="toast-container
                        position-fixed top-0 end-0 p-3"&gt;{"\n"}
                        {"    "}&lt;div id="solid-primaryToast" class="toast
                        colored-toast bg-primary text-fixed-white" role="alert"
                        aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        text-fixed-white"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="solid-secondaryToast" class="toast
                        colored-toast bg-secondary text-fixed-white"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-secondary
                        text-fixed-white"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="solid-warningToast" class="toast
                        colored-toast bg-warning text-fixed-white" role="alert"
                        aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-warning
                        text-fixed-white"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="solid-infoToast" class="toast
                        colored-toast bg-info text-fixed-white" role="alert"
                        aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-info
                        text-fixed-white"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="solid-successToast" class="toast
                        colored-toast bg-success text-fixed-white" role="alert"
                        aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-success
                        text-fixed-white"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div id="solid-dangerToast" class="toast
                        colored-toast bg-danger text-fixed-white" role="alert"
                        aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-danger
                        text-fixed-white"&gt;{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-primary me-2 btn-wave"
                        ...
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-primary me-2 btn-wave"
                        id="middlecenterToastBtn"&gt;Middle
                        Center&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-primary me-2 btn-wave"
                        ...
                        {"    "}&lt;div id="topleft-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        text-fixed-white"&gt;{"\n"}
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast-container position-fixed top-0 start-50
                        translate-middle-x p-3"&gt;{"\n"}
                        {"    "}&lt;div id="topcenter-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        p-3"&gt;
                        {"\n"}
                        {"    "}&lt;div id="topright-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast-container position-fixed top-50 start-0
                        translate-middle-y p-3"&gt;{"\n"}
                        {"    "}&lt;div id="middleleft-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast-container position-fixed top-50 start-50
                        translate-middle"&gt;{"\n"}
                        {"    "}&lt;div id="middlecenter-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast-container position-fixed top-50 end-0
                        translate-middle-y p-3"&gt;{"\n"}
                        {"    "}&lt;div id="middleright-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast-container position-fixed bottom-0 start-0
                        p-3"&gt;{"\n"}
                        {"    "}&lt;div id="bottomleft-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="toast-container position-fixed bottom-0 start-50
                        translate-middle-x p-3"&gt;{"\n"}
                        {"    "}&lt;div id="bottomcenter-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
                        ...
                        p-3"&gt;{"\n"}
                        {"    "}&lt;div id="bottomright-Toast" class="toast
                        colored-toast bg-primary-transparent text-primary"
                        role="alert" aria-live="assertive"{"\n"}
                        {"        "}aria-atomic="true"&gt;{"\n"}
                        {"        "}&lt;div class="toast-header bg-primary
              ...
              <div className="col-xl-12">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="bd-example bg-light bd-example-toasts
                        d-flex p-0"&gt;{"\n"}
                        {"    "}&lt;div aria-live="polite" aria-atomic="true"
                        {"\n"}
                        {"        "}class="d-flex justify-content-center
                        align-items-center w-100"&gt;{"\n"}
                        {"        "}&lt;div class="toast fade show shadow-lg"
                        role="alert" aria-live="assertive"{"\n"}
                        {"            "}aria-atomic="true"&gt;{"\n"}
                        {"            "}&lt;div class="toast-header
                        text-default"&gt;{"\n"}
