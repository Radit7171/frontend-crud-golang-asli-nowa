        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">PROGRESS</h1>
            ...
            <div className="row">
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Different Colored Progress</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Striped Progress</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        progress-bar-striped" style="width: 10%"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress mb-3" role="progressbar"
                        aria-valuenow="25" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar progress-bar-striped
                        bg-secondary" style="width: 25%"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress mb-3" role="progressbar"
                        ...
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar progress-bar-striped
                        bg-info" style="width: 75%"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress" role="progressbar" aria-valuenow="100"
                        aria-valuemin="0"{"\n"}aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar progress-bar-striped
                        bg-warning" style="width: 100%"&gt;&lt;/div&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Progress Height</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        style="width: 10%"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-sm mb-3" role="progressbar"
                        aria-valuenow="25" aria-valuemin="0"
                        aria-valuemax="100"&gt;
                        {"\n"}
                        {"    "}&lt;div class="progress-bar bg-primary"
                        ...
                        style="width: 50%"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-lg mb-3" role="progressbar"
                        aria-valuenow="75" aria-valuemin="0"
                        aria-valuemax="100"&gt;
                        {"\n"}
                        {"    "}&lt;div class="progress-bar bg-primary"
                        style="width: 75%"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-xl" role="progressbar"
                        aria-valuenow="100" aria-valuemin="0"{"\n"}
                        {"        "}aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-primary"
                        style="width: 100%"&gt;&lt;/div&gt;{"\n"}&lt;/div&gt;
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Progress With Labels</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Multiple bars With Sizes</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Animated Stripped Progress</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Gradient Progress</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"    "}&lt;div class="progress-bar
                        bg-secondary-gradient" style="width:
                        20%"&gt;&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}
                        &lt;div class="progress mb-3" role="progressbar"
                        aria-valuenow="40" aria-valuemin="0"
                        aria-valuemax="100"&gt;
            ...
            <div className="row">
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Custom Progress-1</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      ...
                      <div
                        ...
                        aria-valuemax={100}
                      >
                        <h6 className="progress-bar-title bg-secondary">
                          Watches
                        </h6>
                        <div
                          className="progress-bar bg-secondary"
                          style={{ width: "60%" }}
                        >
                          <div className="progress-bar-value bg-secondary">
                            60%
                          </div>
                        </div>
                      </div>
                      <div
                        ...
                        aria-valuemax={100}
                      >
                        <h6 className="progress-bar-title bg-success">
                          Shirts
                        </h6>
                        <div
                          className="progress-bar bg-success"
                          style={{ width: "70%" }}
                        >
                          <div className="progress-bar-value bg-success">
                            70%
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="progress progress-sm progress-custom mb-5
                        progress-animate" role="progressbar" aria-valuenow="50"
                        aria-valuemin="0" aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;h6
                        class="progress-bar-title"&gt;Mobiles&lt;/h6&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar" style="width:
                        50%"&gt;
                        {"\n"}
                        {"        "}&lt;div
                        class="progress-bar-value"&gt;50%&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-sm progress-custom mb-5
                        progress-animate" role="progressbar" aria-valuenow="60"
                        aria-valuemin="0" aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;h6 class="progress-bar-title
                        bg-secondary"&gt;Watches&lt;/h6&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-secondary"
                        style="width: 60%"&gt;{"\n"}
                        {"        "}&lt;div class="progress-bar-value
                        bg-secondary"&gt;60%&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-sm progress-custom
                        progress-animate" role="progressbar" aria-valuenow="70"
                        aria-valuemin="0" aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;h6 class="progress-bar-title
                        bg-success"&gt;Shirts&lt;/h6&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-success"
                        style="width: 70%"&gt;{"\n"}
                        {"        "}&lt;div class="progress-bar-value
                        bg-success"&gt;70%&lt;/div&gt;{"\n"}
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Custom Progress-2</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        bg-primary"&gt;&lt;/div&gt;&lt;div
                        class="progress-item-2"&gt;&lt;/div&gt;&lt;div
                        class="progress-item-3"&gt;&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar" style="width:
                        50%"&gt;&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-sm mb-4" role="progressbar"
                        aria-valuenow="60" aria-valuemin="0"
                        aria-valuemax="100"&gt;
                        {"\n"}
                        {"    "}&lt;div class="progress-item-1
                        bg-secondary"&gt;&lt;/div&gt;&lt;div
                        class="progress-item-2
                        bg-secondary"&gt;&lt;/div&gt;&lt;div
                        class="progress-item-3"&gt;&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-secondary"
                        style="width: 60%"&gt;&lt;/div&gt;{"\n"}&lt;/div&gt;
                        ...
                        {"\n"}
                        {"    "}&lt;div class="progress-item-1
                        bg-info"&gt;&lt;/div&gt;&lt;div class="progress-item-2
                        bg-info"&gt;&lt;/div&gt;&lt;div class="progress-item-3
                        bg-info"&gt;&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-info"
                        style="width: 80%"&gt;&lt;/div&gt;{"\n"}&lt;/div&gt;
                        ...
                        class="progress-item-2
                        bg-warning"&gt;&lt;/div&gt;&lt;div
                        class="progress-item-3 bg-warning"&gt;&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-warning"
                        style="width: 90%"&gt;&lt;/div&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Custom Progress-3</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                    ...
                    <div className="example">
                      ...
                      >
                        <div
                          ...
                          style={{ width: "60%" }}
                        >
                          <div className="progress-bar-value secondary">
                            60%
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        custom-progress-3 progress-animate" role="progressbar"
                        aria-valuenow="50" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar" style="width:
                        50%"&gt;
                        ...
                        class="progress-bar-value"&gt;50%&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-lg mb-5 custom-progress-3
                        progress-animate" role="progressbar" aria-valuenow="60"
                        aria-valuemin="0" aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-secondary"
                        style="width: 60%"&gt;{"\n"}
                        ...
                        secondary"&gt;60%&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;{"\n"}&lt;div
                        class="progress progress-lg custom-progress-3
                        progress-animate" role="progressbar" aria-valuenow="70"
                        aria-valuemin="0" aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-success"
                        style="width: 70%"&gt;{"\n"}
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Custom Progress-4</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        progress-animate custom-progress-4" role="progressbar"
                        aria-valuenow="10" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-primary-gradient"
                        style="width: 10%"&gt;&lt;/div&gt;{"\n"}
                        {"    "}&lt;div
                        class="progress-bar-label"&gt;10%&lt;/div&gt;{"\n"}
                        &lt;/div&gt;{"\n"}&lt;div class="progress progress-xl
                        mb-3 progress-animate custom-progress-4 secondary"
                        role="progressbar" aria-valuenow="20" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar
                        bg-secondary-gradient" style="width:
                        20%"&gt;&lt;/div&gt;{"\n"}
                        {"        "}&lt;div
                        class="progress-bar-label"&gt;20%&lt;/div&gt;{"\n"}
                        &lt;/div&gt;{"\n"}&lt;div class="progress progress-xl
                        mb-3 progress-animate custom-progress-4 success"
                        role="progressbar" aria-valuenow="40" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-success-gradient"
                        style="width: 40%"&gt;&lt;/div&gt;{"\n"}
                        {"        "}&lt;div
                        class="progress-bar-label"&gt;40%&lt;/div&gt;{"\n"}
                        &lt;/div&gt;{"\n"}&lt;div class="progress progress-xl
                        mb-3 progress-animate custom-progress-4 info"
                        role="progressbar" aria-valuenow="60" aria-valuemin="0"
                        aria-valuemax="100"&gt;
                        {"\n"}
                        {"    "}&lt;div class="progress-bar bg-info-gradient"
                        style="width: 60%"&gt;&lt;/div&gt;{"\n"}
                        {"        "}&lt;div
                        class="progress-bar-label"&gt;60%&lt;/div&gt;{"\n"}
                        &lt;/div&gt;{"\n"}&lt;div class="progress progress-xl
                        mb-3 progress-animate custom-progress-4 warning"
                        role="progressbar" aria-valuenow="80" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-warning-gradient"
                        style="width: 80%"&gt;&lt;/div&gt;{"\n"}
                        {"        "}&lt;div
                        class="progress-bar-label"&gt;80%&lt;/div&gt;{"\n"}
                        &lt;/div&gt;{"\n"}&lt;div class="progress progress-xl
                        progress-animate custom-progress-4 danger"
                        role="progressbar" aria-valuenow="90" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"    "}&lt;div class="progress-bar bg-danger-gradient"
                        style="width: 90%"&gt;&lt;/div&gt;{"\n"}
                        {"        "}&lt;div
                        class="progress-bar-label"&gt;90%&lt;/div&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;h6 class="fw-semibold mb-2"&gt;Project
                        Dependencies&lt;/h6&gt;{"\n"}
                        {"    "}&lt;div class="progress-stacked progress-xl
                        mb-5"&gt;{"\n"}
                        {"        "}&lt;div class="progress-bar"
                        role="progressbar" style="width: 25%"{"\n"}
                        {"            "}aria-valuenow="25" aria-valuemin="0"
                        ...
                        text-muted"&gt;Html&lt;span class="float-end fs-10
                        fw-normal"&gt;25%&lt;/span&gt;&lt;/p&gt;{"\n"}
                        {"                "}&lt;div class="progress progress-xs
                        mb-4 progress-animate" role="progressbar"
                        aria-valuenow="25" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"                    "}&lt;div class="progress-bar
                        bg-primary" style="width: 25%"&gt;{"\n"}
                        {"                    "}&lt;/div&gt;{"\n"}
                        {"                "}&lt;/div&gt;{"\n"}
                        {"                "}&lt;p class="fs-12 fw-semibold mb-0
                        text-muted"&gt;Css&lt;span class="float-end fs-10
                        fw-normal"&gt;35%&lt;/span&gt;&lt;/p&gt;{"\n"}
                        {"                "}&lt;div class="progress progress-xs
                        mb-4 progress-animate" role="progressbar"
                        aria-valuenow="35" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"                    "}&lt;div class="progress-bar
                        bg-secondary" style="width: 35%"&gt;{"\n"}
                        {"                    "}&lt;/div&gt;{"\n"}
                        {"                "}&lt;/div&gt;{"\n"}
                        {"                "}&lt;p class="fs-12 fw-semibold mb-0
                        text-muted"&gt;Js&lt;span class="float-end fs-10
                        fw-normal"&gt;40%&lt;/span&gt;&lt;/p&gt;{"\n"}
                        {"                "}&lt;div class="progress progress-xs
                        mb-0 progress-animate" role="progressbar"
                        aria-valuenow="40" aria-valuemin="0"
                        aria-valuemax="100"&gt;{"\n"}
                        {"                    "}&lt;div class="progress-bar
                        bg-danger" style="width: 40%"&gt;{"\n"}
                        {"                    "}&lt;/div&gt;{"\n"}
                        {"                "}&lt;/div&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
