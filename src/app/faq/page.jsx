                ...
                >
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingcustomicon1One">
                      <button
                        className="accordion-button collapsed fs-15"
                        type="button"
                    ...
                    >
                      <div className="accordion-body fs-14">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <button
                        ...
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon3Three"
                        aria-expanded="true"
                        aria-controls="collapsecustomicon3Three"
                      >
                        3. Can I use this Plugins in Another Template?
                      </button>
                    </h2>
                    <div
                      id="collapsecustomicon3Three"
                      className="accordion-collapse collapse"
                  ...
                  <div className="accordion-item">
                    <h2
                      className="accordion-header"
                      id="headingcustomicon4Four"
                    >
                      <button
                        className="accordion-button collapsed fs-15"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon4Four"
                        aria-expanded="true"
                        aria-controls="collapsecustomicon4Four"
                      >
                        4. It is Easy to Customizable?
                      </button>
                    </h2>
                    <div
                      id="collapsecustomicon4Four"
                      className="accordion-collapse collapse"
                  ...
                  <div className="accordion-item">
                    <h2
                      className="accordion-header"
                      id="headingcustomicon5Five"
                    >
                      <button
                        className="accordion-button collapsed fs-15"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon5Five"
                        aria-expanded="true"
                        aria-controls="collapsecustomicon5Five"
                      >
                        5. How Can I Add another page in Template?
                      </button>
                    </h2>
                    <div
                      id="collapsecustomicon5Five"
                      className="accordion-collapse collapse"
                  ...
                  <div className="accordion-item">
                    <h2 className="accordion-header" id="headingcustomicon6Six">
                      <button
                        className="accordion-button collapsed fs-15"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon6Six"
                        aria-expanded="true"
                        aria-controls="collapsecustomicon6Six"
                      >
                        6. How can I download This template?
                      </button>
                    </h2>
                    <div
                      id="collapsecustomicon6Six"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon6Six"
                      data-bs-parent="#accordioncustomicon1Example"
                    >
                      <div className="accordion-body fs-14">
                        I must explain to you how all this mistaken idea of
                  ...
                  <div className="accordion-item mb-4">
                    <h2
                      className="accordion-header"
                      id="headingcustomicon7Seven"
                    >
                      <button
                        className="accordion-button collapsed fs-15"
                        type="button"
                        data-bs-toggle="collapse"
                        data-bs-target="#collapsecustomicon7Seven"
                        aria-expanded="true"
                        aria-controls="collapsecustomicon7Seven"
                      >
                        7. How To Add additional plugins?
                      </button>
                    </h2>
                    <div
                      id="collapsecustomicon7Seven"
                      className="accordion-collapse collapse"
                      aria-labelledby="headingcustomicon7Seven"
                      data-bs-parent="#accordioncustomicon1Example"
                    >
                      <div className="accordion-body fs-14">
                        I must explain to you how all this mistaken idea of
              ...
              <div className="col-xl-12">
                <div className="card mb-lg-0">
                  ...
                  <div className="card-body">
                    <h6>
                      If Your Query Not Clarified Post Your Question, My
