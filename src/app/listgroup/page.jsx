  ...
  <div className="page">
    ...
    <div className="main-content app-content">
      <div className="container-fluid">
        ...
        <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
          <h1 className="page-title fw-semibold fs-18 mb-0">LIST GROUP</h1>
        ...
        <div className="row">
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Basic List</div>
                  ...
                  <ul className="list-group">
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2 fw-semibold">Alicia Sierra</div>
                      </div>
                    </li>
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2 fw-semibold">Samantha Mery</div>
                      </div>
                    </li>
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2 fw-semibold">Juliana Pena</div>
                      </div>
                    </li>
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2 fw-semibold">Adam Smith</div>
                      </div>
                    </li>
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2 fw-semibold">Farhaan Amhed</div>
                      </div>
                    </li>
                  </ul>
                </div>
                  ...
                  <ul className="list-group">
                    ...
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">Sent Messages</div>
                      </div>
                    </li>
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">New Requests</div>
                      </div>
                    </li>
                    <li className="list-group-item">
                      <div className="d-flex align-items-center">
                        ...
                        <div className="ms-2">Deleted Messages</div>
                      </div>
                    </li>
                  </ul>
                </div>
          ...
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Disabled items</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    aria-disabled="true"&gt;A disabled item meant to be disabled
                    {"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;Simply dummy text
                    of the printing&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;There are many
                    variations of passages&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;All the Lorem
                    Ipsum generators&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;Written in 45 BC.
                    This book is a treatise on the theory&lt;/li&gt;{"\n"}
                    &lt;/ul&gt;
                  </code>
                </pre>
                {/* Prism Code */}
        ...
        <div className="row">
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Flush</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
                ...
                <div className="example">
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item fw-semibold">
                      <i className="bi bi-envelope align-middle me-2 text-muted" />
                      Asish Trivedhi
                    ...
                    <li className="list-group-item fw-semibold">
                      <i className="bi bi-tiktok align-middle me-2 text-muted" />
                      Alezander Russo
                      <span className="ms-1 text-muted fw-normal d-inline-block">
                        (+7546-12342)
                      </span>
                    ...
                    <li className="list-group-item fw-semibold">
                      <i className="bi bi-whatsapp align-middle me-2 text-muted" />
                      Karem Smith
                      <span className="ms-1 text-muted fw-normal d-inline-block">
                        (+9944-56632)
                      </span>
                    ...
                    <li className="list-group-item fw-semibold">
                      <i className="bi bi-facebook align-middle me-2 text-muted" />
                      Melissa Brien
                      <span className="ms-1 text-muted fw-normal d-inline-block">
                        (+1023-34323)
                      </span>
                    ...
                    <li className="list-group-item fw-semibold">
                      <i className="bi bi-instagram align-middle me-2 text-muted" />
                      Kamala Harris
                      <span className="ms-1 text-muted fw-normal d-inline-block">
                        (+91-63421)
                      </span>
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    class="bi bi-envelope align-middle me-2
                    text-muted"&gt;&lt;/i&gt;Asish Trivedhi&lt;span class="ms-1
                    text-muted fw-normal
                    d-inline-block"&gt;(+1023-84534)&lt;/span&gt;&lt;/li&gt;
                    {"\n"}
                    {"    "}&lt;li class="list-group-item fw-semibold"&gt;&lt;i
                    class="bi bi-tiktok align-middle me-2
                    text-muted"&gt;&lt;/i&gt;Alezander Russo&lt;span class="ms-1
                    text-muted fw-normal
                    d-inline-block"&gt;(+7546-12342)&lt;/span&gt;&lt;/li&gt;
                    {"\n"}
                    {"    "}&lt;li class="list-group-item fw-semibold"&gt;&lt;i
                    class="bi bi-whatsapp align-middle me-2
                    text-muted"&gt;&lt;/i&gt;Karem Smith&lt;span class="ms-1
                    text-muted fw-normal
                    d-inline-block"&gt;(+9944-56632)&lt;/span&gt;&lt;/li&gt;
                    {"\n"}
                    {"    "}&lt;li class="list-group-item fw-semibold"&gt;&lt;i
                    class="bi bi-facebook align-middle me-2
                    text-muted"&gt;&lt;/i&gt;Melissa Brien&lt;span class="ms-1
                    text-muted fw-normal
                    d-inline-block"&gt;(+1023-34323)&lt;/span&gt;&lt;/li&gt;
                    {"\n"}
                    {"    "}&lt;li class="list-group-item fw-semibold"&gt;&lt;i
                    class="bi bi-instagram align-middle me-2
                    text-muted"&gt;&lt;/i&gt;Kamala Harris&lt;span class="ms-1
                    text-muted fw-normal
                    d-inline-block"&gt;(+91-63421)&lt;/span&gt;&lt;/li&gt;{"\n"}
                    &lt;/ul&gt;
                  </code>
                </pre>
                {/* Prism Code */}
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    bg-white text-default avatar-rounded"&gt;{"\n"}
                    {"                    "}C{"\n"}
                    {"                "}&lt;/span&gt;{"\n"}
                    {"            "}&lt;/div&gt;{"\n"}
                    {"            "}&lt;div
                    class="ms-2"&gt;California&lt;/div&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"    "}&lt;/a&gt;{"\n"}
                    {"    "}&lt;a href="#" class="list-group-item
                    ...
                    {"\n"}
                    {"            "}&lt;div&gt;{"\n"}
                    {"                "}&lt;span class="avatar avatar-xs bg-info
                    avatar-rounded"&gt;{"\n"}
                    {"                    "}L{"\n"}
                    {"                "}&lt;/span&gt;{"\n"}
                    {"            "}&lt;/div&gt;{"\n"}
                    ...
                    {"            "}&lt;div&gt;{"\n"}
                    {"                "}&lt;span class="avatar avatar-xs
                    bg-warning avatar-rounded"&gt;{"\n"}
                    {"                    "}M{"\n"}
                    {"                "}&lt;/span&gt;{"\n"}
                    {"            "}&lt;/div&gt;{"\n"}
                    {"            "}&lt;div class="ms-2"&gt;Miami
                    Florida&lt;/div&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"    "}&lt;/a&gt;{"\n"}
                    ...
                    {"            "}&lt;div&gt;{"\n"}
                    {"                "}&lt;span class="avatar avatar-xs
                    bg-success avatar-rounded"&gt;{"\n"}
                    {"                    "}W{"\n"}
                    {"                "}&lt;/span&gt;{"\n"}
                    {"            "}&lt;/div&gt;{"\n"}
                    {"            "}&lt;div class="ms-2"&gt;Washington
                    D.C&lt;/div&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"    "}&lt;/a&gt;{"\n"}&lt;/div&gt;
                  </code>
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    list-group-item-action active" aria-current="true"&gt;Simply
                    dummy text of the printing&lt;span class="badge float-end
                    bg-primary"&gt;243&lt;/span&gt;&lt;/button&gt;{"\n"}
                    {"    "}&lt;button type="button" class="list-group-item
                    list-group-item-action"&gt;There are many variations of
                    passages&lt;span class="badge float-end
                    bg-secondary-transparent"&gt;35&lt;/span&gt;&lt;/button&gt;
                    {"\n"}
                    {"    "}&lt;button type="button" class="list-group-item
                    list-group-item-action"&gt;All the Lorem Ipsum
                    generators&lt;span class="badge float-end
                    bg-info-transparent"&gt;132&lt;/span&gt;&lt;/button&gt;
                    {"\n"}
                    {"    "}&lt;button type="button" class="list-group-item
                    list-group-item-action"&gt;All the Lorem Ipsum
                    generators&lt;span class="badge float-end
                    bg-success-transparent"&gt;2525&lt;/span&gt;&lt;/button&gt;
                    {"\n"}
                    {"    "}&lt;button type="button" class="list-group-item
                    list-group-item-action" disabled&gt;A disabled item meant to
                    be disabled&lt;span class="badge float-end
                    bg-danger-transparent"&gt;21&lt;/span&gt;&lt;/button&gt;
                    {"\n"}&lt;/div&gt;
                  </code>
                </pre>
                {/* Prism Code */}
        ...
        <div className="row">
          <div className="col-xl-6">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Contextual classes</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    &lt;ul class="list-group"&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;A simple default
                    list group item&lt;/li&gt;{"\n"}
                    {"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-primary"&gt;A simple primary list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-secondary"&gt;A simple secondary{"\n"}
                    {"        "}list{"\n"}
                    {"        "}group item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-success"&gt;A simple success list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-danger"&gt;A simple danger list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-warning"&gt;A simple warning list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-info"&gt;A simple info list group{"\n"}
                    {"        "}item{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-light"&gt;A simple light list group{"\n"}
                    {"        "}item{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-group-item-dark"&gt;A simple dark list group{"\n"}
                    {"        "}item{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}&lt;/ul&gt;
                  </code>
                </pre>
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    &lt;div class="list-group"&gt;{"\n"}
                    {"    "}&lt;a href="#" class="list-group-item
                    list-group-item-action"&gt;A simple default{"\n"}
                    {"        "}list{"\n"}
                    {"        "}group item&lt;/a&gt;{"\n"}
                    {"\n"}
                    {"    "}&lt;a href="#"{"\n"}
        ...
        <div className="row">
          <div className="col-xl-6">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Solid Colored Lists</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-body">
                <div className="example">
                  <ul className="list-group">
                    ...
                    <li className="list-group-item list-item-solid-primary">
                      A simple primary list group item
                    </li>
                    <li className="list-group-item list-item-solid-secondary">
                      A simple secondary list group item
                    </li>
                    <li className="list-group-item list-item-solid-success">
                      A simple success list group item
                    </li>
                    <li className="list-group-item list-item-solid-danger">
                      A simple danger list group item
                    </li>
                    <li className="list-group-item list-item-solid-warning">
                      A simple warning list group item
                    </li>
                    <li className="list-group-item list-item-solid-info">
                      A simple info list group item
                    </li>
                    <li className="list-group-item list-item-solid-light">
                      A simple light list group item
                    </li>
                    <li className="list-group-item list-item-solid-dark text-white">
                      A simple dark list group item
                    </li>
                  </ul>
                </div>
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    {"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-primary"&gt;A simple primary list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-secondary"&gt;A simple secondary{"\n"}
                    {"        "}list{"\n"}
                    {"        "}group item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-success"&gt;A simple success list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-danger"&gt;A simple danger list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-warning"&gt;A simple warning list{"\n"}
                    {"        "}group{"\n"}
                    {"        "}item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-info"&gt;A simple info list group{"\n"}
                    {"        "}item{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item
                    list-item-solid-light"&gt;A simple light list group{"\n"}
                    {"        "}item{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item list-item-solid-dark
                    text-white"&gt;A simple dark list group{"\n"}
                    {"        "}item{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}&lt;/ul&gt;
                  </code>
                </pre>
                  ...
                  <div className="list-group">
                    ...
                    >
                      <div className="d-flex w-100 justify-content-between">
                        <h6 className="mb-1 fw-semibold text-fixed-white">
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    {"            "}&lt;h6 class="mb-1 fw-semibold"&gt;Web page
                    editors now use Lorem Ipsum?&lt;/h6&gt;{"\n"}
                    {"            "}&lt;small&gt;3 days ago&lt;/small&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;p class="mb-1"&gt;There are many variations
                    ...
                    {"        "}&lt;div class="d-flex w-100
                    justify-content-between"&gt;{"\n"}
                    {"            "}&lt;h6 class="mb-1 fw-semibold"&gt;Richard
                    McClintock, a Latin professor?&lt;/h6&gt;{"\n"}
                    {"            "}&lt;small class="text-muted"&gt;4 hrs
                    ago&lt;/small&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;p class="mb-1"&gt;Contrary to popular
                    belief, Lorem Ipsum is not simply random text. It has roots
                    in a piece of classical Latin literature.&lt;/p&gt;{"\n"}
                    {"        "}&lt;small class="text-muted"&gt;30,Nov
                    2022.&lt;/small&gt;{"\n"}
                    {"    "}&lt;/a&gt;{"\n"}
                    {"    "}&lt;a href="#" class="list-group-item
                    list-group-item-action"&gt;{"\n"}
                    {"        "}&lt;div class="d-flex w-100
                    justify-content-between"&gt;{"\n"}
                    {"            "}&lt;h6 class="mb-1 fw-semibold"&gt;It uses a
                    dictionary of over 200 Latin words?&lt;/h6&gt;{"\n"}
                    {"            "}&lt;small class="text-muted"&gt;15 hrs
                    ago&lt;/small&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;p class="mb-1"&gt;Lorem Ipsum has been the
                    industry's standard dummy text ever since the
                    1500s.&lt;/p&gt;{"\n"}
                    {"        "}&lt;small class="text-muted"&gt;4,Nov
                    2022.&lt;/small&gt;{"\n"}
                    {"    "}&lt;/a&gt;{"\n"}
                    {"    "}&lt;a href="#" class="list-group-item
                    list-group-item-action"&gt;{"\n"}
                    {"        "}&lt;div class="d-flex w-100
                    justify-content-between"&gt;{"\n"}
                    {"            "}&lt;h6 class="mb-1 fw-semibold"&gt;The
                    standard Lorem Ipsum used since the 1500s?&lt;/h6&gt;{"\n"}
                    {"            "}&lt;small class="text-muted"&gt;45 mins
                    ago&lt;/small&gt;{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;p class="mb-1"&gt;All the Lorem Ipsum
                    generators on the Internet tend to repeat predefined chunks
                    as necessary, making this the first true generator on the
                    Internet.&lt;/p&gt;{"\n"}
                    {"        "}&lt;small class="text-muted"&gt;28,Oct
                    2022.&lt;/small&gt;{"\n"}
                    {"    "}&lt;/a&gt;{"\n"}&lt;/div&gt;
                  </code>
                </pre>
        ...
        <div className="row">
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Sub headings</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    text-default"&gt;What Happened?&lt;/div&gt;{"\n"}
                    {"            "}Many experts have recently suggested may
                    exist.{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;span class="badge
                    bg-primary-transparent"&gt;32 Views&lt;/span&gt;{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item d-flex
                    justify-content-between align-items-start"&gt;{"\n"}
                    {"        "}&lt;div class="ms-2 me-auto text-muted"&gt;
                    {"\n"}
                    {"            "}&lt;div class="fw-semibold fs-14
                    text-default"&gt;It Was Amazing!&lt;/div&gt;{"\n"}
                    {"            "}His idea involved taking red.{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;span class="badge
                    bg-secondary-transparent"&gt;52 Views&lt;/span&gt;{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item d-flex
                    justify-content-between align-items-start"&gt;{"\n"}
                    {"        "}&lt;div class="ms-2 me-auto text-muted"&gt;
                    {"\n"}
                    {"            "}&lt;div class="fw-semibold fs-14
                    text-default"&gt;News Is A Great Weapon.&lt;/div&gt;{"\n"}
                    {"            "}News can influence in many ways.{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;span class="badge
                    bg-success-transparent"&gt;1,204 Views&lt;/span&gt;{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item d-flex
                    justify-content-between align-items-start"&gt;{"\n"}
                    {"        "}&lt;div class="ms-2 me-auto text-muted"&gt;
                    {"\n"}
                    {"            "}&lt;div class="fw-semibold fs-14
                    text-default"&gt;majority have suffered.&lt;/div&gt;{"\n"}
                    {"            "}If you are going to use a passage of Lorem
                    Ipsum, you need to be sure there isn't anything.{"\n"}
                    {"        "}&lt;/div&gt;{"\n"}
                    {"        "}&lt;span class="badge
                    bg-danger-transparent"&gt;14 Views&lt;/span&gt;{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}&lt;/ol&gt;
                  </code>
                </pre>
                {/* Prism Code */}
          ...
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">Numbered Lists</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    {"    "}&lt;li class="list-group-item"&gt;Written in 45 BC.
                    This book is a treatise on the theory.&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;Randomised words
                    which don't look.&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;Always free from
                    repetition, injected humour.&lt;/li&gt;{"\n"}&lt;/ol&gt;
                  </code>
                </pre>
                {/* Prism Code */}
              </div>
          ...
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">List With Checkboxes</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-body">
                <div className="example">
                  <ul className="list-group">
                    <li className="list-group-item">
                      <input
                        className="form-check-input me-1 fw-semibold"
                        type="checkbox"
                        defaultValue=""
                        aria-label="..."
                        defaultChecked=""
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    fw-semibold" type="checkbox" value=""{"\n"}
                    {"            "}aria-label="..."&gt;{"\n"}
                    {"            "}To maximize profits and improve
                    productivity.{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;{"\n"}
                    {"        "}&lt;input class="form-check-input me-1
          ...
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">List With Radios</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
          ...
          <div className="col-xl-4">
            <div className="card custom-card">
              <div className="card-header justify-content-between">
                <div className="card-title">List With badges</div>
                <div className="prism-toggle">
                  <button className="btn btn-sm btn-primary-light">
                    Show Code
                    <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="card-body">
                <div className="example">
                  <ul className="list-group">
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center fw-semibold">
                      Furniture
                      <span className="badge bg-secondary">Buy</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between align-items-center fw-semibold">
                      Beauty
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center fw-semibold">
                      Mobiles
                      <span className="badge bg-warning">Sold Out</span>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    justify-content-between align-items-center fw-semibold"&gt;
                    {"\n"}
                    {"        "}Grocies{"\n"}
                    {"        "}&lt;span class="badge
                    bg-primary"&gt;Available&lt;/span&gt;{"\n"}
                    {"    "}&lt;/li&gt;{"\n"}
                    {"    "}&lt;li{"\n"}
                    {"        "}class="list-group-item d-flex
                    justify-content-between align-items-center fw-semibold"&gt;
              ...
              <div className="card-footer d-none border-top-0">
                ...
                <pre className="language-html">
                  <code className="language-html">
                    ...
                    item&lt;/li&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;A third
                    item&lt;/li&gt;{"\n"}&lt;/ul&gt;{"\n"}&lt;ul
                    ...
                    {"    "}&lt;li class="list-group-item"&gt;A third
                    item&lt;/li&gt;{"\n"}&lt;/ul&gt;{"\n"}&lt;ul
                    class="list-group list-group-horizontal-lg"&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;An item&lt;/li&gt;
                    {"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;A second
                    item&lt;/li&gt;{"\n"}
                    ...
                    {"    "}&lt;li class="list-group-item"&gt;A third
                    item&lt;/li&gt;{"\n"}&lt;/ul&gt;{"\n"}&lt;ul
                    class="list-group list-group-horizontal-xxl"&gt;{"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;An item&lt;/li&gt;
                    {"\n"}
                    {"    "}&lt;li class="list-group-item"&gt;A second
                    item&lt;/li&gt;{"\n"}
    ...
    >
      <div className="offcanvas-header border-bottom bg-light">
        <h6 className="offcanvas-title text-default" id="offcanvasRightLabel22">
          NOTIFICATIONS
        </h6>
        <button
          type="button"
