                        ...
                        <div className="d-flex align-items-center">
                          <div className="mt-0">
                            ...
                            <p className="mb-0 fs-13 mb-0 text-muted">
                              ...
                              <span className="badge bg-primary-transparent tx-12 fw-semibold text-primiary ms-1 me-1">
                                files
                              </span>
                              and
                              <span className="badge bg-primary-transparent text-primary tx-12 fw-semibold ms-1 me-1">
                                folders
                              </span>
                              were included
                            </p>
                          ...
                          <div className="ms-auto">
                            <span className="float-end badge notification-badge">
                              <span className="tx-11 fw-semibold">
                                24, oct 2021
                              </span>
                            </span>
                          </div>
                        ...
                        <div className="d-flex align-items-center">
                          <div className="mt-0">
                            ...
                            <p className="mb-0 fs-13 mb-0 text-muted">
                              ...
                              <span className="badge bg-danger-transparent tx-12 fw-semibold me-1 ms-1">
                                deleted
                              </span>{" "}
                        ...
                        <div className="d-flex align-items-center">
                          <div className="mt-0">
                            ...
                            <p className="mb-0 fs-13 mb-0 text-muted">
                              ...
                              <span className="badge bg-success-transparent fw-semibold tx-12 ms-1 me-1">
                                login
                              </span>{" "}
                              details
                            </p>
