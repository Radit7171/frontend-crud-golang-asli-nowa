        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">HELPERS</h1>
                  ...
                  <div className="card-body">
                    ...
                    >
                      ...
                      <div className="card-body pt-0">
                        <p className="card-text text-fixed-white">
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-evenly flex-wrap">
                      <a
                        href="#"
                        className="link-primary fw-semibold fs-15 p-1"
                      >
                        Primary
                      </a>
                      <a
                        href="#"
                        className="link-secondary fw-semibold fs-15 p-1"
                      >
                        Secondary
                      </a>
                      <a
                        href="#"
                        className="link-success fw-semibold fs-15 p-1"
                      >
                        Success
                      </a>
                      <a href="#" className="link-danger fw-semibold fs-15 p-1">
                        Danger
                      </a>
                      <a
                        href="#"
                        className="link-warning fw-semibold fs-15 p-1"
                      >
                        Warning
                      </a>
                      <a href="#" className="link-info fw-semibold fs-15 p-1">
                        Info
                      </a>
                      <a href="#" className="link-dark fw-semibold fs-15 p-1">
                        Dark
                      </a>
                    </div>
                  </div>
