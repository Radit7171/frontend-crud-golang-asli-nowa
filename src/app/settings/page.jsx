                  ...
                  <div className="main-content-left main-content-left-mail card-body">
                    <div className="main-settings-menu">
                      <nav className="nav main-nav-column">
                        <a
                          className="nav-link thumb active mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-home" /> Main{" "}
                        </a>
                        <a
                          className="nav-link thumb mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-grid" /> Web Apps
                        </a>
                        <a
                          className="nav-link thumb mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-server" /> General
                        </a>
                        <a
                          className="nav-link thumb mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-globe" /> Components
                        </a>
                        <a
                          className="nav-link thumb mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-layers" /> Pages
                        </a>
                        <a
                          className="nav-link thumb mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-flag" /> Language &amp; Region
                        </a>
                        <a
                          className="nav-link thumb mb-2"
                          href="javascript:void(0);"
                        >
                          <i className="fe fe-bell" /> Notifications
                        </a>
                      </nav>
                    </div>
                  </div>
              ...
              <div className="col-lg-8 col-xl-9">
                <div className="card custom-card">
                  <div className="card-header d-block">
                    ...
                    <p>
                      Used to customize and manage all settngs about this
                      Dashboard
                    </p>
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-12 col-xl-6 col-md-12 col-sm-12 p-2">
                    <div className="card">
                        ...
                        <div className="row">
                          <div className="col-lg-12">
                            <div className="d-flex">
                              ...
                              <div>
                                <p className="fs-20 fw-semibold d-flex mb-0">
                                  Dashboard
                                </p>
                                <p className="fs-13 text-muted mb-0">
                                  Dashboard Settings such as sidemenu,header and
                                  main page can be Controlled.
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="card-footer p-3 d-flex">
                        <a href="javascript:void(0);" className="fs-14 mb-0">
                          Go to Settings
                        </a>
                        <label className="custom-switch ms-auto mb-0 d-flex">
                          <a
                            href="javascript:void(0);"
                            className="fs-14 mb-0 me-2"
                          >
                            Restore default
                          </a>
                          ...
                          <div className="col-lg-12">
                            <div className="d-flex">
                              ...
                              <div>
                                ...
                                <p className="fs-13 text-muted mb-0">
                                  Web apps settings such as
                                  Apps,Elements,Advanced Ui &amp; Mail can be
                                  Controlled.
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="d-flex">
                              ...
                              <div>
                                ...
                                <p className="fs-13 text-muted mb-0">
                                  ...
                                  Icons,Charts,Ecommerce can be Controlled.
                                </p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="col-lg-12">
                            <div className="d-flex">
                              ...
                              <div>
                                ...
                                <p className="fs-13 text-muted mb-0">
                                  In this settings we can change the region and
                                  language manually.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="col-lg-12">
                            <div className="d-flex">
                              ...
                              <div>
                                ...
                                <p className="fs-13 text-muted mb-0">
                                  Notification settings we can control the
                          ...
                          <div className="col-lg-12">
                            <div className="d-flex">
                              ...
                              <div>
                                ...
                                <p className="fs-13 text-muted mb-0">
                                  In this settings we can modify all Blog
                                  related settings in this template.
                                </p>
                              </div>
                            </div>
                          </div>
