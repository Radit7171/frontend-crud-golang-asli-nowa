                    ...
                    <div className="vtimeline">
                      <div className="timeline-wrapper timeline-wrapper-primary">
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="timeline-footer d-flex align-items-center flex-wrap">
                            <i className="fe fe-heart  text-muted me-1" />
                            <span>19</span>
                            <span className="ms-auto">
                              <i className="fe fe-calendar text-muted me-1 d-inline-flex" />
                              19 Oct 2020
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="timeline-wrapper timeline-wrapper-primary">
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="timeline-body">
                            <p>
                              Alpha 5 has arrived just over a month after Alpha
                              4 with some major feature improvements and a boat
                              load of bug fixes.
                            </p>
                          </div>
                          <div className="timeline-footer d-flex align-items-center flex-wrap">
                      ...
                      <div className="timeline-wrapper timeline-wrapper-primary">
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="timeline-body">
                            ...
                            <a className="btn ripple btn-primary mb-3">
                              Read more
                            </a>
                          </div>
                          <div className="timeline-footer d-flex align-items-center flex-wrap">
                        ...
                        <div className="timeline-panel">
                          ...
                          <div className="timeline-body">
                            <p>
                              ...
                              adipisicing elit. Amet cupiditate, delectus
                              deserunt doloribus earum eveniet explicabo fuga
                              iste magni maxime
                            </p>
                          </div>
                          <div className="timeline-footer d-flex align-items-center flex-wrap">
