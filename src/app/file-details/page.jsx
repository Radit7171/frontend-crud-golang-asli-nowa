...
export default function Home3() {
  ...
  return (
    <>
                    ...
                    <div className="swiper keyboard-control">
                      <div className="swiper-wrapper">
                        <div className="swiper-slide">
                          <img
                            src="/assets/images/photos/fileimage4.jpg"
                            alt=""
                          />
                        </div>
                        <div className="swiper-slide">
                          <img
                            src="/assets/images/photos/fileimage1.jpg"
                            alt=""
                          />
                        </div>
                        <div className="swiper-slide">
                          <img
                            src="/assets/images/photos/fileimage2.jpg"
                            alt=""
                          />
                        </div>
                        <div className="swiper-slide">
                          <img
                            src="/assets/images/photos/fileimage3.jpg"
                            alt=""
                          />
                        </div>
                        <div className="swiper-slide">
                        ...
                        <div className="swiper-slide">
                          <img
                            src="/assets/images/photos/fileimage5.jpg"
                            alt=""
                          />
                        </div>
                        <div className="swiper-slide">
                  ...
                  <div className="card-body">
                    ...
                    <div className="row">
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-91.jpg"
                      ...
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-92.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                      ...
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-93.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                      ...
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-94.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                      ...
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-95.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                            src="/assets/images/media/media-95.jpg"
                            alt="image"
                          />
                        </a>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-96.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                            src="/assets/images/media/media-96.jpg"
                            alt="image"
                          />
                        </a>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-97.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                            src="/assets/images/media/media-97.jpg"
                            alt="image"
                          />
                        </a>
                      </div>
                      <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                        <a
                          href="/assets/images/media/media-98.jpg"
                          className="glightbox card"
                          data-gallery="gallery1"
                        >
                          <img
                            src="/assets/images/media/media-98.jpg"
                            alt="image"
                          />
                        </a>
                      </div>
      ...
      {/* <!-- File details  js --> */}
      <Script src="/assets/js/file-details.js"></Script>
