        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">BUTTONS</h1>
            ...
            <div className="row">
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        ...
                        <button
                          type="button"
                          className="btn btn-warning btn-wave"
                        >
                          Warning
                        </button>
                        ...
                        <button
                          type="button"
                          className="btn btn-dark btn-wave text-white"
                        >
                          Dark
                        </button>
                        <button type="button" className="btn btn-link btn-wave">
                          Link
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-wave"&gt;Primary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary btn-wave"&gt;Secondary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn btn-success
                        btn-wave"&gt;Success&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-danger
                        btn-wave"&gt;Danger&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-warning
                        btn-wave"&gt;Warning&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-info
                        btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-light
                        btn-wave"&gt;Light&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-dark
                        btn-wave text-white"&gt;Dark&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-link
                        btn-wave"&gt;Link&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button
                          type="button"
                          className="btn btn-primary rounded-pill btn-wave"
                        >
                          Primary
                        </button>
                        <button
                          type="button"
                          className="btn btn-secondary rounded-pill btn-wave"
                        >
                          Secondary
                        </button>
                        <button
                          type="button"
                          className="btn btn-success rounded-pill btn-wave"
                        >
                          Success
                        </button>
                        <button
                        ...
                        <button
                          type="button"
                          className="btn btn-warning rounded-pill btn-wave"
                        >
                          Warning
                        </button>
                        <button
                          type="button"
                          className="btn btn-info rounded-pill btn-wave"
                        >
                          Info
                        </button>
                        <button
                          type="button"
                          className="btn btn-light rounded-pill btn-wave"
                        >
                          Light
                        </button>
                        <button
                          type="button"
                          className="btn btn-dark rounded-pill btn-wave text-white"
                        >
                          Dark
                        </button>
                        <button
                          type="button"
                          className="btn btn-link rounded-pill btn-wave"
                        >
                          Link
                        </button>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-primary
                        rounded-pill btn-wave"&gt;Primary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary rounded-pill
                        btn-wave"&gt;Secondary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-success
                        rounded-pill btn-wave"&gt;Success&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-danger
                        rounded-pill btn-wave"&gt;Danger&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-warning
                        rounded-pill btn-wave"&gt;Warning&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-info
                        rounded-pill btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-light
                        rounded-pill btn-wave"&gt;Light&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-dark
                        rounded-pill btn-wave text-white"&gt;Dark&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn btn-link
                        rounded-pill btn-wave"&gt;Link&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        ...
                        <button
                          type="button"
                          className="btn btn-purple-light btn-wave"
                        >
                          purple
                        </button>
                        <button
                          type="button"
                          className="btn btn-teal-light btn-wave"
                        >
                          teal
                        </button>
                        <button
                          type="button"
                          className="btn btn-orange-light btn-wave"
                        >
                          orange
                        </button>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-primary-light btn-wave"&gt;Primary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary-light
                        btn-wave"&gt;Secondary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-success-light btn-wave"&gt;Success&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-danger-light btn-wave"&gt;Danger&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-warning-light btn-wave"&gt;Warning&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-info-light btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-purple-light btn-wave"&gt;purple&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-teal-light btn-wave"&gt;teal&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-orange-light btn-wave"&gt;orange&lt;/button&gt;
                        {"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Light Rounded Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button
                          type="button"
                          className="btn btn-primary-light rounded-pill btn-wave"
                        >
                          Primary
                        </button>
                        <button
                          type="button"
                          className="btn btn-secondary-light rounded-pill btn-wave"
                        >
                          Secondary
                        </button>
                        <button
                          type="button"
                          className="btn btn-success-light rounded-pill btn-wave"
                        >
                          Success
                        </button>
                        <button
                          type="button"
                          className="btn btn-danger-light rounded-pill btn-wave"
                        >
                          Danger
                        </button>
                        <button
                          type="button"
                          className="btn btn-warning-light rounded-pill btn-wave"
                        >
                          Warning
                        </button>
                        <button
                          type="button"
                          className="btn btn-info-light rounded-pill btn-wave"
                        >
                          Info
                        </button>
                        <button
                          type="button"
                          className="btn btn-purple-light rounded-pill btn-wave"
                        >
                          purple
                        </button>
                        <button
                          type="button"
                          className="btn btn-teal-light rounded-pill btn-wave"
                        >
                          teal
                        </button>
                        <button
                          type="button"
                          className="btn btn-orange-light rounded-pill btn-wave"
                        >
                          orange
                        </button>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-primary-light rounded-pill
                        btn-wave"&gt;Primary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary-light rounded-pill
                        btn-wave"&gt;Secondary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-success-light rounded-pill
                        btn-wave"&gt;Success&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-danger-light rounded-pill
                        btn-wave"&gt;Danger&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-warning-light rounded-pill
                        btn-wave"&gt;Warning&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-info-light rounded-pill
                        btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-purple-light rounded-pill
                        btn-wave"&gt;purple&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-teal-light rounded-pill
                        btn-wave"&gt;teal&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-orange-light rounded-pill
                        btn-wave"&gt;orange&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        ...
                        <button
                          type="button"
                          className="btn btn-outline-light btn-wave"
                        >
                          Light
                        </button>
                        <button
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-primary btn-wave"&gt;Primary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        ...
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-success btn-wave"&gt;Success&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-danger btn-wave"&gt;Danger&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-warning btn-wave"&gt;Warning&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-info btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-light btn-wave"&gt;Light&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-dark btn-wave"&gt;Dark&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Rounded Outline Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button
                          type="button"
                          className="btn btn-outline-primary rounded-pill btn-wave"
                        >
                          Primary
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-secondary rounded-pill btn-wave"
                        >
                          Secondary
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-success rounded-pill btn-wave"
                        >
                          Success
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-danger rounded-pill btn-wave"
                        >
                          Danger
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-warning rounded-pill btn-wave"
                        >
                          Warning
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-info rounded-pill btn-wave"
                        >
                          Info
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-light rounded-pill btn-wave"
                        >
                          Light
                        </button>
                        <button
                          type="button"
                          className="btn btn-outline-dark rounded-pill btn-wave"
                        >
                          Dark
                        </button>
                      </div>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Gradient Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button
                          type="button"
                          className="btn btn-primary-gradient btn-wave"
                        >
                          Primary
                        </button>
                        <button
                        ...
                        <button
                          type="button"
                          className="btn btn-danger-gradient btn-wave"
                        >
                          Danger
                        </button>
                        <button
                        ...
                        <button
                          type="button"
                          className="btn btn-info-gradient btn-wave"
                        >
                          Info
                        </button>
                        <button
                          type="button"
                          className="btn btn-orange-gradient btn-wave"
                        >
                          Orange
                        </button>
                        <button
                          type="button"
                          className="btn btn-purple-gradient btn-wave"
                        >
                          Purple
                        </button>
                        <button
                          type="button"
                          className="btn btn-teal-gradient btn-wave"
                        >
                          Teal
                        </button>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-primary-gradient btn-wave"&gt;Primary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        ...
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-success-gradient btn-wave"&gt;Success&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-danger-gradient btn-wave"&gt;Danger&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-warning-gradient btn-wave"&gt;Warning&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-info-gradient btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-orange-gradient btn-wave"&gt;Orange&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-purple-gradient btn-wave"&gt;Purple&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-teal-gradient btn-wave"&gt;Teal&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Rounded Gradient Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button
                          type="button"
                          className="btn btn-primary-gradient rounded-pill btn-wave"
                        >
                          Primary
                        </button>
                        <button
                          type="button"
                          className="btn btn-secondary-gradient rounded-pill btn-wave"
                        >
                          Secondary
                        </button>
                        <button
                          type="button"
                          className="btn btn-success-gradient rounded-pill btn-wave"
                        >
                          Success
                        </button>
                        <button
                          type="button"
                          className="btn btn-danger-gradient rounded-pill btn-wave"
                        >
                          Danger
                        </button>
                        <button
                          type="button"
                          className="btn btn-warning-gradient rounded-pill btn-wave"
                        >
                          Warning
                        </button>
                        <button
                          type="button"
                          className="btn btn-info-gradient rounded-pill btn-wave"
                        >
                          Info
                        </button>
                        <button
                          type="button"
                          className="btn btn-orange-gradient rounded-pill btn-wave"
                        >
                          Orange
                        </button>
                        <button
                          type="button"
                          className="btn btn-purple-gradient rounded-pill btn-wave"
                        >
                          Purple
                        </button>
                        <button
                          type="button"
                          className="btn btn-teal-gradient rounded-pill btn-wave"
                        >
                          Teal
                        </button>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-primary-gradient rounded-pill
                        btn-wave"&gt;Primary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary-gradient rounded-pill
                        btn-wave"&gt;Secondary&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-success-gradient rounded-pill
                        btn-wave"&gt;Success&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-danger-gradient rounded-pill
                        btn-wave"&gt;Danger&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-warning-gradient rounded-pill
                        btn-wave"&gt;Warning&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-info-gradient rounded-pill
                        btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-orange-gradient rounded-pill
                        btn-wave"&gt;Orange&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-purple-gradient rounded-pill
                        btn-wave"&gt;Purple&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-teal-gradient rounded-pill
                        btn-wave"&gt;Teal&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Ghost Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button
                          type="button"
                          className="btn btn-primary-ghost btn-wave"
                        >
                          Primary
                        </button>
                        <button
                          type="button"
                          className="btn btn-secondary-ghost btn-wave"
                        >
                          Secondary
                        </button>
                        <button
                        ...
                        <button
                          type="button"
                          className="btn btn-danger-ghost btn-wave"
                        >
                          Danger
                        </button>
                        <button
                          type="button"
                          className="btn btn-warning-ghost btn-wave"
                        >
                          Warning
                        </button>
                        <button
                          type="button"
                          className="btn btn-info-ghost btn-wave"
                        >
                          Info
                        </button>
                        <button
                          type="button"
                          className="btn btn-orange-ghost btn-wave"
                        >
                          Orange
                        </button>
                        <button
                          type="button"
                          className="btn btn-purple-ghost btn-wave"
                        >
                          Purple
                        </button>
                        <button
                          type="button"
                          className="btn btn-teal-ghost btn-wave"
                        >
                          Teal
                        </button>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-primary-ghost btn-wave"&gt;Primary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-secondary-ghost
                        btn-wave"&gt;Secondary&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-success-ghost btn-wave"&gt;Success&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-danger-ghost btn-wave"&gt;Danger&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-warning-ghost btn-wave"&gt;Warning&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-info-ghost btn-wave"&gt;Info&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-orange-ghost btn-wave"&gt;Orange&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-purple-ghost btn-wave"&gt;Purple&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-teal-ghost btn-wave"&gt;Teal&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Button tags</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;a class="btn btn-primary btn-wave" href="#"
                        role="button"&gt;Link&lt;/a&gt;{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"            "}button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn
                        btn-secondary" disabled=""&gt;Button&lt;/button&gt;
                        {"\n"}
                        {"        "}&lt;button type="button" class="btn
                        btn-outline-primary" disabled=""&gt;Primary{"\n"}
                        {"            "}button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn
                        btn-outline-secondary"
                        ...
                        role="button" aria-disabled="true"&gt;Primary{"\n"}
                        {"            "}link&lt;/a&gt;{"\n"}
                    ...
                    <div className="example">
                      <div className="btn-list">
                        <div className="mb-4">
                          ...
                          <button
                            type="button"
                            className="btn btn-secondary active btn-wave"
                            data-bs-toggle="button"
                            aria-pressed="true"
                          >
                          ...
                          <button
                            type="button"
                            className="btn btn-teal btn-wave"
                            disabled=""
                            data-bs-toggle="button"
                          >
                        ...
                        <div>
                          ...
                          <a
                            className="btn btn-teal disabled btn-wave"
                            aria-disabled="true"
                            role="button"
                            data-bs-toggle="button"
                          >
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;div class="mb-4"&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn
                        btn-primary btn-wave" data-bs-toggle="button"{"\n"}
                        {"            "}&gt;Toggle button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn
                        btn-secondary active btn-wave" data-bs-toggle="button"
                        {"\n"}
                        {"             "}aria-pressed="true"&gt;Active toggle
                        button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn btn-teal
                        btn-wave" disabled data-bs-toggle="button"{"\n"}
                        {"            "}&gt;Disabled toggle{"\n"}
                        {"            "}button&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div&gt;{"\n"}
                        {"        "}&lt;a href="#" class="btn btn-primary
                        btn-wave" role="button"
                        data-bs-toggle="button"&gt;Toggle{"\n"}
                        {"            "}link&lt;/a&gt;{"\n"}
                        {"        "}&lt;a href="#" class="btn btn-secondary
                        active btn-wave" role="button" data-bs-toggle="button"
                        {"\n"}
                        {"            "}aria-pressed="true"&gt;Active toggle
                        link&lt;/a&gt;{"\n"}
                        {"        "}&lt;a class="btn btn-teal disabled btn-wave"
                        aria-disabled="true" role="button"{"\n"}
                        {"            "}data-bs-toggle="button"&gt;Disabled
                        toggle link&lt;/a&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Link functionally caveat</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Loading Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                    ...
                    <div className="example">
                      <div className="btn-list d-md-flex flex-wrap">
                        ...
                        <button className="btn btn-info-transparent btn-loader">
                          <span className="me-2">Loading</span>
                          <span className="loading">
                            <i className="ri-loader-4-line fs-16" />
                          </span>
                        </button>
                        <button className="btn btn-warning-transparent btn-loader">
                          <span className="me-2">Loading</span>
                          <span className="loading">
                            <i className="ri-loader-5-line fs-16" />
                          </span>
                        </button>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"    "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-success btn-loader
                        disabled"&gt;{"\n"}
                        {"        "}&lt;span
                        class="me-2"&gt;Disabled&lt;/span&gt;
                        {"\n"}
                        {"        "}&lt;span class="loading"&gt;&lt;i
                        class="ri-refresh-line fs-16"&gt;&lt;/i&gt;&lt;/span&gt;
                        {"\n"}
                        {"    "}&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-primary-transparent rounded-pill btn-wave"&gt;{"\n"}
                        {"            "}&lt;i
                        class="ri-home-smile-line"&gt;&lt;/i&gt;{"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-secondary-transparent rounded-pill btn-wave"&gt;
                        {"\n"}
                        {"            "}&lt;i
                        class="ri-delete-bin-line"&gt;&lt;/i&gt;{"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-success-transparent rounded-pill btn-wave"&gt;{"\n"}
                        {"            "}&lt;i
                        class="ri-notification-3-line"&gt;&lt;/i&gt;{"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-danger-transparent rounded-pill btn-wave me-5"&gt;
                        {"\n"}
                        {"            "}&lt;i
                        class="ri-chat-settings-line"&gt;&lt;/i&gt;{"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class=""&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-outline-primary rounded-pill btn-wave"&gt;{"\n"}
                        {"            "}&lt;i
                        class="ri-phone-line"&gt;&lt;/i&gt;
                        {"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-outline-teal rounded-pill btn-wave"&gt;{"\n"}
                        {"            "}&lt;i
                        class="ri-customer-service-2-line"&gt;&lt;/i&gt;{"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-outline-success rounded-pill btn-wave"&gt;{"\n"}
                        {"            "}&lt;i class="ri-live-line"&gt;&lt;/i&gt;
                        {"\n"}
                        {"        "}&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-icon
                        btn-outline-secondary rounded-pill btn-wave"&gt;{"\n"}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Social Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                      ...
                      <div className="card-body">
                        <div className="example">
                          <div className="btn-list">
                            ...
                            <button
                              type="button"
                              className="btn btn-success btn-lg btn-wave"
                            >
                              Large button
                            </button>
                          </div>
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            &lt;div class="btn-list"&gt;{"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-primary btn-sm btn-wave"&gt;Small{"\n"}
                            {"        "}button&lt;/button&gt;{"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-secondary btn-wave"&gt;Default{"\n"}
                            {"        "}button&lt;/button&gt;{"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-success btn-lg btn-wave"&gt;Large{"\n"}
                            {"        "}button&lt;/button&gt;{"\n"}&lt;/div&gt;
                          </code>
                        </pre>
                        {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="row">
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      <div className="card-header justify-content-between">
                        <div className="card-title">Button Widths</div>
                        <div className="prism-toggle">
                          <button className="btn btn-sm btn-primary-light">
                            Show Code
                            <i className="ri-code-line ms-2 d-inline-block align-middle" />
                      ...
                      <div className="card-body">
                        <div className="example">
                          <div className="btn-list">
                            <button
                              type="button"
                              className="btn btn-primary btn-w-xs btn-wave"
                            >
                              XS
                            </button>
                            <button
                              type="button"
                              className="btn btn-secondary btn-w-sm btn-wave"
                            >
                              SM
                            </button>
                            <button
                              type="button"
                              className="btn btn-warning btn-w-md btn-wave"
                            >
                              MD
                            </button>
                            <button
                              type="button"
                              className="btn btn-info btn-w-lg btn-wave"
                            >
                              LG
                            </button>
                          </div>
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            &lt;div class="btn-list"&gt;{"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-primary btn-w-xs btn-wave"&gt;XS&lt;/button&gt;
                            {"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-secondary btn-w-sm
                            btn-wave"&gt;SM&lt;/button&gt;
                            {"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-warning btn-w-md btn-wave"&gt;MD&lt;/button&gt;
                            {"\n"}
                            {"    "}&lt;button type="button" class="btn btn-info
                            btn-w-lg btn-wave"&gt;LG&lt;/button&gt;{"\n"}
                            &lt;/div&gt;
                          </code>
                        </pre>
                        {/* Prism Code */}
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list d-flex">
                        <div className="me-5">
                          <button className="btn btn-primary shadow-sm btn-wave">
                            Button
                          </button>
                          <button className="btn btn-primary shadow btn-wave">
                            Button
                          </button>
                          <button className="btn btn-primary shadow-lg btn-wave">
                            Button
                          </button>
                        </div>
                        <div>
                          <button className="btn btn-secondary btn-sm shadow-sm btn-wave">
                            Button
                          </button>
                          <button className="btn btn-info shadow btn-wave">
                            Button
                          </button>
                          <button className="btn btn-lg btn-success shadow-lg btn-wave">
                            Button
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        shadow-sm btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-info shadow
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-lg btn-success
                        shadow-lg btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button className="btn btn-primary shadow-primary btn-wave">
                          Button
                        </button>
                        <button className="btn btn-secondary shadow-secondary btn-wave">
                          Button
                        </button>
                        <button className="btn btn-success shadow-success btn-wave">
                          Button
                        </button>
                        <button className="btn btn-info shadow-info btn-wave">
                          Button
                        </button>
                        <button className="btn btn-warning shadow-warning btn-wave">
                          Button
                        </button>
                        <button className="btn btn-danger shadow-danger btn-wave">
                          Button
                        </button>
                        <button className="btn btn-purple shadow-purple btn-wave">
                          Button
                        </button>
                        <button className="btn btn-orange shadow-orange btn-wave">
                          Button
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        shadow-secondary btn-wave"&gt;Button&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button class="btn btn-success shadow-success
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-info shadow-info
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-warning shadow-warning
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-danger shadow-danger
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-purple shadow-purple
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-orange shadow-orange
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Raised Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-list">
                        <button className="btn btn-primary btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-secondary btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-success btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-info btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-warning btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-danger btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-purple btn-raised-shadow btn-wave">
                          Button
                        </button>
                        <button className="btn btn-orange btn-raised-shadow btn-wave">
                          Button
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="btn-list"&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-primary
                        btn-raised-shadow btn-wave"&gt;Button&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button class="btn btn-secondary
                        btn-raised-shadow btn-wave"&gt;Button&lt;/button&gt;
                        {"\n"}
                        ...
                        btn-raised-shadow btn-wave"&gt;Button&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button class="btn btn-info btn-raised-shadow
                        btn-wave"&gt;Button&lt;/button&gt;{"\n"}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Label Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                    ...
                    <div className="example">
                      <div className="btn-list">
                        <button className="btn btn-primary label-btn">
                          <i className="ri-chat-smile-line label-btn-icon me-2" />
                          Primary
                        </button>
                        <button className="btn btn-secondary label-btn">
                          <i className="ri-settings-4-line label-btn-icon me-2" />
                          Secondary
                        </button>
                        <button className="btn btn-warning label-btn rounded-pill">
                          <i className="ri-spam-2-line label-btn-icon me-2 rounded-pill" />
                          Warning
                        </button>
                        <button className="btn btn-info label-btn rounded-pill">
                          <i className="ri-phone-line label-btn-icon me-2 rounded-pill" />
                          Info
                        </button>
                        <button className="btn btn-success label-btn label-end">
                          Success
                          <i className="ri-thumb-up-line label-btn-icon ms-2" />
                        </button>
                        <button className="btn btn-danger label-btn label-end rounded-pill">
                          Cancel
                          <i className="ri-close-line label-btn-icon ms-2 rounded-pill" />
                        </button>
                      </div>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"        "}&lt;i class="ri-chat-smile-line
                        label-btn-icon me-2"&gt;&lt;/i&gt;{"\n"}
                        {"        "}Primary{"\n"}
                        {"    "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-secondary
                        label-btn"&gt;
                        ...
                        rounded-pill"&gt;{"\n"}
                        {"        "}&lt;i class="ri-spam-2-line label-btn-icon
                        me-2 rounded-pill"&gt;&lt;/i&gt;{"\n"}
                        {"        "}Warning{"\n"}
                        {"    "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-info label-btn
                        rounded-pill"&gt;{"\n"}
                        {"        "}&lt;i class="ri-phone-line label-btn-icon
                        me-2 rounded-pill"&gt;&lt;/i&gt;{"\n"}
                        {"        "}Info{"\n"}
                        {"    "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-success label-btn
                        label-end"&gt;{"\n"}
                        {"        "}Success{"\n"}
                        {"        "}&lt;i class="ri-thumb-up-line label-btn-icon
                        ms-2"&gt;&lt;/i&gt;{"\n"}
                        {"    "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-danger label-btn
                        label-end rounded-pill"&gt;{"\n"}
                        {"        "}Cancel{"\n"}
                        {"        "}&lt;i class="ri-close-line label-btn-icon
                        ms-2 rounded-pill"&gt;&lt;/i&gt;{"\n"}
                        {"    "}&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
              ...
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Custom Buttons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                      ...
                      <div className="btn-list">
                        <button className="btn btn-info custom-button rounded-pill">
                          <span className="custom-btn-icons">
                            <i className="ri-twitter-line text-info" />
                          </span>
                          Twitter
                        </button>
                        <button className="btn btn-teal-light btn-border-down">
                          Border
                        </button>
                        <button className="btn btn-secondary-light btn-border-start">
                          Border
                        </button>
                        <button className="btn btn-purple-light btn-border-end">
                          Border
                        </button>
                        <button className="btn btn-warning-light btn-border-top">
                          Border
                        </button>
                        <button className="btn btn-secondary btn-glare">
                          <span>Glare Button</span>
                        </button>
                        <button className="btn btn-danger btn-hover btn-hover-animate">
                          Like
                        </button>
                        <button className="btn btn-success btn-darken-hover">
                          Hover
                        </button>
                        <button className="btn btn-orange btn-custom-border">
                          Hover
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        rounded-pill"&gt;{"\n"}
                        {"        "}&lt;span class="custom-btn-icons"&gt;&lt;i
                        class="ri-twitter-line
                        text-info"&gt;&lt;/i&gt;&lt;/span&gt;
                        {"\n"}
                        {"        "}Twitter{"\n"}
                        {"    "}&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-teal-light
                        btn-border-down"&gt;Border&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-secondary-light
                        btn-border-start"&gt;Border&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-purple-light
                        btn-border-end"&gt;Border&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-warning-light
                        btn-border-top"&gt;Border&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-secondary
                        btn-glare"&gt;&lt;span&gt;Glare
                        Button&lt;/span&gt;&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-danger btn-hover
                        btn-hover-animate"&gt;Like&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-success
                        btn-darken-hover"&gt;Hover&lt;/button&gt;{"\n"}
                        {"    "}&lt;button class="btn btn-orange
                        btn-custom-border"&gt;Hover&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                    ...
                    <div className="example">
                      <div className="btn-list">
                        ...
                        <div className="d-grid gap-2 d-md-flex justify-content-md-end">
                          <button
                            className="btn btn-teal me-md-2 btn-wave"
                            type="button"
                          >
                            Button
                          </button>
                          <button
                            className="btn btn-purple btn-wave"
                            type="button"
                          >
                            Button
                          </button>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"        "}&lt;button class="btn btn-secondary
                        btn-wave" type="button"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="d-grid gap-2 d-md-block"&gt;
                        {"\n"}
                        {"        "}&lt;button class="btn btn-info btn-wave"
                        type="button"&gt;Button&lt;/button&gt;{"\n"}
                        ...
                        {"\n"}
                        {"        "}&lt;button class="btn btn-danger btn-wave"
                        type="button"&gt;Button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-warning btn-wave"
                        type="button"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div class="d-grid gap-2 d-md-flex
                        justify-content-md-end"&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-teal me-md-2
                        btn-wave" type="button"&gt;Button&lt;/button&gt;{"\n"}
                        {"        "}&lt;button class="btn btn-purple btn-wave"
                        type="button"&gt;Button&lt;/button&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
