        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">OBJECT FIT</h1>
            ...
            <div className="row">
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div className="card custom-card">
                  ...
                  <div className="card-body object-fit-container">
                    <img
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Object Fit Contain Video</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Object Fit Cover Video</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Object Fit Fill Video</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body object-fit-container">
                    <video
                      src="/assets/video/1.mp4"
                      className="object-fit-fill rounded border"
                      autoPlay=""
                      loop=""
                      muted=""
                    />
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Object Fit Scale Video</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body object-fit-container">
                    <video
                      src="/assets/video/1.mp4"
                      className="object-fit-scale rounded border"
                      autoPlay=""
                      loop=""
                      muted=""
                    />
              ...
              <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Object Fit None Video</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body object-fit-container">
                    <video
                      src="/assets/video/1.mp4"
                      className="object-fit-none rounded border"
                      autoPlay=""
                      loop=""
                      muted=""
                    />
