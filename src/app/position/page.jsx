        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">POSITION</h1>
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header">
                    <div className="card-title">
                      By adding .translate-middle-x or .translate-middle-y
                      classes
                    </div>
                  </div>
                  <div className="card-body bd-example-position-utils">
                  ...
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      ...
                      <div className="card-body bd-example-position-examples d-flex justify-content-around">
                        ...
                        <button
                          type="button"
                          className="btn btn-dark position-relative about text-white"
                        >
                          Marker{" "}
                          <svg
                            width="1em"
