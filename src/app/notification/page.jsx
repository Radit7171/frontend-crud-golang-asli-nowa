          ...
          <div className="main-container container-fluid">
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">Basic Notification</h3>
                  </div>
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">PopUp Notification</h3>
                  </div>
                  <div className="card-body text-center">
                    <button
                      type="button"
            ...
            <div className="row">
              <div className="col-xl-3 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">Info Notification</h3>
                  </div>
                  <div className="card-body text-center">
                    <button type="button" className="btn  btn-info" id="info">
                      Info Notification
                    </button>
                  </div>
                </div>
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">Success Notification</h3>
                  </div>
                  <div className="card-body text-center">
                    <button
                      type="button"
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">Warning Notification</h3>
                  </div>
                  <div className="card-body text-center">
                    <button
                      type="button"
              ...
              <div className="col-xl-3 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">Error Notification</h3>
                  </div>
                  <div className="card-body text-center">
                    <button type="button" className="btn btn-danger" id="error">
                      Error Notification
                    </button>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-6">
                <div className="card">
                  <div className="card-header border-bottom">
                    <h3 className="card-title">Confirmation Notification</h3>
                  </div>
                  <div className="card-body text-center">
                    <button
                      type="button"
