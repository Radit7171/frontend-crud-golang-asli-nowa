          ...
          <div className="container-fluid">
            ...
            <div className="row">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-wave"&gt;&lt;i class="bi
                        bi-skip-backward"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-info
                        btn-wave"&gt;&lt;i class="bi
                        bi-pause"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-info
                        btn-wave"&gt;&lt;i class="bi
                        bi-skip-forward"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="btn-group">
                        <a
                          href="javascript:void(0);"
                          className="btn btn-primary active btn-wave"
                          aria-current="page"
                        >
                          Active link
                        </a>
              ...
              <div className="col-xl-3">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Mixed style</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-wave"&gt;Left&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-warning
                        btn-wave"&gt;Middle&lt;/button&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn btn-success
                        btn-wave"&gt;Right&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
              ...
              <div className="col-xl-3">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Outline styled</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-outline-primary btn-wave"&gt;Left&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-primary btn-wave"&gt;Middle&lt;/button&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn
                        btn-outline-primary btn-wave"&gt;Right&lt;/button&gt;
                        {"\n"}
                        &lt;/div&gt;
                      </code>
                    </pre>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body checkbox-button-group">
                    <div className="example">
                      <div
                        className="btn-group"
                        role="group"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        for="btncheck1"&gt;Checkbox 1&lt;/label&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;input type="checkbox" class="btn-check"
                        id="btncheck2"&gt;{"\n"}
                        {"    "}&lt;label class="btn btn-outline-primary"
                        for="btncheck2"&gt;Checkbox 2&lt;/label&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;input type="checkbox" class="btn-check"
                        id="btncheck3"&gt;{"\n"}
                        {"    "}&lt;label class="btn btn-outline-primary"
                  ...
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      ...
                      <div className="card-body">
                        <div className="example">
                          <div
                            className="btn-group btn-group-lg my-1"
                            role="group"
                          ...
                          <div
                            className="btn-group btn-group-sm my-1"
                            role="group"
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            &lt;div class="btn-group btn-group-lg my-1"
                            role="group" aria-label="Large button group"&gt;
                            {"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-outline-success"&gt;Left&lt;/button&gt;{"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-outline-success"&gt;Middle&lt;/button&gt;{"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-outline-success"&gt;Right&lt;/button&gt;{"\n"}
                            ...
                            btn-outline-success"&gt;Right&lt;/button&gt;{"\n"}
                            &lt;/div&gt;{"\n"}&lt;div class="btn-group
                            btn-group-sm my-1" role="group" aria-label="Small
                            button group"&gt;
                            {"\n"}
                            {"    "}&lt;button type="button" class="btn
                            btn-outline-success"&gt;Left&lt;/button&gt;{"\n"}
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            ...
                            {"        "}&lt;button type="button" class="btn
                            btn-secondary"&gt;5&lt;/button&gt;{"\n"}
                            {"        "}&lt;button type="button" class="btn
                            btn-secondary"&gt;6&lt;/button&gt;{"\n"}
                            {"        "}&lt;button type="button" class="btn
                            btn-secondary"&gt;7&lt;/button&gt;{"\n"}
                            {"    "}&lt;/div&gt;{"\n"}
                            ...
                            {"        "}&lt;button type="button" class="btn
                            btn-outline-secondary"&gt;2&lt;/button&gt;{"\n"}
                            {"        "}&lt;button type="button" class="btn
                            btn-outline-secondary"&gt;3&lt;/button&gt;{"\n"}
                            {"        "}&lt;button type="button" class="btn
                            btn-outline-secondary"&gt;4&lt;/button&gt;{"\n"}
                            {"    "}&lt;/div&gt;{"\n"}
                            {"    "}&lt;div class="input-group"&gt;{"\n"}
                            {"        "}&lt;div class="input-group-text"
                            id="btnGroupAddon"&gt;@&lt;/div&gt;{"\n"}
                            {"        "}&lt;input type="text"
                            class="form-control"
                            {"\n"}
                            {"            "}placeholder="Input group example"
              ...
              <div className="col-xl-6">
                <div className="row">
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      <div className="card-header justify-content-between">
                        <div className="card-title">Vertical variation</div>
                        <div className="prism-toggle">
                          <button className="btn btn-sm btn-primary-light">
                            Show Code
                            <i className="ri-code-line ms-2 d-inline-block align-middle" />
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            ...
                            {"        "}&lt;div class="btn-group-vertical"
                            role="group"{"\n"}
                            {"            "}aria-label="Vertical radio toggle
                            button group"&gt;{"\n"}
                            {"            "}&lt;input type="radio"
                            class="btn-check" name="vbtn-radio" id="vbtn-radio1"
                            {"\n"}
                            {"                "}checked=""&gt;{"\n"}
                            {"            "}&lt;label class="btn
                            btn-outline-danger" for="vbtn-radio1"&gt;Radio
                            1&lt;/label&gt;{"\n"}
                            {"            "}&lt;input type="radio"
                            class="btn-check" name="vbtn-radio" id="vbtn-radio2"
                            {"\n"}
                            {"               "}&gt;{"\n"}
                            {"            "}&lt;label class="btn
                            btn-outline-danger" for="vbtn-radio2"&gt;Radio
                            2&lt;/label&gt;{"\n"}
                            {"            "}&lt;input type="radio"
                            ...
                            {"               "}&gt;{"\n"}
                            {"            "}&lt;label class="btn
                            btn-outline-danger" for="vbtn-radio3"&gt;Radio
                            3&lt;/label&gt;{"\n"}
                            {"        "}&lt;/div&gt;{"\n"}
                            {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;
                          </code>
