        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">SCROLLSPY</h1>
              ...
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Example in navbar</div>
                  ...
                  <div className="card-body">
                    <div className="example">
                      <nav
                        id="navbar-example2"
                        className="navbar navbar-light bg-light px-3 mb-3"
                      >
                      ...
                      <div
                        ...
                        tabIndex={0}
                      >
                        <h6 className="fw-semibold" id="scrollspyHeading1">
                          First heading
                        </h6>
                        <p className="text-muted">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Quidem culpa alias, illum vero cupiditate
                          fugiat, placeat nemo assumenda distinctio magni,
                          reprehenderit sit deleniti excepturi! Tempore magni
                          adipisci iusto sit illum Once upon a time in a quiet
                          little town, Sarah discovered an old, mysterious key
                          in her grandmother's attic. She had no idea what it
                          unlocked. With a sense of adventure, she set out on a
                          quest to find the hidden treasure that the key must
                          surely belong to. Along the way, she encountered
                          riddles, puzzles, and unexpected allies. The journey
                          not only led her to a long-lost family heirloom but
                          also revealed the importance of family history and the
                          value of determination. ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias,
                          illum vero cupiditate fugiat, placeat nemo assumenda
                          distinctio magni, reprehenderit sit deleniti
                          excepturi! Tempore magni adipisci iusto sit illum vero
                          veniam harum quas sunt!Lorem ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias,
                          illum vero cupiditate fugiat, placeat nemo assumenda
                          distinctio magni, reprehenderit sit deleniti
                          excepturi! Tempore magni adipisci iusto sit illum vero
                          veniam harum quas suntLorem ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias,
                          illum vero cupiditate fugiat, placeat nemo assumenda
                          distinctio magni,Lorem ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias,
                          illum vero cupiditate fugiat, placeat nemo assumenda
                          distinctio magni, reprehenderit sit deleniti
                          excepturi! Tempore magni adipisci iusto sit illum vero
                          veniam harum quas sunt!Lorem ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias, Once
                          upon a time in a quiet little town, Sarah discovered
                          an old, mysterious key in her grandmother's attic. She
                          had no idea what it unlocked. With a sense of
                          adventure, she set out on a quest to find the hidden
                          treasure that the key must surely belong to. Along the
                          way, she encountered riddles, puzzles, and unexpected
                          allies. The journey not only led her to a long-lost
                          family heirloom but also revealed the importance of
                          family history and the value of determination. vero
                          veniam harum quas sunt!Lorem ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias,
                          illum vero cupiditate fugiat, placeat nemo assumenda
                          distinctio magni, reprehenderit sit deleniti
                          ...
                          illum vero cupiditate fugiat, placeat nemo assumenda
                          distinctio magni, reprehenderit sit deleniti
                          excepturi! Tempore magni adipisci iusto sit illumOnce
                          upon a time in a quiet little town, Sarah discovered
                          an old, mysterious key in her grandmother's attic. She
                          had no idea what it unlocked. With a sense of
                          adventure, she set out on a quest to find the hidden
                          ...
                          allies. The journey not only led her to a long-lost
                          family heirloom but also revealed the importance of
                          family history and the value of determination.
                        </p>
                        <h6 className="fw-semibold" id="scrollspyHeading2">
                          Second heading
                        </h6>
                        <p className="text-muted">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Aliquam veniam ullam perspiciatis ut fugit atque
                          iure, quae animi ex tempore. Ducimus illum fugit
                          sapiente quisquam!Lorem ipsum dolor sit amet
                          consectetur adipisicing elit. Quidem culpa alias,Lorem
                          ipsum dolor sit amet consectetur adipisicing elit.
                          Aliquam veniam ullam perspiciatis ut fugit atque iure,
                          quae animi ex tempore. Ducimus illum fugit sapiente
                          quisquam!Lorem ipsum dolor sit amet consectetur
                          adipisicing elit. Quidem culpa alias,Lorem ipsum dolor
                          sit amet consectetur adipisicing elit. Aliquam veniam
                          ullam Once upon a time in a quiet little town, Sarah
                          discovered an old, mysterious key in her grandmother's
                          attic. She had no idea what it unlocked. With a sense
                          of adventure, she set out on a quest to find the
                          hidden treasure that the key must surely belong to.
                          Along the way, she encountered riddles, puzzles, and
                          unexpected allies. The journey not only led her to a
                          long-lost family heirloom but also revealed the
                          importance of family history and the value of
                          determination.
                        </p>
                        <h6 className="fw-semibold" id="scrollspyHeading3">
                          Third heading
                        </h6>
                        <p className="text-muted">
                          Lorem ipsum dolor sit amet, consectetur adipisicing
                          elit. Eveniet nobis et quaerat asperiores fugit
                          dignissimos rerum qui minus vitae nesciunt nisi
                          aspernatur aperiam quidem magnam, cumque repudiandae
                          quod aliquid quo?
                        </p>
                        <h6 className="fw-semibold" id="scrollspyHeading4">
                          Fourth heading
                        </h6>
                        <p className="text-muted">
                          Lorem ipsum dolor, sit amet consectetur adipisicing
                          elit. Maiores tempora pariatur modi corporis
                          aspernatur eveniet?
                        </p>
                        <h6 className="fw-semibold" id="scrollspyHeading5">
                          Fifth heading
                        </h6>
                        <p className="text-muted">
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Ullam voluptates consequuntur ipsum eos, magni
                          vitae tempore suscipit excepturi blanditiis!
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        id="scrollspyHeading1"&gt;First heading&lt;/h6&gt;{"\n"}
                        {"    "}&lt;p class="text-muted"&gt;Lorem ipsum dolor
                        sit amet consectetur adipisicing elit. Quidem culpa
                        {"\n"}
                        {"        "}alias,{"\n"}
                        {"        "}illum vero cupiditate fugiat, placeat nemo
                        assumenda distinctio magni,{"\n"}
                        {"        "}reprehenderit sit deleniti excepturi!
                        Tempore magni adipisci iusto sit{"\n"}
                        {"        "}illum{"\n"}
                        {"        "}vero veniam harum quas sunt!Lorem ipsum
                        ...
                        Tempore magni adipisci iusto sit{"\n"}
                        {"        "}illum{"\n"}
                        {"        "}vero veniam harum quas suntLorem ipsum dolor
                        ...
                        Sarah discovered an old, mysterious key in her
                        grandmother's attic. She had no idea what it unlocked.
                        With a sense of adventure, she set out on a quest to
                        find the hidden treasure that the key must surely belong
                        to. Along the way, she encountered riddles, puzzles, and
                        unexpected allies. The journey not only led her to a
                        long-lost family heirloom but also revealed the
                        importance of family history and the value of
                        determination.{"\n"}
                        ...
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;h6 class="fw-semibold"
                        id="scrollspyHeading2"&gt;Second heading&lt;/h6&gt;
                        {"\n"}
                        {"    "}&lt;p class="text-muted"&gt;Lorem ipsum dolor
                        sit amet consectetur adipisicing elit. Aliquam veniam
                        {"\n"}
                        {"        "}ullam{"\n"}
                        {"        "}perspiciatis ut fugit atque iure, quae animi
                        ex tempore. Ducimus illum{"\n"}
                        {"        "}fugit{"\n"}
                        {"        "}sapiente quisquam!Lorem ipsum dolor sit amet
                        ...
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;h6 class="fw-semibold"
                        id="scrollspyHeading3"&gt;Third heading&lt;/h6&gt;{"\n"}
                        {"    "}&lt;p class="text-muted"&gt;Lorem ipsum dolor
                        sit amet, consectetur adipisicing elit. Eveniet nobis
                        {"\n"}
                        {"        "}et{"\n"}
                        {"        "}quaerat asperiores fugit dignissimos rerum
                        qui minus vitae nesciunt nisi{"\n"}
                        {"        "}aspernatur aperiam quidem magnam, cumque
                        repudiandae quod aliquid quo?{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}
                        {"    "}&lt;h6 class="fw-semibold"
                        id="scrollspyHeading4"&gt;Fourth heading&lt;/h6&gt;
                        {"\n"}
                        {"    "}&lt;p class="text-muted"&gt;Lorem ipsum dolor,
                        sit amet consectetur adipisicing elit. Maiores tempora
                        {"\n"}
                        {"        "}pariatur modi corporis aspernatur
                        eveniet?&lt;/p&gt;{"\n"}
                        {"    "}&lt;h6 class="fw-semibold"
                        id="scrollspyHeading5"&gt;Fifth heading&lt;/h6&gt;{"\n"}
                        {"    "}&lt;p class="text-muted"&gt;Lorem ipsum dolor
                        sit amet consectetur adipisicing elit. Ullam voluptates
                        {"\n"}
                        {"        "}consequuntur ipsum eos, magni vitae tempore
                        suscipit excepturi{"\n"}
                        {"        "}blanditiis!{"\n"}
                        {"    "}&lt;/p&gt;{"\n"}&lt;/div&gt;
                      </code>
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Nested nav</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                          ...
                          >
                            <div id="item-1">
                              ...
                              <p className="text-muted">
                                ...
                                adipisicing elit. Asperiores explicabo in
                                delectus nostrum aut ab quasi placeat facilis?
                                Laborum corporis eaque ipsum laboriosam animi
                                possimus.
                              </p>
                            </div>
                            <div id="item-1-1">
                              ...
                              <p className="text-muted">
                                Lorem ipsum dolor, sit amet consectetur
                                adipisicing elit. Placeat minus distinctio
                                itaque odit magnam voluptate quos ipsam ab
                                provident! Facere minus aperiam non architecto
                                sequi, temporibus aspernatur harum consequatur,
                                laboriosam nam ratione adipisci? Doloremque sed
                                ducimus aliquid dicta beatae! Quasi voluptas
                            ...
                            <div id="item-1-2">
                              ...
                              <p className="text-muted">
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Tempore eius consectetur quae
                                modi iste voluptatibus a quidem amet ea corporis
                                neque non quasi nesciunt sunt numquam minima
                                maiores eveniet ratione soluta temporibus, quam
                                harum nostrum. Laudantium repellat, dolores
                                blanditiis iusto tempora corrupti. Distinctio,
                                nesciunt. Tenetur sapiente cumque, totam veniam
                                repellat alias quasi, beatae eveniet quas eos,
                                ea aperiam!
                              </p>
                            </div>
                            <div id="item-2">
                              ...
                              <p className="text-muted">
                                Lorem ipsum dolor sit, amet consectetur
                                adipisicing elit. Once upon a time in a quiet
                                little town, Sarah discovered an old, mysterious
                                key in her grandmother's attic. She had no idea
                                what it unlocked. With a sense of adventure, she
                                set out on a quest to find the hidden treasure
                                that the key must surely belong to. Along the
                                way, she encountered riddles, puzzles, and
                                unexpected allies. The journey not only led her
                                to a long-lost family heirloom but also revealed
                                the importance of family history and the value
                                of determination.
                              </p>
                            </div>
                            <div id="item-3">
                              ...
                              <p className="text-muted">
                                Lorem ipsum dolor sit, amet consectetur
                                adipisicing elit. Fuga voluptate sequi
                                exercitationem voluptatem, commodi dicta nostrum
                                atque, praesentium consequatur eos at vero animi
                                neque deleniti ipsa. Aliquid facere saepe
                                pariatur porro nihil blanditiis recusandae dolor
                                fuga? Iusto et omnis neque doloremque, cum modi
                                officia facilis placeat repellendus obcaecati
                                mollitia! Id aperiam officiis vitae. Fugit quo
                                id veritatis commodi maiores numquam nostrum
                                necessitatibus eaque, quia exercitationem
                                distinctio ipsa eum, nihil atque perferendis
                                dicta, mollitia sed dignissimos incidunt
                                voluptas ab tempore laborum? Fugiat, deserunt.
                                Harum, repellat praesentium! Fuga!
                              </p>
                            </div>
                            <div id="item-3-1">
                            ...
                            <div id="item-3-2">
                              ...
                              <p className="text-muted">
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Quo, est. Blanditiis
                                cupiditate voluptate obcaecati eligendi iusto
                                amet. Cupiditate laborum, itaque laboriosam
                                culpa sunt eligendi.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"            "}class="navbar bg-light flex-column
                        align-items-stretch p-3"&gt;{"\n"}
                        ...
                        flex-column"&gt;{"\n"}
                        {"                    "}&lt;a class="nav-link ms-3 my-1"
                        href="#item-3-1"&gt;Item 3-1&lt;/a&gt;{"\n"}
                        {"                    "}&lt;a class="nav-link ms-3 my-1"
                        href="#item-3-2"&gt;Item 3-2&lt;/a&gt;{"\n"}
                        {"                "}&lt;/nav&gt;{"\n"}
                        {"            "}&lt;/nav&gt;{"\n"}
                        {"        "}&lt;/nav&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        ...
                        data-bs-target="#navbar-example3"{"\n"}
                        {"            "}data-bs-smooth-scroll="true"
                        tabindex="0" class="scrollspy-example-2"&gt;{"\n"}
                        {"            "}&lt;div id="item-1"&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"&gt;Item
                        1&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;Lorem
                        ipsum dolor sit amet consectetur adipisicing elit.{"\n"}
                        {"                    "}Asperiores{"\n"}
                        {"                    "}explicabo in delectus nostrum
                        aut ab quasi placeat facilis?{"\n"}
                        {"                    "}Laborum{"\n"}
                        {"                    "}corporis eaque ipsum laboriosam
                        animi possimus.&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"            "}&lt;div id="item-1-1"&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"&gt;Item
                        ...
                        {"                    "}Placeat{"\n"}
                        {"                    "}minus{"\n"}
                        {"                    "}Once upon a time in a quiet
                        little town, Sarah discovered an old, mysterious key in
                        her grandmother's attic. She had no idea what it
                        unlocked. With a sense of adventure, she set out on a
                        quest to find the hidden treasure that the key must
                        surely belong to. Along the way, she encountered
                        riddles, puzzles, and unexpected allies. The journey not
                        only led her to a long-lost family heirloom but also
                        revealed the importance of family history and the value
                        of determination.{"\n"}
                        {"                "}&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"            "}&lt;div id="item-1-2"&gt;{"\n"}
                        ...
                        {"                    "}Tempore{"\n"}
                        {"                    "}eius{"\n"}
                        {"                    "}consectetur quae modi iste
                        voluptatibus a quidem amet ea{"\n"}
                        {"                    "}corporis neque{"\n"}
                        {"                    "}non quasi nesciunt sunt numquam
                        minima maiores eveniet{"\n"}
                        {"                    "}ratione{"\n"}
                        {"                    "}soluta{"\n"}
                        {"                    "}temporibus, quam harum nostrum.
                        Laudantium repellat, dolores{"\n"}
                        {"                    "}blanditiis{"\n"}
                        {"                    "}iusto tempora corrupti.
                        Distinctio, nesciunt. Tenetur{"\n"}
                        {"                    "}sapiente{"\n"}
                        {"                    "}cumque,{"\n"}
                        {"                    "}totam veniam repellat alias
                        quasi, beatae eveniet quas eos,{"\n"}
                        {"                    "}ea{"\n"}
                        {"                    "}aperiam!{"\n"}
                        {"                "}&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        ...
                        {"                    "}Eius,{"\n"}
                        {"                    "}itaque{"\n"}
                        {"                    "}debitis. Numquam facere sunt
                        adipisci dolores ratione quo{"\n"}
                        {"                    "}magni.{"\n"}
                        {"                    "}Non,{"\n"}
                        {"                    "}officiis minima deserunt
                        consequatur, repellendus nihil{"\n"}
                        {"                    "}laudantium{"\n"}
                        {"                    "}aperiam laborum eaque animi
                        maxime porro saepe nisi quos.{"\n"}
                        {"                    "}Corporis hic{"\n"}
                        {"                    "}tempore illo reiciendis autem,
                        necessitatibus debitis sed{"\n"}
                        {"                    "}molestias.&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"            "}&lt;div id="item-3"&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"&gt;Item
                        ...
                        {"                    "}Fuga{"\n"}
                        {"                    "}voluptate{"\n"}
                        {"                    "}sequi exercitationem voluptatem,
                        commodi dicta nostrum{"\n"}
                        {"                    "}atque,{"\n"}
                        {"                    "}praesentium consequatur eos at
                        vero animi neque deleniti{"\n"}
                        {"                    "}ipsa.{"\n"}
                        {"                    "}Once upon a time in a quiet
                        little town, Sarah discovered an old, mysterious key in
                        her grandmother's attic. She had no idea what it
                        ...
                        {"                    "}Numquam{"\n"}
                        {"                    "}non{"\n"}
                        {"                    "}deleniti saepe voluptate, est
                        praesentium ducimus sapiente{"\n"}
                        {"                    "}aut{"\n"}
                        {"                    "}dignissimos voluptas blanditiis
                        reiciendis earum accusantium{"\n"}
                        {"                    "}id{"\n"}
                        {"                    "}ex!&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"            "}&lt;div id="item-3-2"&gt;{"\n"}
                        ...
                        {"\n"}
                        {"                    "}est.{"\n"}
                        {"                    "}Blanditiis cupiditate voluptate
                        obcaecati eligendi iusto{"\n"}
                        {"                    "}amet.{"\n"}
                        {"                    "}Cupiditate laborum, itaque
                        laboriosam culpa sunt eligendi.{"\n"}
                        {"                "}&lt;/p&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}&lt;/div&gt;
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-10 col-12">
                            <div
                              ...
                              data-bs-smooth-scroll="true"
                              className="scrollspy-example-3"
                              tabIndex={0}
                            >
                              <h6 className="fw-semibold" id="list-item-01">
                                Item 1
                              </h6>
                              <p className="text-muted">
                                Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Vel, laborum reiciendis sunt
                                officia doloribus, soluta ratione id
                                reprehenderit autem temporibus cupiditate
                                necessitatibus atque similique quam ex minus,
                                sint ipsum deleniti sed assumenda fugiat numquam
                                saepe incidunt perferendis. Aliquid, quas.
                              </p>
                              <h6 className="fw-semibold" id="list-item-02">
                                Item 2
                              </h6>
                              <p className="text-muted">
                                Lorem ipsum dolor sit amet, consectetur
                              ...
                              <h6 className="fw-semibold" id="list-item-03">
                                Item 3
                              </h6>
                              <p className="text-muted">
                                Lorem ipsum dolor sit amet, consectetur
                              ...
                              <h6 className="fw-semibold" id="list-item-04">
                                Item 4
                              </h6>
                              <p className="text-muted">
                                Lorem ipsum dolor sit amet, consectetur
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        data-bs-target="#list-example"{"\n"}
                        {"                "}data-bs-smooth-scroll="true"
                        class="scrollspy-example-3"{"\n"}
                        {"                "}tabindex="0"&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="list-item-01"&gt;Item 1&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;Lorem
                        ipsum dolor sit amet, consectetur adipisicing elit.
                        {"\n"}
                        {"                "}Once upon a time in a quiet little
                        town, Sarah discovered an old, mysterious key in her
                        grandmother's attic. She had no idea what it unlocked.
                        With a sense of adventure, she set out on a quest to
                        find the hidden treasure that the key must surely belong
                        to. Along the way, she encountered riddles, puzzles, and
                        ...
                        {"                    "}Aliquid, quas.&lt;/p&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="list-item-02"&gt;Item 2&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;Lorem
                        ipsum dolor sit amet, consectetur adipisicing elit.
                        {"\n"}
                        {"                    "}Vel,{"\n"}
                        {"                    "}laborum{"\n"}
                        {"                    "}reiciendis sunt officia
                        doloribus, soluta ratione id{"\n"}
                        {"                    "}reprehenderit{"\n"}
                        {"                    "}autem{"\n"}
                        {"                    "}temporibus cupiditate
                        necessitatibus atque similique quam ex{"\n"}
                        {"                    "}minus,{"\n"}
                        {"                    "}sint{"\n"}
                        {"                    "}ipsum deleniti sed assumenda
                        fugiat numquam saepe incidunt{"\n"}
                        {"                    "}perferendis.{"\n"}
                        {"                    "}Aliquid, quas.&lt;/p&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="list-item-03"&gt;Item 3&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;Lorem
                        ipsum dolor sit amet, consectetur adipisicing elit.
                        {"\n"}
                        {"                    "}Vel,{"\n"}
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Simple anchors</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                          ...
                          <div className="col-md-10 col-12">
                            ...
                            >
                              ...
                              <p className="text-muted">
                                ...
                                scrollspy page. Note that as you scroll down the
                                page, the appropriate navigation link is
                                highlighted. It's repeated throughout the
                                component example. We keep adding some more
                                example copy here to emphasize the scrolling and
                                highlighting.
                              </p>
                              <h6
                                className="fw-semibold"
                              ...
                              <p className="text-muted">
                                This is some placeholder content for the
                                scrollspy page. Note Once upon a time in a quiet
                                little town, Sarah discovered an old, mysterious
                                key in her grandmother's attic. She had no idea
                                what it unlocked. With a sense of adventure, she
                                set out on a quest to find the hidden treasure
                              ...
                              <p className="text-muted">
                                ...
                                to a long-lost family heirloom but also revealed
                                the importance of family history and the value
                                of determination. the scrolling and
                                highlighting.
                              </p>
                            </div>
                          </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        simple-list-example-scrollspy text-center"&gt;{"\n"}
                        {"                "}&lt;a class="p-2 rounded"
                        href="#simple-list-item-1"&gt;Item 1&lt;/a&gt;{"\n"}
                        {"                "}&lt;a class="p-2 rounded"
                        href="#simple-list-item-2"&gt;Item 2&lt;/a&gt;{"\n"}
                        {"                "}&lt;a class="p-2 rounded"
                        href="#simple-list-item-3"&gt;Item 3&lt;/a&gt;{"\n"}
                        {"                "}&lt;a class="p-2 rounded"
                        href="#simple-list-item-4"&gt;Item 4&lt;/a&gt;{"\n"}
                        {"                "}&lt;a class="p-2 rounded"
                        href="#simple-list-item-5"&gt;Item 5&lt;/a&gt;{"\n"}
                        {"            "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;/div&gt;{"\n"}
                        {"        "}&lt;div class="col-md-10 col-12"&gt;{"\n"}
                        {"            "}&lt;div data-bs-spy="scroll"
                        ...
                        {"                "}data-bs-offset="0"
                        data-bs-smooth-scroll="true"{"\n"}
                        {"                "}class="scrollspy-example-4"
                        tabindex="0"&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="simple-list-item-1"&gt;Item 1&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;This is
                        some placeholder content for the scrollspy page. Note
                        {"\n"}
                        {"                    "}that as you scroll down the
                        page, the appropriate navigation{"\n"}
                        {"                    "}link is highlighted. It's
                        repeated throughout the component{"\n"}
                        {"                    "}example. We keep adding some
                        more example copy here to{"\n"}
                        {"                    "}emphasize{"\n"}
                        {"                    "}the scrolling and
                        highlighting.&lt;/p&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="simple-list-item-2"&gt;Item 2&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;This is
                        some placeholder content for the scrollspy page. Note
                        {"\n"}
                        {"                    "}that as you scroll down the
                        ...
                        highlighting.&lt;/p&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="simple-list-item-3"&gt;Item 3&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;This is
                        some placeholder content for the scrollspy page. Note
                        {"\n"}
                        {"                    "}that as you scroll down the
                        ...
                        highlighting.&lt;/p&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="simple-list-item-4"&gt;Item 4&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;This is
                        some placeholder content for the scrollspy page. Note
                        {"\n"}
                        {"                    "}that as you scroll down the
                        ...
                        highlighting.&lt;/p&gt;{"\n"}
                        {"                "}&lt;h6 class="fw-semibold"
                        id="simple-list-item-5"&gt;Item 5&lt;/h6&gt;{"\n"}
                        {"                "}&lt;p class="text-muted"&gt;This is
                        some placeholder content for the scrollspy page. Note
                        {"\n"}
                        {"                    "}that as you scroll down the
