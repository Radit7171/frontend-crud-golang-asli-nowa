                      ...
                      <table className="table table-bordered table-hover mb-0 text-nowrap">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td className="text-center text-lg text-medium fw-bold  fs-15">
                              $80.00
                            </td>
                            <td className="text-center">
                  ...
                  <div className="card-footer d-flex justify-content-between flex-wrap gap-2">
                    <div>
                      <a className="btn btn-secondary" href="shop.html">
                        <i className="fe fe-corner-up-left  mx-2" />
                        Back to Shopping
                      </a>
                    </div>
                    <div className="btn-list">
                      <a className="btn btn-primary" href="product-cart.html">
                        <i className="fe fe-refresh-cw mx-2" />
                        Update Cart
                      </a>
                      <a
                ...
                <div className="card custom-card cart-details">
                  <div className="card-body p-0">
                    ...
                    <div className="px-4">
                      <dl className="dlist-align">
                        <dt>Total:</dt>
                        <dd className="text-end  ms-auto fs-20">
