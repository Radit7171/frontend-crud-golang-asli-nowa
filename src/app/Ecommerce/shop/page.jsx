          ...
          <div className="main-container container-fluid">
            ...
            <div className="row row-sm">
              <div className="col-xl-9 col-lg-8 col-md-12">
                <div className="row row-sm">
                  <div className="col-md-4 col-lg-6 col-xl-4 col-xxl-3  col-sm-6">
                    <div className="card">
                      <div className="card-body h-100  product-grid6">
                        <div className="pro-img-box product-image">
                          ...
                          <ul className="icons list-unstyled">
                            <li>
                              <a
                                href="wish-list.html"
                                className="primary-gradient me-2"
                                data-bs-placement="top"
                                data-bs-toggle="tooltip"
                        ...
                        <div className="text-center pt-2">
                          ...
                          <span className="fs-15 ms-auto">
                            <i className="ion ion-md-star text-warning" />
                            <i className="ion ion-md-star text-warning" />
                            <i className="ion ion-md-star text-warning" />
                            <i className="ion ion-md-star-half text-warning" />
                            <i className="ion ion-md-star-outline text-warning" />
                          </span>
                          <h4 className="h5 mb-0 mt-1 text-center fw-bold  fs-22">
                            $55{" "}
                            <span className="text-secondary fw-normal fs-13 ms-1 prev-price text-decoration-line-through">
                              $59
                            </span>
                          </h4>
                        </div>
                      ...
                      <div className="card-body h-100  product-grid6">
                        <div className="pro-img-box product-image">
                          <a href="product-details.html">
                            ...
                            <img
                              className="pic-2"
                              src="/assets/images/ecommerce/20.jpg"
                              alt="product-image-1"
                            />
                          </a>
                          <ul className="icons list-unstyled">
                      ...
                      <div className="card-body h-100  product-grid6">
                        <div className="pro-img-box product-image">
                          <a href="product-details.html">
                            ...
                            <img
                              className="pic-2"
                              src="/assets/images/ecommerce/17.jpg"
                              alt="product-image-1"
                            />
                          </a>
                          <ul className="icons list-unstyled">
                      ...
                      <div className="card-body h-100  product-grid6">
                        <div className="pro-img-box product-image">
                          <a href="product-details.html">
                            ...
                            <img
                              className="pic-2"
                              src="/assets/images/ecommerce/18.jpg"
                              alt="product-image-1"
                            />
                          </a>
                          <ul className="icons list-unstyled">
                      ...
                      <div className="card-body h-100  product-grid6">
                        <div className="pro-img-box product-image">
                          <a href="product-details.html">
                            ...
                            <img
                              className="pic-2"
                              src="/assets/images/ecommerce/15.jpg"
                              alt="product-image-1"
                            />
                          </a>
                          <ul className="icons list-unstyled">
                  ...
                  <ul className="pagination product-pagination justify-content-end list-unstyled">
              ...
              <div className="col-xl-3 col-lg-4 col-md-12 mb-3 mb-md-0">
                ...
                <div className="card">
                  ...
                  <div className="card border-0 rounded-0">
                    <div className="card-header border-bottom pt-3 pb-3 mb-0 fw-bold text-uppercase">
                      Category
                    </div>
                    <div className="card-body pb-0">
                      <div className="form-group">
                        ...
                        >
                          ...
                          <option value="Choice 3">Bottom wear</option>
                    ...
                    <div className="card-header border-bottom border-top pt-3 pb-3 mb-0 fw-bold text-uppercase rounded-0">
                      Rating
                    </div>
                    <div className="card-body">
                      <form>
                        <div className="form-group">
                          ...
                          >
                            <option value="">--Select--</option>
                            <option value="Choice 1">Wallmart</option>
                            <option value="Choice 2">Catseye</option>
                            <option value="Choice 3">Monsoon</option>
                            <option value="Choice 4">Textmart</option>
                          </select>
                        </div>
                        <div className="form-group">
                          ...
                          >
                            <option value="">--Select--</option>
                            <option value="Choice 1">Small</option>
                            <option value="Choice 2">Medium</option>
