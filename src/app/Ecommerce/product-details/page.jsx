                ...
                <div className="row row-sm ">
                            ...
                            <div className="carousel-inner">
                              <ul className="carousel-item active">
                                <li
                                  ...
                                  data-bs-slide-to={0}
                                  className="thumb active my-sm-2 m-2 mx-sm-0"
                                >
                                  <img
                                    src="/assets/images/ecommerce/25.png"
                                    alt="img"
                                  />
                                </li>
                                <li
                                  data-bs-target="#Slider"
                                  data-bs-slide-to={1}
                                  className="thumb my-sm-2 m-2 mx-sm-0"
                                >
                                  <img
                                    src="/assets/images/ecommerce/27.png"
                                    alt="img"
                                  />
                                </li>
                                <li
                                ...
                                >
                                  <img
                                    src="/assets/images/ecommerce/28.png"
                                    alt="img"
                                  />
                                </li>
                                <li
                                ...
                                >
                                  <img
                                    src="/assets/images/ecommerce/26.png"
                                    alt="img"
                                  />
                                </li>
                              </ul>
                            ...
                            <div className="carousel-inner">
                              ...
                              <div className="carousel-item">
                                ...
                                <img
                                  ...
                                  className="img-fluid mx-auto d-block"
                                />
                                <div className="text-center mb-5 mt-5 btn-list"></div>
                              </div>
                              <div className="carousel-item">
                                {" "}
                                <img
                  ...
                  <div className="details col-xxl-6 col-lg-12 col-md-12 mt-4">
                    <h4 className="product-title mb-1">
                      Jyothi Fashion Women's Fit &amp; Flare Knee Length Western
                      Frock
                    </h4>
                    ...
                    <div className="mb-3">
                      <div className="">
                        <p className="font-weight-normal">
                          ...
                          <span className="text-primary h5 ">110/150</span>{" "}
                          products in stock.
                        </p>
                        <p></p>
                      </div>
                        ...
                        <ul className=" mb-0 Quantity-list">
                          <li>
                            <div className="form-group">
                              <select
                                name="quantity"
                                id="select-countries17"
                                className="form-control nice-select wd-100"
                                data-trigger=""
                              >
                ...
                <div className="panel panel-primary">
                  ...
                  <div className="panel-body tabs-menu-body">
                    <div className="tab-content">
                      <div className="tab-pane active border-0" id="tab5">
                          ...
                          <table className="table table-bordered">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  {" "}
                                  #141 in Clothing &amp; Accessories (See Top
                                  100 in Clothing &amp; Accessories)
                                </td>
                              </tr>
                              <tr>
                                <td className="fw-semibold">
                                ...
                                <td>
                                  <p className="text-muted float-start me-3">
                                    ...
                                    <span className="fa fa-star-o text-warning" />
                      ...
                      <div className="tab-pane border-0" id="tab6">
                        <div className="table-responsive">
                          <table className="table table-bordered">
                            <tbody>
                              <tr>
                      ...
                      <div className="tab-pane border-0" id="tab7">
                        <div className="table-responsive">
                          <table className="table table-bordered">
                            <tbody>
                              <tr>
                                <td>
                                  <i className="fa fa-check me-3 text-success" />
              ...
              <div className="card-body p-0">
                ...
                <div className="media mt-0 p-3 border-bottom border-top">
                  ...
                  <div className="media-body">
                    <a href="profile.html">
                      <p className="mt-0 mb-1 fw-semibold fs-16">
                        Bruce Tran
                        <span
                    ...
                    <div className="text-warning mt-1">
                      <i className="bx bxs-star active" />
                      <i className="bx bxs-star active" />
                      <i className="bx bxs-star active" />
                      <i className="bx bxs-star active" />
                    ...
                    <p className="mb-1">
                      ...
                      <span className="float-end">
                        {" "}
                        <a href="javascript:void(0)" className="new ms-3">
                          <i className="text-success br-7 text-success fe fe-thumbs-up fs-16 text-icon " />
                        </a>
                        <a href="javascript:void(0)" className="new ms-3 mt-6">
                          <i className="text-danger br-7 text-danger fe fe-thumbs-down  fs-16 text-icon" />
                        </a>
                      </span>
                    </p>
                  </div>
                ...
                <div className="media mt-0  p-3 border-bottom">
                  ...
                  <div className="media-body">
                    <a href="profile.html">
                      <span className="mt-0 mb-1 fw-semibold fs-16">
                        Mina Harpe
                      </span>
                      <span
                        className="fs-14 ms-0"
                ...
                <div className="media mt-0 p-3">
                  ...
                  <div className="media-body">
                    <a href="profile.html">
                      <h5 className="mt-0 mb-1 fw-semibold fs-16">
                        Maria Quinn
                        <span
                          className="fs-14 ms-0"
                          data-bs-toggle="tooltip"
                    ...
                    <div className="text-warning mt-1">
                      ...
                      <i className="bx bxs-star active" />
                      <i className="bx bxs-star active" />
                      <i className="bx bxs-star text-light" />
                    </div>
                    <p className="mb-2 mt-2">
            ...
            <div className="card">
              <div className="ps-4 pe-4 pb-2 pt-4">
                ...
                <form>
                  ...
                  <div className="form-group">
                    <button className="btn btn-primary mt-3 mb-0" type="button">
                      Post your review
                    </button>
                  </div>
                </form>
            ...
            <div className="card item-card">
              <div className="card-body pb-0 h-100  product-grid6">
                <div className="text-center product-image">
                  <img
                    src="/assets/images/ecommerce/2.jpg"
                    alt="img"
                    className="img-fluid"
                  />
                </div>
                <div className="card-body cardbody position-relative">
                  <div className="cardtitle">
                    <span className="fs-12 mb-2 fw-bold text-uppercase">
                      Fashion
                    </span>
                    <a className="h6 mb-2 mt-4 fw-bold text-uppercase">
                      {" "}
                      long slit
                    </a>
                  </div>
              ...
              <div className="text-center border-top pt-3 pb-3 ps-2 pe-2 ">
                <a
                  href="javascript:void(0);"
                  className="btn btn-primary mb-0 mb-lg-2"
                >
                  {" "}
                  View More
                </a>
                <a
                  href="product-cart.html"
                  className="btn btn-secondary mb-0 mb-lg-2"
                >
          ...
          <div className="col-xl-3 col-sm-6">
            <div className="card item-card">
              <div className="card-body pb-0 h-100  product-grid6">
                <div className="text-center product-image">
                  <img
                    src="/assets/images/ecommerce/22.jpg"
                    alt="img"
                    className="img-fluid"
                  />
                </div>
          ...
          <div className="col-xl-3 col-sm-6">
            <div className="card item-card">
              <div className="card-body pb-0 h-100 product-grid6">
                <div className="text-center product-image">
                  <img
                    src="/assets/images/ecommerce/21.jpg"
                    alt="img"
                    className="img-fluid"
                  />
                </div>
