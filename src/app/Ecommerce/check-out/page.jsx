              ...
              <div className="col-xl-9">
                <div className="card">
                  <div className="card-body p-0 product-checkout">
                    <ul
                      className="nav nav-tabs tab-style-2 d-sm-flex d-block border-bottom border-block-end-dashed"
                      id="myTab1"
                      role="tablist"
                    >
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          aria-selected="true"
                        >
                          <i className="ri-number-1 me-2 align-middle" />
                          Sign In
                        </button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <i className="ri-number-2 me-2 align-middle" />
                          Billing
                        </button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <i className="ri-number-3 me-2 align-middle" />
                          Order
                        </button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          aria-selected="false"
                        >
                          <i className="ri-number-4 me-2 align-middle" />
                          Payments
                        </button>
                      </li>
                      <li className="nav-item" role="presentation">
                        <button
                          ...
                          id="finished-tab"
                          data-bs-toggle="tab"
                          data-bs-target="#finished-tab-pane"
                          type="button"
                          role="tab"
                          aria-controls="finished-tab"
                          aria-selected="false"
                        >
                          <i className="ri-number-5 me-2 align-middle" />
                          Finished
                        </button>
                      </li>
                    </ul>
                    <div className="row">
                      <div className="col-xl-8 mx-auto">
                        <div
                          className="tab-content border m-4"
                          id="myTabContent"
                        >
                          <div
                              ...
                              <div className="fs-15 fw-semibold align-items-center justify-content-between mb-3 z">
                                <form>
                                  ...
                                  <p className="mb-4 text-muted tx-13 ms-0 text-start">
                                    Signin to create, discover and connect with
                              ...
                              <div className="product">
                                <div className="item flex-wrap px-4 py-3">
                                  <div className="left flex-wrap gap-2">
                                    ...
                                    <a
                                      href="javascript:void(0);"
                                      className="thumb rounded-3 mb-2"
                                    >
                                      {" "}
                                      <img
                            ...
                            <div className="p-4">
                              ...
                              <div className="card-pay">
                                <ul className="tabs-menu nav">
                                  <li className="">
                                    <a
                                      ...
                                      data-bs-toggle="tab"
                                    >
                                      <i className="fa fa-credit-card" /> Credit
                                      Card
                                    </a>
                                  </li>
                                  <li>
                                ...
                                <div className="tab-content">
                                  <div
                                    className="tab-pane border-0 active show"
                                    id="tab20"
                                  >
                                  ...
                                  <div className="tab-pane border-0" id="tab21">
                                    ...
                                    <p>
                                      <a
                                        ...
                                        className="btn btn-primary"
                                      >
                                        <i className="fab fa-paypal" /> Log in
                                        my Paypal
                                      </a>
                                    </p>
                                    <p className="mb-0">
                          ...
                          <div
                            className="tab-pane fade border-0 p-0"
                            id="finished-tab-pane"
                            role="tabpanel"
                            aria-labelledby="finished-tab-pane"
                            tabIndex={0}
                          >
                            <div className="text-center p-4">
                              ...
                              <p className="success pl-5 pr-5">
                                ...
                                dispacted soon. meanwhile you can track your
                                order in my order section.
                              </p>
                            </div>
                            <div className="px-4 py-3 border-top border-block-start-dashed d-sm-flex justify-content-between">
                              <button
