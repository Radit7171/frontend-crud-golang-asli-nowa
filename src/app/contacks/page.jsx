            ...
            <div className="breadcrumb-header justify-content-between">
              ...
              <div className="justify-content-center">
                <button type="button" className="btn btn-primary">
                  <i className="fe fe-plus me-1" /> Add New Contact
                </button>
              </div>
            </div>
            {/* /breadcrumb */}
                  ...
                  <div className="">
                    <div className="main-content-contacts pt-0">
                      <div className="main-content-left main-content-left-contacts">
                        <nav className="nav main-nav-line  border-bottom-0 main-nav-line-chat  p-3">
                          <a
                            className="nav-link active"
                            data-bs-toggle="tab"
                            href="#mainContactList"
                          >
                            All Contacts
                          </a>
                          <a
                  ...
                  <div className="main-content-body main-content-body-contacts card custom-card">
                    <div className="main-contact-info-header pt-3">
                      ...
                      <div className="main-contact-action btn-list pt-3 pe-0">
                        <a
                          href="javascript:void(0);"
                          className="btn ripple btn-primary text-fixed-white btn-icon"
                          data-placement="top"
                          data-bs-toggle="tooltip"
                          title="Edit Profile"
                        >
                        ...
                        <a
                          href="javascript:void(0);"
                          className="btn ripple btn-secondary text-fixed-white btn-icon"
                          data-placement="top"
                          data-bs-toggle="tooltip"
                        ...
                        <a
                          href="javascript:void(0);"
                          className="btn ripple btn-warning text-fixed-white btn-icon"
                          data-placement="top"
                          data-bs-toggle="tooltip"
                          title="Add Favorite"
                        >
                    ...
                    <div className="main-contact-info-body">
                      <div className="px-4 py-3">
                        ...
                        <p>
                          ...
                          reprehenderit qui in ea voluptate velit esse quam
                          nihil molestiae consequatur, vel illum qui dolorem eum
                          fugiat quo voluptas nulla pariaturexplicabo. Nemo enim
                        ...
                        <div className="media">
                          <div className="media-body px-4">
                            <div>
                              ...
                              <span className="tx-medium">
                                012 Dashboard Apartments, Dayl Francisco,
                                California 13245
                              </span>
                            </div>
                          </div>
