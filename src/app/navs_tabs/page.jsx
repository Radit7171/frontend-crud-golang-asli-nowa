...
export default function Navs_tabs() {
                    ...
                    <div className="example">
                      ...
                      <div className="tab-content">
                        <div
                          ...
                          role="tabpanel"
                        >
                          <b>Lorem Ipsum is simply dummy</b> text of the
                        ...
                        >
                          ...
                          <b>Making it over 2000 years old</b>. Richard
                    ...
                    <div className="example">
                      ...
                      <div className="tab-content">
                        ...
                        >
                          ...
                          cheapest flights can find you the love of your life.
                          The complete beginner's guide to mission trips. If you
                          read one article about cultural notes read this one.
                        ...
                        >
                          ...
                          aren't as bad as you think. How cultural solutions can
                          help you predict the future. How to cheat at dog
                          friendly hotels and get away with it. 17 problems with
                          summer activities. How to cheat at travel agents and
                          get away with it. How not knowing family trip ideas
                        ...
                        >
                          ...
                          youtube videos. How restaurant weeks can make you
                          sick. The complete beginner's guide to cooking healthy
                          food. Unbelievable food stamp success stories. How
                          whole foods markets are making the world a better
                        ...
                        >
                          ...
                          making the world a better place. 8 great articles
                          about minute meals. Why our world would end if healthy
                          snacks disappeared. Why the world would end without
                          mexican food. The evolution of chef uniforms. How not
                          knowing food processors makes you a rookie. Why whole
                          foods markets beat peanut butter on pancakes.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="card-body">
                    <div className="example">
                      ...
                      >
                        ...
                        >
                          Cart{" "}
                          <span className="badge bg-info-transparent ms-1">
                            Full
                          </span>
                        </a>
                        <a
                        ...
                        >
                          Offers{" "}
                          <span className="badge bg-warning-transparent ms-1">
                            7
                          </span>
                        </a>
                      </nav>
                        ...
                        <div className="col-xl-9">
                          <div className="tab-content">
                            ...
                            >
                              ...
                              the future. How to cheat at dog friendly hotels
                              and get away with it. 17 problems with summer
                            ...
                            >
                              How travel coupons make you a better lover. Why
                              cultural solutions are the new black. Why mom was
                              right about travel insurances. How family trip
                              ideas can help you predict the future.{" "}
                              <b>
                                How carnival cruises make you a better lover
                              </b>
                              . Why you'll never succeed at daily deals. 11 ways
                              cheapest flights can find you the love of your
                              life. The complete beginner's guide to mission
                              trips.
                            </div>
                            <div
                              className="tab-pane text-muted"
                            ...
                            >
                              ...
                              restaurants are making the world a better place. 8
                              great articles about minute meals. Why our world
                              would end if healthy snacks disappeared. Why the
                              world would end without mexican food. The
                        ...
                        <div className="col-xl-3">
                          ...
                          >
                            <a
                              ...
                              aria-selected="false"
                            >
                              <i className="ri-home-smile-line me-2 align-middle d-inline-block" />
                              Home
                            </a>
                            <a
                              className="nav-link"
                              ...
                              aria-selected="false"
                            >
                              <i className="ri-archive-drawer-line me-2 align-middle d-inline-block" />
                              About
                            </a>
                            <a
                              className="nav-link active"
                              ...
                              aria-selected="true"
                            >
                              <i className="ri-bank-line me-2 align-middle d-inline-block" />
                              Services
                            </a>
                            <a
                              className="nav-link"
                              ...
                              aria-selected="false"
                            >
                              <i className="ri-contacts-book-2-line me-2 align-middle d-inline-block" />
                              Contacts
                            </a>
                          </nav>
                        </div>
                        <div className="col-xl-9">
                          <div className="tab-content">
                            ...
                            >
                              ...
                              <b>
                                <i>
                                  Will mexican food ever rule the world? The 10
                                  best thai restaurant youtube videos
                                </i>
                              </b>
                        ...
                        >
                          <ul className="mb-0">
                            ...
                            <li>
                              How travel coupons make you a better lover. Why
                              cultural solutions are the new black. Why mom was
                              header about travel insurances. How family trip
                              ideas can help you predict the future.{" "}
                              <b>
                                How carnival cruises make you a better lover
                              </b>
                      ...
                      <div className="tab-content">
                        ...
                        <div className="tab-pane" id="accepted" role="tabpanel">
                          <div className="text-muted">
                            ...
                            text, and a search for <b>'lorem ipsum'</b> will
                      ...
                      >
                        <li className="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="true"
                          >
                            <i className="ri-gift-line me-1 align-middle" />
                            Ordered
                          </button>
                        </li>
                        <li className="nav-item" role="presentation">
                        ...
                        <li className="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="false"
                          >
                            <i className="ri-shopping-bag-3-line me-1 align-middle" />
                            Shipped
                          </button>
                        </li>
                      </ul>
                    ...
                    <div className="example">
                      ...
                      <div className="tab-content" id="myTabContent1">
                        ...
                        <div
                          ...
                          tabIndex={0}
                        >
                          Many desktop publishing packages as their default
                          model text, and a search for <b>'lorem ipsum'</b> will
                          over the years.
                        </div>
                        <div
                          className="tab-pane fade text-muted"
                    ...
                    <div className="example">
                      ...
                      <div className="tab-content" id="tab-style-4">
                        ...
                        >
                          ...
                          <b>Many desktop publishing</b> packages and web page
                          editors now use Lorem Ipsum as their default model
                          ...
                          sometimes on purpos, remaining essentially unchanged.
                        </div>
                        <div
                          className="tab-pane"
                          id="nav-contact1"
                        ...
                        >
                          ...
                          which don't look even slightly believable.{" "}
                          <b>If you are going</b> to use a passage of Lorem
                          Ipsum, you need to be sure there isn't anything
                      ...
                      >
                        <li className="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="true"
                          >
                            <i className="ri-gift-line me-1 align-middle d-inline-block" />
                            Products
                          </button>
                        </li>
                        <li className="nav-item" role="presentation">
                        ...
                        <li className="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="false"
                          >
                            <i className="ri-money-dollar-box-line me-1 align-middle d-inline-block" />
                            Profit
                          </button>
                        </li>
                        <li className="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="false"
                          >
                            <i className="ri-exchange-box-line me-1 align-middle d-inline-block" />
                            Expenses
                          </button>
                        </li>
                      </ul>
                        ...
                        <div className="col-md-2">
                          ...
                          >
                            <button
                              ...
                              aria-selected="true"
                            >
                              <i className="ri-shield-user-line me-1 align-middle d-inline-block" />
                              Profile
                            </button>
                            <button
                                ...
                                <div>
                                  <div className="my-md-auto mt-4 ms-md-3">
                                    ...
                                    <p className="text-muted mb-0 ms-2">
                                      <b>Lorem Ipsum</b> is simply dummy text of
                        ...
                        <div className="col-md-9">
                          <div className="tab-content">
                            ...
                            >
                              <ul className="mb-0">
                                <li className="mb-2">
                                  How hotel deals can help you live a better
                                  life. <b>How celebrity cruises</b> aren't as
                                  bad as you think. How cultural solutions can
                                  help you predict the future. How to cheat at
                                  dog friendly hotels and get away with it. 17
                                  problems with summer activities. How to cheat
                                  at travel agents and get away with it. How not
                                  knowing family trip ideas makes you a rookie.
                                  What everyone is saying about daily deals.
                                </li>
                                <li>
                                  There are many variations of passages of Lorem
                                  Ipsum available, but the majority have
                            ...
                            >
                              <ul className="mb-0">
                                <li className="mb-2">
                                  ...
                                  translation by H. Rackham,How hotel deals can
                          ...
                          >
                            <li className="nav-item">
                              <a
                                ...
                                aria-selected="true"
                              >
                                <i className="ri-map-pin-user-line me-2 align-middle d-inline-block" />
                                Employees
                              </a>
                            </li>
                            <li className="nav-item">
                              <a
                                ...
                                aria-selected="true"
                              >
                                <i className="ri-group-line me-2 align-middle d-inline-block" />
                                Customers
                              </a>
                            </li>
                            <li className="nav-item">
                              <a
                                ...
                                aria-selected="true"
                              >
                                <i className="ri-gift-line me-2 align-middle d-inline-block" />
                                Products
                              </a>
                            </li>
                          </ul>
