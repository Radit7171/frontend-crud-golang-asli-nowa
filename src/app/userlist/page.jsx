  ...
  return (
    <>
      ...
      <div className="page">
          ...
          <div className="main-container container-fluid">
            ...
            <div className="d-flex justify-content-between mb-2 flex-wrap gap-2">
              ...
              <div className="btn-list">
                <button id="userlist-1" className="btn btn-primary  me-2">
                  Delete User
                </button>
                <button type="button" className="btn btn-secondary">
                  <i className="fe fe-download me-1" /> Download User Data
                </button>
              </div>
            </div>
            {/*Row*/}
                      ...
                      >
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <span className="badge bg-light text-muted tx-13">
                                20 days ago
                              </span>
                            </td>
                            <td>
                              <span className="text-muted tx-13">France</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                              </span>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div className="avatar avatar-md bg-success text-fixed-white rounded-circle">
                                W
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <span className="text-muted tx-13">Greece</span>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td>
                              <div className="avatar avatar-md bg-secondary text-fixed-white rounded-circle">
                                CX
                              </div>
                            </td>
                            <td>
                              <p className="tx-14 font-weight-semibold text-fixed-white mb-1">
                                Cox
                              </p>
                              <p className="tx-13 text-muted mb-0">
                                morenocox.g111@gmail.in
                              </p>
                            </td>
                            <td>
                              <span className="text-muted tx-13">
                            ...
                            <td>
                              <span className="text-muted tx-13">Texas</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Columbia</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-secondary-transparent text-secondary tx-11">
                                Not Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Spain</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Bermuda</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            <td>
                              <div className="avatar avatar-md bg-info text-fixed-white rounded-circle">
                                CH
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <span className="text-muted tx-13">China</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-secondary-transparent text-secondary tx-11">
                                Not Verified
                            ...
                            <td>
                              <span className="text-muted tx-13">3-4-2021</span>
                            </td>
                            <td>
                              <a
                                href="javascript:void(0);"
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <p className="tx-12 font-weight-semibold text-muted mb-0">
                                davidson.david@hotmail.com
                              </p>
                            </td>
                            <td>
                              <span className="text-muted tx-13">
                            ...
                            <td>
                              <span className="text-muted tx-13">Portugal</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            <td>
                              <div className="avatar avatar-md bg-warning text-fixed-white rounded-circle">
                                H
                              </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <span className="text-muted tx-13">Iceland</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">India</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Romania</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-secondary-transparent text-secondary tx-11">
                                Not Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Japan</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Mexico</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
                          ...
                          <tr>
                            ...
                            <td>
                              <span className="text-muted tx-13">Italy</span>
                            </td>
                            <td>
                              <span className="badge font-weight-semibold bg-success-transparent text-success tx-11">
                                Verified
        ...
        {/* New User Modal*/}
        <div className="modal fade" id="Vertically">
