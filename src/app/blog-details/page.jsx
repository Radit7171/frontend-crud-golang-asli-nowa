      ...
      <div className="page">
        ...
        <div className="main-content app-content">
          ...
          <div className="main-container container-fluid">
            ...
            {/*Row*/}
            <div className="row">
              <div className="col-xxl-9 col-xl-12 col-lg-12 col-md-12">
                <div className="card overflow-hidden">
                  ...
                  <div className="card-body">
                    <a href="javascript:void(0);" className="mt-4">
                  ...
                  <div className="card-footer pb-2 pt-2">
                    <div className="item7-card-desc d-md-flex">
                      ...
                      <div className="ms-auto mb-2 d-flex mt-3">
                        <a
                          href="javascript:void(0);"
                          className="me-3 mb-2 me-2 d-flex"
                        >
                          <span className="fe fe-calendar text-muted me-2 fs-17" />
                          <div className="mt-0 mt-0 text-dark">Jan-18-2020</div>
                        </a>
                        <a className="me-0 d-flex" href="javascript:void(0);">
                          <span className="fe fe-message-square text-muted me-2 fs-17" />
                  ...
                  <div className="card-body">
                      ...
                      <div className="media-body">
                        <a href="profile.html">
                          <h5 className="mt-0 mb-1 fw-semibold">
                            ...
                            >
                              <i className="fe fe-check-circle text-success fs-12" />
                            </span>
                            <span className="fs-14 ms-2">
                              {" "}
                              4.5 <i className="fa fa-star text-warning" />
                            </span>
                          </h5>
                        </a>
                        <p className="fs-13  mb-2 mt-2">
                          Lorem ipsum dolor sit amet, quis Neque porro quisquam
                          est, nostrud exercitation ullamco laboris commodo
                          consequat.
                        </p>
                        <a href="javascript:void(0);" className="me-2 mt-1">
                          <span className="badge badge-primary">
                            <span className="me-1 fe fe-thumbs-up fs-11 d-inline-flex" />
                            Helpful
                          </span>
                        </a>
                        <a href="" className="me-2 mt-1">
                          <span className="badge bg-success ">
                            <span className="me-1 fe fe-edit-2 fs-11 d-inline-flex" />
                            Comment
                          </span>
                        </a>
                        <a href="" className="me-2 mt-1">
                          <span className="badge bg-success">
                            <span className="me-1 fe fe-alert-triangle fs-11 d-inline-flex" />
                            Report
                          </span>
                        </a>
                        <div className="btn-group-sm float-sm-right ms-auto mt-1">
                          <button className="btn btn-light me-2">
                            <span className="fe fe-thumbs-up fs-16" />
                          </button>
                          <button className="btn btn-light">
                            <span className="fe fe-thumbs-down fs-16" />
                          </button>
                        </div>
                      </div>
                    </div>
                    <div className="d-sm-flex p-3 mt-4 sub-review-section border subsection-color br-tl-0 br-tr-0">
                      ...
                      <div className="media-body">
                        ...
                        <p className="fs-13  mb-2 mt-2">
                          Lorem ipsum dolor sit amet nostrud exercitation
                      ...
                      <div className="media-body">
                        <a href="profile.html">
                          <h5 className="mt-0 mb-1 fw-semibold">
                            ...
                            <span className="fs-14 ms-2">
                              {" "}
                              4 <i className="fa fa-star text-warning" />
                            </span>
                          </h5>
                        </a>
                        <p className="fs-13  mb-2 mt-2">
              ...
              <div className="col-xxl-3 col-xl-12 col-lg-12 col-md-12">
                <div className="card custom-card overflow-hidden">
                  <div className="card-header border-bottom mb-1">
                    ...
                    <div className="text-center">
                      ...
                      <div className="br-5 py-2 text-start">
                        <p>
                          ...
                          elit. Veniam nulla deleniti voluptas officia accusamus
                          magnam ullam inventore Lorem ipsum dolor, sit amet
                          consectetur dolorem quibusdam?.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="mt-2">
                        <div className="masonry row">
                          {/* <div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/1.jpg" class="js-img-viewer" data-caption="IMAGE-01"
															data-id="lion">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/2.jpg" class="js-img-viewer" data-caption="IMAGE-02"
															data-id="camel">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/3.jpg" class="js-img-viewer" data-caption="IMAGE-03"
															data-id="hippo">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/4.jpg" class="js-img-viewer" data-caption="IMAGE-04"
															data-id="koala">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/5.jpg"  class="js-img-viewer" data-caption="IMAGE-05"
															data-id=" bear">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/6.jpg" class=" js-img-viewer" data-caption="IMAGE-06"
															data-id=" rhino">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/7.jpg" class=" js-img-viewer" data-caption="IMAGE-07"
															data-id=" rhino">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/8.jpg" class=" js-img-viewer" data-caption="IMAGE-08"
															data-id=" rhino">
												...
												<div class="col-xl-4 col-lg-4 col-sm-6">
													<div class="brick">
														<a href="/assets/images/photos/9.jpg" class=" js-img-viewer" data-caption="IMAGE-09"
															data-id=" rhino">
															<img src="/assets/images/photos/9.jpg" alt="" />
														</a>
													</div>
												</div> */}
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/1.jpg"
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/2.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/3.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/4.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/5.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/6.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/7.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
                          ...
                          <div className="col-xl-4 col-lg-4 col-sm-6">
                            <a
                              href="/assets/images/photos/8.jpg"
                              className="glightbox card"
                              data-gallery="gallery1"
                            >
                              <img
