              ...
              <div className="col-xl-3 col-lg-12">
                <div className="card tasks-card">
                  <div className="list-group list-group-transparent mb-0 mail-inbox pb-3">
                    ...
                    <a
                      href="javascript:void(0);"
                      className="list-group-item  d-flex align-items-center border-0 py-2"
                    >
                      <i className="fe fe-codepen fs-18 me-4 p-2 border-primary rounded-circle bg-primary-transparent text-primary" />
                      <span>All Tasks</span>
                    </a>
                    <a
                      href="javascript:void(0);"
                      className="list-group-item  d-flex align-items-center border-0 py-2"
                    >
                      <i className="fe fe-alert-octagon fs-18 me-4 p-2 border-warning rounded-circle bg-warning-transparent text-warning" />
                      <span>Important </span>
                      <span className="ms-auto badge bg-danger">6</span>
                    </a>
                    <a
                      href="javascript:void(0);"
                      className="list-group-item  d-flex align-items-center border-0 py-2 "
                    >
                      <i className="fe fe-star fs-18 me-4 p-2 border-secondary rounded-circle bg-secondary-transparent text-secondary" />
                      <span>Starred</span>
                    </a>
                    <a
                      href="javascript:void(0);"
                      className="list-group-item  d-flex align-items-center border-0 py-2"
                    >
                      <i className="fe fe-briefcase fs-18 me-4 p-2 border-info rounded-circle bg-info-transparent text-info" />
                      <span>Spam</span>
                    </a>
                    <a
                      href="javascript:void(0);"
                      className="list-group-item  d-flex align-items-center border-0 py-2"
                    >
                      <i className="fe fe-bell fs-18 me-4 p-2 border-success rounded-circle bg-success-transparent text-success" />
                      <span>Archive</span>{" "}
                      <span className="ms-auto badge bg-warning">4</span>
                    </a>
                    <a
                      href="javascript:void(0);"
                      className="list-group-item  d-flex align-items-center border-bottom-0 border-0 py-2"
                    >
                      <i className="fe fe-trash-2 fs-18 me-4 p-2 border-danger rounded-circle bg-danger-transparent text-danger" />
                      <span>Trash</span>
                    </a>
                  </div>
                </div>
                  ...
                  <div className="col-lg-12">
                    <div className="card mg-b-20">
                      <div className="card-body d-flex p-3">
                        <div className="main-content-label mb-0 mt-1">
                          User Today Tasks
                        </div>
                        <div className="ms-auto">
                          <a
                            className="d-block tx-20 px-3"
                            data-placement="top"
                            data-bs-toggle="tooltip"
                            title="Add New User"
                            href="javascript:void(0);"
                          >
                            <i className="si si-plus text-muted" />
                          </a>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="card mg-b-20">
                      <div className="card-body p-0">
                        <div className="todo-widget-header d-flex p-3 border-bottom">
                          <div className="dropdown">
                            ...
                            >
                              ...
                              />
                              <span className="assigned-task bg-success">
                                9
                              </span>
                            </div>
                            <ul className="dropdown-menu">
                              <li className="main-header-profile text-center py-1 flex-column">
                                <div className="fs-16 fw-semibold mb-0">
                                  Teri Dactyl
                                </div>
                          ...
                          <div className="ms-auto">
                            <div className="card-options-task">
                              <a
                                ...
                                data-bs-toggle="tooltip"
                                title="archive"
                                className="p-2 border br-5 text-primary me-1"
                              >
                                <i className="fe fe-folder-plus align-middle" />
                              </a>
                              <a
                                href="javascript:void(0);"
                                data-placement="top"
                                ...
                                className="p-2 border br-5 text-primary me-1"
                              >
                                <i className="fe fe-info align-middle" />
                              </a>
                              <a
                                href="javascript:void(0);"
                                className="p-2 border br-5 text-primary me-1"
                                data-bs-toggle="dropdown"
                              >
                                <i className="fe fe-more-vertical align-middle" />
                              </a>
                              <div className="dropdown-menu fs-13 dropleft">
                                <a
                                  className="dropdown-item"
                                  href="javascript:void(0);"
                                >
                        ...
                        <div className="p-4">
                          ...
                          <span className="badge bg-primary-transparent me-1 my-2  text-primary ms-auto float-end">
                            New
                          </span>
                          <h5 className="fs-14 mb-0 mg-t-5 text-capitalize">
                            Work Assigned by Clients ,try to get new work
                          </h5>
                        </div>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="card mg-b-20">
                      <div className="card-body p-0">
                        <div className="todo-widget-header d-flex p-3 border-bottom">
                          <div className="dropdown">
                            ...
                            >
                              ...
                              />
                              <span className="assigned-task bg-info">2</span>
                            </div>
                            <ul className="dropdown-menu">
                              <li className="main-header-profile text-center py-1 flex-column">
                                <div className="fs-16 fw-semibold mb-0">
                          ...
                          <div className="ms-auto">
                            <div className="card-options-task">
                              ...
                              <div className="dropdown-menu fs-13">
                                <a
                                  className="dropdown-item"
                                  href="javascript:void(0);"
                                >
                        ...
                        <div className="p-4">
                          <span className="fs-12 text-muted">10.54am</span>
                          <span className="badge bg-success-transparent text-success ms-auto float-end">
                            completed
                          </span>
                          <h5 className="fs-14 mb-0 mg-t-5 text-capitalize">
                            voluptatem accusantium dolo laudantium
                          </h5>
                        </div>
                        <div className="p-4 border-top">
                          <span className="fs-12 text-muted">10.54am</span>
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="card mg-b-20">
                      <div className="card-body p-0">
                        <div className="todo-widget-header d-flex p-3 border-bottom">
                          <div className="dropdown">
                            ...
                            >
                              ...
                              />
                              <span className="assigned-task bg-danger">6</span>
                            </div>
                            <ul className="dropdown-menu">
                              <li className="main-header-profile text-center py-1 flex-column">
                                <div className="fs-16 fw-semibold mb-0">
                        ...
                        <div className="p-4">
                          <span className="fs-12 text-muted">10.54am</span>
                          <span className="badge bg-danger-transparent text-danger ms-auto float-end">
                            Pending{" "}
                          </span>
                          <h5 className="fs-14 mb-0 mg-t-5 text-capitalize">
                        ...
                        <div className="todo-widget-header d-flex p-3 border-bottom">
                          <div className="dropdown">
                            ...
                            >
                              ...
                              />
                              <span className="assigned-task bg-info">9</span>
                            </div>
                            <ul className="dropdown-menu">
                              <li className="main-header-profile text-center py-1 flex-column">
                                <div className="fs-16 fw-semibold mb-0">
                        ...
                        <div className="todo-widget-header d-flex p-3 border-bottom">
                          <div className="dropdown">
                            ...
                            >
                              ...
                              />
                              <span className="assigned-task bg-danger">7</span>
                            </div>
                            <ul className="dropdown-menu">
                              <li className="main-header-profile text-center py-1 flex-column">
                                <div className="fs-16 fw-semibold mb-0">
                  ...
                  <div className="col-xl-4 col-md-6">
                    <div className="card mg-b-20 ">
                      <div className="card-body p-0">
                        <div className="todo-widget-header d-flex p-3 border-bottom">
                          <div className="dropdown">
                            ...
                            >
                              ...
                              />
                              <span className="assigned-task bg-info">4</span>
                            </div>
                            <ul className="dropdown-menu">
                              <li className="main-header-profile text-center py-1 flex-column">
                                <div className="fs-16 fw-semibold mb-0">
                        ...
                        <div className="p-4">
                          <span className="fs-12 text-muted">10.54am</span>
                          <span className="badge bg-primary-transparent text-primary ms-auto float-end">
                            New
                          </span>
                          <h5 className="fs-14 mb-0 mg-t-5 text-capitalize">
                            Rationally encounter quences extremely painful
                          </h5>
                        </div>
                        <div className="p-4 border-top">
                          <span className="fs-12 text-muted">10.54am</span>
