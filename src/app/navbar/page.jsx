          ...
          <div className="main-content app-content">
            <div className="container-fluid">
              ...
              <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <h1 className="page-title fw-semibold fs-18 mb-0">NAVBAR</h1>
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">Image and text</div>
                    </div>
                    <div className="card-body">
                      <nav className="navbar bg-light">
                        <div className="container-fluid">
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">Forms In Navbar</div>
                    </div>
                    <div className="card-body">
                      <nav className="navbar bg-light mb-3">
                        <div className="container-fluid">
                      ...
                      <h6 className="mb-3 fw-semibold">
                        {" "}
                        Variation buttons are supported as part of the navbar
                        forms
                      </h6>
                      <nav className="navbar bg-light">
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">Navbar With Text</div>
                    </div>
                    <div className="card-body">
                      <nav className="navbar bg-light mb-3">
                        <div className="container-fluid">
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    ...
                    <div className="card-body">
                      <nav className="navbar navbar-expand-lg navbar-primary-transparent mb-3">
                        <div className="container-fluid">
                          <a
                            className="navbar-brand"
                            href="javascript:void(0);"
                      ...
                      <nav className="navbar navbar-expand-lg navbar-secondary-transparent mb-3">
                        <div className="container-fluid">
                          <a
                            className="navbar-brand"
                            href="javascript:void(0);"
                ...
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">Solid Color Schemes</div>
                    </div>
                    <div className="card-body">
                      <nav className="navbar navbar-expand-lg navbar-primary mb-3">
                        <div className="container-fluid">
                          <a
                            className="navbar-brand"
                            href="javascript:void(0);"
                      ...
                      <nav className="navbar navbar-expand-lg navbar-secondary mb-3">
                        <div className="container-fluid">
                          <a
                            className="navbar-brand"
                            href="javascript:void(0);"
                ...
                <div className="col-xl-12">
                  <div className="card custom-card">
                    ...
                    <div className="card-body">
                      ...
                      <h6>
                        Change the responsive container to how to wide the
                        content
                      </h6>
                      <nav className="navbar navbar-expand-lg bg-light">
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">Scrolling</div>
                    </div>
                    <div className="card-body">
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">External content</div>
                    </div>
                    <div className="card-body">
                      <div
                        className="collapse"
              ...
              <div className="row">
                <div className="col-xl-12">
                  <div className="card custom-card">
                    <div className="card-header">
                      <div className="card-title">Offcanvas</div>
                    </div>
                    <div className="card-body">
