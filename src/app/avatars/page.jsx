        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">AVATARS</h1>
            ...
            <div className="row">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar me-2 avatar-rounded"&gt;{"\n"}
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <span className="avatar avatar-xs me-2 avatar-rounded">
                      ...
                      <a
                        href="javascript:void(0);"
                        className="badge bg-success rounded-pill avatar-badge"
                      >
                    ...
                    <span className="avatar avatar-sm me-2 avatar-rounded">
                      ...
                      <a
                        href="javascript:void(0);"
                        className="badge rounded-pill bg-secondary avatar-badge"
                      >
                    ...
                    <span className="avatar avatar-lg me-2 avatar-rounded">
                      ...
                      <a
                        href="javascript:void(0);"
                        className="badge rounded-pill bg-info avatar-badge"
                      >
                        <i className="fe fe-edit" />
                      </a>
                    </span>
                    <span className="avatar avatar-xl me-2 avatar-rounded">
                      ...
                      <a
                        href="javascript:void(0);"
                        className="badge rounded-pill bg-success avatar-badge"
                      >
                        <i className="fe fe-camera" />
                      </a>
                    </span>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        bg-success rounded-pill avatar-badge"&gt;&lt;i class="fe
                        fe-camera"&gt;&lt;/i&gt;&lt;/a&gt;{"\n"}&lt;/span&gt;
                        {"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;a href="javascript:void(0);" class="badge
                        rounded-pill bg-secondary avatar-badge"&gt;&lt;i
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;a href="javascript:void(0);" class="badge
                        rounded-pill bg-warning avatar-badge"&gt;&lt;i class="fe
                        fe-plus"&gt;&lt;/i&gt;&lt;/a&gt;{"\n"}&lt;/span&gt;
                        {"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;a href="javascript:void(0);" class="badge
                        rounded-pill bg-info avatar-badge"&gt;&lt;i class="fe
                        fe-edit"&gt;&lt;/i&gt;&lt;/a&gt;{"\n"}&lt;/span&gt;
                        {"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;a href="javascript:void(0);" class="badge
                        rounded-pill bg-success avatar-badge"&gt;&lt;i class="fe
                        fe-camera"&gt;&lt;/i&gt;&lt;/a&gt;{"\n"}&lt;/span&gt;
                        {"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;a href="javascript:void(0);" class="badge
                        rounded-pill bg-danger avatar-badge"&gt;&lt;i class="fe
                        fe-plus"&gt;&lt;/i&gt;&lt;/a&gt;{"\n"}&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xxl-4 col-lg-12 col-md-12 col-sm-12">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;span class="avatar avatar-xs me-2 online
                        avatar-rounded"&gt;{"\n"}
                        {"    "}&lt;img src="/assets/images/faces/8.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-sm online me-2 avatar-rounded"&gt;
                        {"\n"}
                        ...
                        {"    "}&lt;img src="/assets/images/faces/14.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-xxl me-2 online avatar-rounded"&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/faces/15.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;
                      </code>
              ...
              <div className="col-xxl-4 col-lg-12 col-md-12 col-sm-12">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;span class="avatar avatar-xs me-2 offline
                        avatar-rounded"&gt;{"\n"}
                        {"    "}&lt;img src="/assets/images/faces/2.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-sm offline me-2 avatar-rounded"&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/faces/3.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-md me-2 offline avatar-rounded"&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/faces/4.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-lg me-2 offline avatar-rounded"&gt;
                        {"\n"}
                        {"    "}&lt;img src="/assets/images/faces/5.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        ...
                        {"    "}&lt;img src="/assets/images/faces/6.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-xxl me-2 offline
                        avatar-rounded"&gt;{"\n"}
                        {"    "}&lt;img src="/assets/images/faces/7.jpg"
                        alt="img"&gt;{"\n"}&lt;/span&gt;
                      </code>
                ...
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">
                      ...
                      <p className="subtitle text-muted fs-12 fw-normal">
                        Avatar numbers indicates the no. of unread
                        notififactions/messages.
                      </p>
                    </div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
              ...
              <div className="col-xxl-4 col-lg-12 col-md-12 col-sm-12">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <span className="avatar avatar-xs m-2 bg-primary">xs</span>
                    <span className="avatar avatar-sm m-2 bg-secondary">
                      SM
                    </span>
                    <span className="avatar avatar-md m-2 bg-warning">MD</span>
                    <span className="avatar avatar-lg m-2 bg-danger">LG</span>
                    <span className="avatar avatar-xl m-2 bg-success">XL</span>
                    <span className="avatar avatar-xxl m-2 bg-info">XXL</span>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    {/* Prism Code */}
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"    "}xs{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-sm me-2 bg-secondary"&gt;{"\n"}
                        {"    "}SM{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-md me-2 bg-warning"&gt;{"\n"}
                        {"    "}MD{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-lg me-2 bg-danger"&gt;{"\n"}
                        {"    "}LG{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-xl me-2 bg-success"&gt;{"\n"}
                        {"    "}XL{"\n"}&lt;/span&gt;{"\n"}&lt;span
                        class="avatar avatar-xxl me-2 bg-info"&gt;{"\n"}
                        {"    "}XXL{"\n"}&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;/span&gt;{"\n"}
                        {"    "}&lt;a class="avatar bg-primary text-fixed-white"
                        href="javascript:void(0);"&gt;{"\n"}
                        {"        "}+8{"\n"}
                        {"    "}&lt;/a&gt;{"\n"}&lt;/div&gt;
                      </code>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;/span&gt;{"\n"}
                        {"    "}&lt;a class="avatar bg-primary avatar-rounded
                        text-fixed-white" href="javascript:void(0);"&gt;{"\n"}
                        {"        "}+8{"\n"}
                        {"    "}&lt;/a&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
