        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">BADGE</h1>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        class="badge bg-light text-dark"&gt;Light&lt;/span&gt;
                        {"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}&lt;span class="badge rounded-pill
                        bg-warning"&gt;Warning&lt;/span&gt;{"\n"}&lt;span
                        class="badge rounded-pill bg-info"&gt;Info&lt;/span&gt;
                        {"\n"}&lt;span class="badge rounded-pill bg-light
                        text-dark"&gt;Light&lt;/span&gt;{"\n"}&lt;span
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Light Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body d-flex flex-wrap gap-2">
                    <div className="example">
                      ...
                      <span className="badge bg-info-transparent">Info</span>
                      <span className="badge bg-light-transparent text-dark">
                        Light
                      </span>
                      <span className="badge bg-dark-transparent">Dark</span>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    {/* Prism Code */}
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;span class="badge
                        bg-primary-transparent"&gt;Primary&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-secondary-transparent"&gt;Secondary&lt;/span&gt;
                        {"\n"}
                        &lt;span class="badge
                        bg-success-transparent"&gt;Success&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-danger-transparent"&gt;Danger&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-warning-transparent"&gt;Warning&lt;/span&gt;
                        {"\n"}&lt;span class="badge
                        bg-info-transparent"&gt;Info&lt;/span&gt;{"\n"}&lt;span
                        class="badge bg-light-transparent
                        text-dark"&gt;Light&lt;/span&gt;{"\n"}&lt;span
                        class="badge bg-dark-transparent"&gt;Dark&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Light Pill Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body d-flex flex-wrap gap-2">
                    <div className="example">
                      <span className="badge rounded-pill bg-primary-transparent">
                        Primary
                      </span>
                      <span className="badge rounded-pill bg-secondary-transparent">
                        Secondary
                      </span>
                      <span className="badge rounded-pill bg-success-transparent">
                        Success
                      </span>
                      <span className="badge rounded-pill bg-danger-transparent">
                        Danger
                      </span>
                      <span className="badge rounded-pill bg-warning-transparent">
                        Warning
                      </span>
                      <span className="badge rounded-pill bg-info-transparent">
                        Info
                      </span>
                      <span className="badge rounded-pill bg-light-transparent text-dark">
                        Light
                      </span>
                      <span className="badge rounded-pill bg-dark-transparent">
                        Dark
                      </span>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        &lt;span class="badge rounded-pill
                        bg-info-transparent"&gt;Info&lt;/span&gt;{"\n"}&lt;span
                        class="badge rounded-pill bg-light-transparent
                        text-dark"&gt;Light&lt;/span&gt;{"\n"}&lt;span
                        class="badge rounded-pill
                        bg-dark-transparent"&gt;Dark&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Gradient Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;span class="badge
                        bg-primary-gradient"&gt;Primary&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-secondary-gradient"&gt;Secondary&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-success-gradient"&gt;Success&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-danger-gradient"&gt;Danger&lt;/span&gt;
                        {"\n"}&lt;span class="badge
                        bg-warning-gradient"&gt;Warning&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-info-gradient"&gt;Info&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-orange-gradient"&gt;orange&lt;/span&gt;{"\n"}&lt;span
                        class="badge bg-purple-gradient"&gt;purple&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Gradient Pill Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Outline Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body d-flex flex-wrap gap-2">
                    <div className="example">
                      ...
                      <span className="badge bg-outline-dark">Dark</span>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    {/* Prism Code */}
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;span class="badge
                        bg-outline-primary"&gt;Primary&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-outline-secondary"&gt;Secondary&lt;/span&gt;
                        {"\n"}&lt;span class="badge
                        bg-outline-success"&gt;Success&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-outline-danger"&gt;Danger&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-outline-warning"&gt;Warning&lt;/span&gt;{"\n"}
                        &lt;span class="badge
                        bg-outline-info"&gt;Info&lt;/span&gt;{"\n"}
                        &lt;span class="badge bg-outline-light
                        text-dark"&gt;Light&lt;/span&gt;{"\n"}&lt;span
                        class="badge bg-outline-dark"&gt;Dark&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Outline Pill Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body d-flex flex-wrap gap-2">
                    <div className="example">
                      ...
                      <span className="badge rounded-pill bg-outline-dark">
                        Dark
                      </span>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        &lt;span class="badge rounded-pill
                        bg-outline-info"&gt;Info&lt;/span&gt;{"\n"}&lt;span
                        class="badge rounded-pill bg-outline-light
                        text-dark"&gt;Light&lt;/span&gt;{"\n"}&lt;span
                        class="badge rounded-pill
                        bg-outline-dark"&gt;Dark&lt;/span&gt;
                      </code>
                    </pre>
                    {/* Prism Code */}
                  </div>
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Buttons With Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body d-flex flex-wrap gap-2">
                    <div className="example">
                      ...
                      >
                        Notifications{" "}
                        <span className="badge ms-2 bg-secondary">4</span>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        Notifications{" "}
                        <span className="badge ms-2 bg-primary">7</span>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        Notifications{" "}
                        <span className="badge ms-2 bg-danger">12</span>
                      </button>
                      <button type="button" className="btn btn-info my-1 me-2">
                        Notifications{" "}
                        <span className="badge ms-2 bg-warning">32</span>
                      </button>
                    </div>
                  </div>
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        me-2"&gt;{"\n"}
                        {"    "}Notifications &lt;span class="badge ms-2
                        bg-secondary"&gt;4&lt;/span&gt;{"\n"}&lt;/button&gt;
                        {"\n"}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Outline Button Badges</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body d-flex flex-wrap gap-2">
                    <div className="example">
                      ...
                      <button
                        type="button"
                        className="btn btn-outline-info my-1 me-2"
                      >
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-outline-secondary my-1 me-2"&gt;{"\n"}
                        {"    "}Notifications &lt;span class="badge
                        ms-2"&gt;7&lt;/span&gt;{"\n"}&lt;/button&gt;{"\n"}
            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Headings</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                ...
                <div className="row">
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            ...
                            {"    "}&lt;span{"\n"}
                            {"        "}class="position-absolute top-0 start-100
                            translate-middle p-2 bg-success border border-light
                            rounded-circle"&gt;{"\n"}
                            ...
                            {"    "}&lt;span{"\n"}
                            {"    "}class="position-absolute top-0 start-100
                            translate-middle p-1 bg-success border border-light
                            rounded-circle"&gt;{"\n"}
                            {"    "}&lt;span class="visually-hidden"&gt;New
                            alerts&lt;/span&gt;{"\n"}
                            {"    "}&lt;/span&gt;{"\n"}&lt;/span&gt;{"\n"}
                            ...
                            start-100 translate-middle p-1 bg-success border
                            ...
                            alt="img"&gt;{"\n"}
                            {"    "}&lt;span class="position-absolute top-0
                            start-100 translate-middle badge bg-secondary
                            rounded-pill shadow-lg"&gt;1000+{"\n"}
                            {"        "}&lt;span class="visually-hidden"&gt;New
                            alerts&lt;/span&gt;{"\n"}
                            {"    "}&lt;/span&gt;{"\n"}&lt;/span&gt;{"  "}
                          </code>
                  ...
                  <div className="col-xl-12">
                    <div className="card custom-card">
                      ...
                      <div className="card-body">
                        <div className="example">
                          <span className="badge bg-outline-secondary custom-badge fs-15 me-4 m-2">
                            <i className="ti ti-flame me-1 d-inline-flex" />
                            Hot
                          </span>
                          <span className="icon-badge me-4 m-2">
                            <svg
                              className="icon"
                              xmlns="http://www.w3.org/2000/svg"
                              height="24px"
                          ...
                          <span className="badge border bg-light text-default custom-badge me-4 m-2">
                            <i className="fe fe-eye me-1 d-inline-block" />
                            13.2k
                          </span>
                          <span className="text-badge me-4 m-2">
                      ...
                      <div className="card-footer d-none border-top-0">
                        ...
                        <pre className="language-html">
                          <code className="language-html">
                            ...
                            custom-badge fs-15 me-5 m-2"&gt;&lt;i class="ti
                            ti-flame me-1"&gt;&lt;/i&gt;Hot&lt;/span&gt;{"\n"}
                            &lt;span class="icon-badge me-5 m-2"&gt;{"\n"}
                            {"    "}&lt;svg class="icon"
                            xmlns="http://www.w3.org/2000/svg" height="24px"
                            viewBox="0 0 24 24" width="24px"
                            fill="#000000"&gt;&lt;path d="M12 22c1.1 0 2-.9
                            2-2h-4c0 1.1.89 2 2
                            2zm6-6v-5c0-3.07-1.64-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5
                            1.5v.68C7.63 5.36 6 7.92 6 11v5l-2
                            2v1h16v-1l-2-2z"/&gt;&lt;/svg&gt;{"\n"}
                            {"    "}&lt;span class="badge rounded-pill
                            bg-success"&gt;14&lt;/span&gt;{"\n"}&lt;/span&gt;
                            {"\n"}
                            &lt;span class="badge border bg-light text-default
                            custom-badge me-5 m-2"&gt;&lt;i class="fe fe-eye
                            me-1 d-inline-block"&gt;&lt;/i&gt;13.2k&lt;/span&gt;
                            {"\n"}
