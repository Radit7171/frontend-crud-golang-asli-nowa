        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">ALERTS</h1>
            ...
            <div className="row">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        guacamole!&lt;/strong&gt; You should check in on some of
                        those fields{"\n"}below.{"\n"}&lt;button type="button"
                        class="btn-close" data-bs-dismiss="alert"{"\n"}
                        {"    "}aria-label="Close"&gt;&lt;i class="bi
                        bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}&lt;/div&gt;
                        {"\n"}
                      </code>
                    </pre>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        btn-primary" id="liveAlertBtn"&gt;Show live{"\n"}
                        {"    "}alert{"\n"}&lt;/button&gt;{"\n"}
                      </code>
                      {"\n"}
                    </pre>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Default alerts</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Links in alerts</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        role="alert"&gt;
                        {"\n"}
                        {"    "}A simple warning alert with &lt;a href="#"
                        class="alert-link"&gt;an example{"\n"}
                        {"        "}link&lt;/a&gt;.{"\n"}
                        {"    "}Give it a click if you like.{"\n"}&lt;/div&gt;
                        {"\n"}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Solid Colored Alerts</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}A simple solid light alert—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close
                        text-default" data-bs-dismiss="alert"
                        aria-label="Close"&gt;&lt;i class="bi
                        bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}&lt;/div&gt;
                        {"\n"}
                        {"\n"}&lt;div class="alert alert-solid-dark
                        alert-dismissible fade show text-white"&gt;{"\n"}
                        {"    "}A simple solid dark alert—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close
                        text-white" data-bs-dismiss="alert"
                        aria-label="Close"&gt;&lt;i class="bi
                        bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}&lt;/div&gt;
                      </code>
                    </pre>
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Outline Alerts</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="example">
                      <div className="alert alert-solid-primary shadow-sm alert-dismissible fade show">
                        A simple solid primary alert with small shadow—check it
                        out!
                        <button
                          type="button"
                          className="btn-close"
                      ...
                      <div className="alert alert-solid-primary shadow alert-dismissible fade show">
                        A simple solid primary alert with normal shadow—check it
                        out!
                        <button
                          type="button"
                          className="btn-close"
                      ...
                      <div className="alert alert-solid-primary shadow-lg alert-dismissible fade show">
                        A simple solid primary alert with large shadow—check it
                        out!
                        <button
                          type="button"
                          className="btn-close"
                      ...
                      <div className="alert alert-solid-secondary shadow-sm alert-dismissible fade show">
                        A simple solid secondary alert with small shadow—check
                        it out!
                        <button
                          type="button"
                          className="btn-close"
                      ...
                      <div className="alert alert-solid-secondary shadow alert-dismissible fade show">
                        A simple solid secondary alert with normal shadow—check
                        it out!
                        <button
                          type="button"
                          className="btn-close"
                      ...
                      <div className="alert alert-solid-secondary shadow-lg alert-dismissible fade show">
                        A simple solid secondary alert with large shadow—check
                        it out!
                        <button
                          type="button"
                          className="btn-close"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="alert alert-solid-primary shadow-sm
                        alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid primary alert with small
                        shadow—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-solid-primary shadow
                        alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid primary alert with normal
                        shadow—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-solid-primary shadow-lg
                        alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid primary alert with large
                        shadow—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        ...
                        {"    "}A simple solid secondary alert with small
                        shadow—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;&lt;/div&gt;
                        {"\n"}
                        {"\n"}&lt;div class="alert alert-solid-secondary shadow
                        alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid secondary alert with normal
                        shadow—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;&lt;/div&gt;
                        {"\n"}
                        {"\n"}&lt;div class="alert alert-solid-secondary
                        shadow-lg alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid secondary alert with large
                        shadow—check it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="example">
                      ...
                      <div className="alert alert-secondary shadow">
                        A simple secondary alert with normal shadow—check it
                        out!
                      </div>
                      <div className="alert alert-secondary shadow-lg">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="alert alert-primary shadow-sm"&gt;A
                        simple primary alert with small shadow—check it
                        out!&lt;/div&gt;
                        {"\n"}
                        {"\n"}
                        {"    "}&lt;div class="alert alert-primary shadow"&gt;A
                        simple primary alert with normal shadow—check it
                        out!&lt;/div&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;div class="alert alert-primary
                        shadow-lg"&gt;A simple primary alert with large
                        shadow—check it out!&lt;/div&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;div class="alert alert-secondary
                        shadow-sm"&gt;A simple secondary alert with small
                        shadow—check it out!&lt;/div&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;div class="alert alert-secondary
                        shadow"&gt;A simple secondary alert with normal
                        shadow—check it out!&lt;/div&gt;{"\n"}
                        {"\n"}
                        {"    "}&lt;div class="alert alert-secondary
                        shadow-lg"&gt;A simple secondary alert with large
                        shadow—check it out!&lt;/div&gt;{" "}
                      </code>
                    </pre>
                    {/* Prism Code */}
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Rounded Solid Alerts</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="alert alert-solid-primary rounded-pill
                        alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid rounded primary alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        ...
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-solid-secondary
                        rounded-pill alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid rounded secondary alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        ...
                        {"\n"}&lt;div class="alert alert-solid-warning
                        rounded-pill alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid rounded warning alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        ...
                        {"\n"}&lt;div class="alert alert-solid-danger
                        rounded-pill alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple solid rounded danger alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Rounded Outline Alerts</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="alert alert-outline-primary rounded-pill
                        alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple outline rounded primary alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        ...
                        rounded-pill alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple outline rounded secondary alert—check
                        it out!{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        ...
                        rounded-pill alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple outline rounded warning alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        ...
                        rounded-pill alert-dismissible fade show"&gt;{"\n"}
                        {"    "}A simple outline rounded danger alert—check it
                        out!
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close
                        custom-close" data-bs-dismiss="alert"
                        aria-label="Close"&gt;&lt;i class="bi
                        bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}&lt;/div&gt;
                        {"\n"}
                        {"\n"}&lt;div class="alert alert-secondary rounded-pill
              ...
              <div className="col-xl-6">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Alerts with icons</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-body">
                    <div className="example">
                      ...
                      >
                        <svg
                          className="flex-shrink-0 me-2 svg-success"
                          xmlns="http://www.w3.org/2000/svg"
                          height="1.5rem"
                          viewBox="0 0 24 24"
                          width="1.5rem"
                      ...
                      >
                        <svg
                          className="flex-shrink-0 me-2 svg-warning"
                          xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}&lt;svg class="flex-shrink-0 me-2 svg-primary"
                        xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;path d="M0 0h24v24H0V0z"
                        fill="none"/&gt;&lt;path d="M11 7h2v2h-2zm0
                        4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48
                        10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8
                        3.59 8 8-3.59 8-8 8z"/&gt;&lt;/svg&gt;{"\n"}
                        {"    "}&lt;div&gt;{"\n"}
                        ...
                        xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;path d="M0 0h24v24H0V0zm0
                        0h24v24H0V0z" fill="none"/&gt;&lt;path d="M16.59 7.58L10
                        14.17l-3.59-3.58L5 12l5 5 8-8zM12 2C6.48 2 2 6.48 2
                        12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42
                        0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8
                        8z"/&gt;&lt;/svg&gt;{"\n"}
                        {"    "}&lt;div&gt;{"\n"}
                        ...
                        align-items-center" role="alert"&gt;{"\n"}
                        {"    "}&lt;svg class="flex-shrink-0 me-2 svg-warning"
                        xmlns="http://www.w3.org/2000/svg"
                        enable-background="new 0 0 24 24" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;g&gt;&lt;rect fill="none"
                        height="24"
                        width="24"/&gt;&lt;/g&gt;&lt;g&gt;&lt;g&gt;&lt;g&gt;&lt;path
                        d="M12,5.99L19.53,19H4.47L12,5.99
                        M12,2L1,21h22L12,2L12,2z"/&gt;&lt;polygon points="13,16
                        11,16 11,18 13,18"/&gt;&lt;polygon points="13,10 11,10
                        11,15
                        13,15"/&gt;&lt;/g&gt;&lt;/g&gt;&lt;/g&gt;&lt;/svg&gt;
                        {"\n"}
                        {"    "}&lt;div&gt;{"\n"}
                        ...
                        align-items-center" role="alert"&gt;{"\n"}
                        {"    "}&lt;svg class="flex-shrink-0 me-2 svg-danger"
                        xmlns="http://www.w3.org/2000/svg"
                        enable-background="new 0 0 24 24" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;g&gt;&lt;rect fill="none"
                        height="24"
                        width="24"/&gt;&lt;/g&gt;&lt;g&gt;&lt;g&gt;&lt;g&gt;&lt;path
                        d="M15.73,3H8.27L3,8.27v7.46L8.27,21h7.46L21,15.73V8.27L15.73,3z
                        M19,14.9L14.9,19H9.1L5,14.9V9.1L9.1,5h5.8L19,9.1V14.9z"/&gt;&lt;rect
                        height="6" width="2" x="11" y="7"/&gt;&lt;rect
                        height="2" width="2" x="11"
                        y="15"/&gt;&lt;/g&gt;&lt;/g&gt;&lt;/g&gt;&lt;/svg&gt;
                        {"\n"}
                        {"    "}&lt;div&gt;{"\n"}
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-body">
                    <div className="example">
                      ...
                      <div
                        className="alert alert-secondary alert-dismissible fade show custom-alert-icon shadow-sm"
                        role="alert"
                      >
                        <svg
                      ...
                      <div
                        className="alert alert-warning alert-dismissible fade show custom-alert-icon shadow-sm"
                        role="alert"
                      >
                        <svg
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        fade show custom-alert-icon shadow-sm" role="alert"&gt;
                        {"\n"}
                        {"    "}&lt;svg class="svg-primary"
                        xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;path d="M0 0h24v24H0z"
                        fill="none"/&gt;&lt;path d="M12 2C6.48 2 2 6.48 2
                        ...
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-secondary
                        alert-dismissible fade show custom-alert-icon shadow-sm"
                        role="alert"&gt;
                        {"\n"}
                        {"    "}&lt;svg class="svg-secondary"
                        xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;path d="M0 0h24v24H0z"
                        fill="none"/&gt;&lt;path d="M12 2C6.48 2 2 6.48 2
                        12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5
                        1.41-1.41L10 14.17l7.59-7.59L19 8l-9
                        9z"/&gt;&lt;/svg&gt;{"\n"}
                        {"    "}A customized secondary alert with an icon{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        ...
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;path d="M0 0h24v24H0z"
                        fill="none"/&gt;&lt;path d="M1 21h22L12 2 1
                        ...
                        role="alert"&gt;
                        {"\n"}
                        {"    "}&lt;svg class="svg-danger"
                        xmlns="http://www.w3.org/2000/svg" height="1.5rem"
                        viewBox="0 0 24 24" width="1.5rem"
                        fill="#000000"&gt;&lt;path d="M0 0h24v24H0z"
                        fill="none"/&gt;&lt;path d="M15.73 3H8.27L3
                        8.27v7.46L8.27 21h7.46L21 15.73V8.27L15.73 3zM12
                        17.3c-.72 0-1.3-.58-1.3-1.3 0-.72.58-1.3 1.3-1.3.72 0
                        1.3.58 1.3 1.3 0 .72-.58 1.3-1.3
              ...
              <div className="col-xxl-6 col-xl-12">
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="alert alert-img alert-primary
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        ...
                        image—check it out!&lt;/div&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-img alert-secondary
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        {"    "}&lt;div class="avatar avatar-sm me-3
                        avatar-rounded"&gt;{"\n"}
                        ...
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-img alert-warning
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        {"    "}&lt;div class="avatar avatar-sm me-3
                        avatar-rounded"&gt;{"\n"}
                        ...
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-img alert-danger
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        {"    "}&lt;div class="avatar avatar-sm me-3
                        avatar-rounded"&gt;{"\n"}
                        ...
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-img alert-info
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        {"    "}&lt;div class="avatar avatar-sm me-3
                        avatar-rounded"&gt;{"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div&gt;A simple info alert with image—check
                        it out!&lt;/div&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-img alert-light
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        {"    "}&lt;div class="avatar avatar-sm me-3
                        avatar-rounded"&gt;{"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div&gt;A simple light alert with image—check
                        it out!&lt;/div&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                        class="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;{"\n"}
                        &lt;/div&gt;{"\n"}
                        {"\n"}&lt;div class="alert alert-img alert-dark
                        alert-dismissible fase show rounded-pill flex-wrap"
                        role="alert"&gt;{"\n"}
                        {"    "}&lt;div class="avatar avatar-sm me-3
                        avatar-rounded"&gt;{"\n"}
                        ...
                        alt="img"&gt;{"\n"}
                        {"    "}&lt;/div&gt;{"\n"}
                        {"    "}&lt;div&gt;A simple dark alert with image—check
                        it out!&lt;/div&gt;{"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i
                ...
                <div className="card custom-card">
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="alert alert-img alert-primary
                        alert-dismissible fase show flex-wrap" role="alert"&gt;
                        {"\n"}
                    ...
                    <div className="card bg-white border-0">
                      <div className="alert custom-alert1 alert-warning">
                        ...
                        <div className="text-center px-5 pb-0">
                          ...
                          <h5>Warning</h5>
                          <p className="">
                            This alert is created to just show the warning
                            message.
                          </p>
                          <div className="">
                    ...
                    <div className="card bg-white border-0">
                      <div className="alert custom-alert1 alert-danger">
                        ...
                        <div className="text-center px-5 pb-0">
                          ...
                          <h5>danger</h5>
                          <p className="">
                            This alert is created to just show the danger
                            message.
                          </p>
                          <div className="">
              ...
              <div className="col-xl-12">
                <div className="row">
                    ...
                    <div className="card border-0">
                      <div className="alert alert-primary border border-primary mb-0 p-2">
                        <div className="d-flex align-items-start">
                          <div className="me-2">
                            <svg
                              className="flex-shrink-0 svg-primary"
                              xmlns="http://www.w3.org/2000/svg"
                              height="1.5rem"
                              viewBox="0 0 24 24"
                              width="1.5rem"
                    ...
                    <div className="card border-0">
                      <div className="alert alert-secondary border border-secondary mb-0 p-2">
                        <div className="d-flex align-items-start">
                          <div className="me-2">
                            <svg
                              className="flex-shrink-0 svg-secondary"
                              xmlns="http://www.w3.org/2000/svg"
                              height="1.5rem"
                              viewBox="0 0 24 24"
                              width="1.5rem"
                    ...
                    <div className="card border-0">
                      <div className="alert alert-warning border border-warning mb-0 p-2">
                        <div className="d-flex align-items-start">
                          <div className="me-2">
                            <svg
                              className="flex-shrink-0 svg-warning"
                              xmlns="http://www.w3.org/2000/svg"
                              enableBackground="new 0 0 24 24"
                              height="1.5rem"
                              viewBox="0 0 24 24"
                  ...
                  <div className="col-xl-3">
                    <div className="card border-0">
                      <div className="alert alert-danger border border-danger mb-0 p-2">
                        <div className="d-flex align-items-start">
                          <div className="me-2">
                            <svg
                              className="flex-shrink-0 svg-danger"
                              xmlns="http://www.w3.org/2000/svg"
                              enableBackground="new 0 0 24 24"
                              height="1.5rem"
                              viewBox="0 0 24 24"
                    ...
                    <div className="card border-0">
                      <div className="alert alert-solid-primary border border-primary mb-0 p-2">
                        <div className="d-flex align-items-start">
                          <div className="me-2">
                            <svg
                              className="flex-shrink-0 svg-white"
                              xmlns="http://www.w3.org/2000/svg"
                              height="1.5rem"
                              viewBox="0 0 24 24"
                              width="1.5rem"
                        ...
                        <div className="col-xl-6">
                          ...
                          >
                            <div className="p-3 bg-primary text-fixed-white d-flex justify-content-between">
                              <h6 className="aletr-heading text-fixed-white mb-0">
                            ...
                            <div className="p-3">
                              <p className="mb-0">
                                ...
                                template and for warning us about future
                                consequences{" "}
                                <a
                                  href="javascript:void(0);"
                                  className="fw-semibold text-decoration-underline d-inline-block"
                                >
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        &lt;div class="col-xl-6"&gt;{"\n"}
                        {"    "}&lt;div class="alert alert-primary
                        overflow-hidden p-0" role="alert"&gt;{"\n"}
                        {"        "}&lt;div class="p-3 bg-primary
                        text-fixed-white d-flex justify-content-between"&gt;
                        {"\n"}
                        {"            "}&lt;h6 class="aletr-heading
                        mb-0"&gt;Thank you for reporting this.&lt;/h6&gt;{"\n"}
                        {"            "}&lt;button type="button"
                        ...
                        {"        "}&lt;hr class="my-0"&gt;{"\n"}
                        {"        "}&lt;div class="p-3"&gt;{"\n"}
                        {"            "}&lt;p class="mb-0"&gt;We appreciate you
                        to let us know the bug in the template and for warning
                        us about future consequences &lt;a
                        href="javascript:void(0);" class="fw-semibold
                        text-decoration-underline d-inline-block"&gt;Visit for
