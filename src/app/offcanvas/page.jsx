        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">OFFCANVAS</h1>
            ...
            <div className="row">
                              ...
                              <div className="d-flex align-items-center">
                                ...
                                <div className="flex-fill">
                                  ...
                                  <span className="fs-12 text-muted">
                                    <i className="ri-time-line align-middle me-1 d-inline-block" />
                                    30 mins ago
                                  </span>
                                </div>
                              </div>
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        id="offcanvasExampleLabel"&gt;Notifications&lt;/h5&gt;
                        {"\n"}
              ...
              <div className="col-xl-4">
                <div className="card custom-card">
                  <div className="card-header justify-content-between">
                    <div className="card-title">Body scrolling</div>
                    <div className="prism-toggle">
                      <button className="btn btn-sm btn-primary-light">
                        Show Code
                        <i className="ri-code-line ms-2 d-inline-block align-middle" />
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"            "}&lt;h5 class="offcanvas-title"
                        id="offcanvasScrollingLabel"&gt;Notifications&lt;/h5&gt;
                        {"\n"}
                        {"            "}&lt;button type="button"
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        border-block-end-dashed"&gt;{"\n"}
                        {"    "}&lt;h5 class="offcanvas-title"
                        id="staticBackdropLabel"&gt;Notifications&lt;/h5&gt;
                        {"\n"}
                        {"    "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="offcanvas"{"\n"}
                        {"        "}aria-label="Close"&gt;&lt;/button&gt;{"\n"}
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        scrolling &amp;{"\n"}
                        {"    "}backdrop&lt;/button&gt;{"\n"}&lt;div
                        class="offcanvas offcanvas-start" data-bs-scroll="true"
                        tabindex="-1"{"\n"}
                        {"    "}id="offcanvasWithBothOptions"
                        aria-labelledby="offcanvasWithBothOptionsLabel"&gt;
                        {"\n"}
                        ...
                        border-block-end-dashed"&gt;{"\n"}
                        {"        "}&lt;h5 class="offcanvas-title"
                        id="offcanvasWithBothOptionsLabel"&gt;Notifications&lt;/h5&gt;
                        {"\n"}
                        {"        "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="offcanvas"{"\n"}
                        {"            "}aria-label="Close"&gt;&lt;/button&gt;
                  ...
                  <div className="card-footer d-none border-top-0">
                    ...
                    <pre className="language-html">
                      <code className="language-html">
                        ...
                        {"    "}offcanvas&lt;/button&gt;{"\n"}&lt;div
                        class="offcanvas offcanvas-top" tabindex="-1"
                        id="offcanvasTop"{"\n"}
                        {"    "}aria-labelledby="offcanvasTopLabel"&gt;{"\n"}
                        {"    "}&lt;div class="offcanvas-header"&gt;{"\n"}
                        {"        "}&lt;h5 class="offcanvas-title"
                        id="offcanvasTopLabel"&gt;Offcanvas top&lt;/h5&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="offcanvas"{"\n"}
                        {"            "}aria-label="Close"&gt;&lt;/button&gt;
                        {"\n"}
                        ...
                        border-block-end-dashed"&gt;{"\n"}
                        {"        "}&lt;h5 class="offcanvas-title"
                        id="offcanvasRightLabel1"&gt;Notifications{"\n"}
                        {"        "}&lt;/h5&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="offcanvas"{"\n"}
                        {"            "}aria-label="Close"&gt;&lt;/button&gt;
                        ...
                        {"    "}&lt;div class="offcanvas-header"&gt;{"\n"}
                        {"        "}&lt;h5 class="offcanvas-title"
                        id="offcanvasBottomLabel"&gt;Offcanvas bottom{"\n"}
                        {"        "}&lt;/h5&gt;{"\n"}
                        {"        "}&lt;button type="button" class="btn-close"
                        data-bs-dismiss="offcanvas"{"\n"}
                        {"            "}aria-label="Close"&gt;&lt;/button&gt;
