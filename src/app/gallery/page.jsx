        ...
        <div className="main-content app-content">
          <div className="container-fluid">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
              <h1 className="page-title fw-semibold fs-18 mb-0">GALLERY</h1>
            ...
            <div className="row">
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                ...
                >
                  <img src="/assets/images/media/media-91.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-92.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-93.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-94.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-95.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-96.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-97.jpg" alt="image" />
                </a>
              </div>
              <div className="col-lg-3 col-md-3 col-sm-6 col-12">
                <a
                  ...
                  data-gallery="gallery1"
                >
                  <img src="/assets/images/media/media-98.jpg" alt="image" />
                </a>
              </div>
            </div>
            {/*End::row-1 */}
